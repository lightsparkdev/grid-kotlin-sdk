...
interface AgentService {
    ...
    fun retrieveApprovals(requestOptions: RequestOptions): AgentRetrieveApprovalsResponse =
    ...
    /** @see updatePolicy */
    fun updatePolicy(agentId: String, requestOptions: RequestOptions): AgentUpdatePolicyResponse =
