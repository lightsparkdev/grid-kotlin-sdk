...
interface CredentialService {
    ...
    /** @see delete */
    fun delete(id: String, requestOptions: RequestOptions): CredentialDeleteResponse =
    ...
    /** @see challenge */
    fun challenge(id: String, requestOptions: RequestOptions): CredentialChallengeResponse =
