...
interface SimulateService {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): SimulateService
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): SimulateService.WithRawResponse

        /**
         * Returns a raw HTTP response for `post /sandbox/cards/{id}/simulate/authorization`, but is
         * otherwise the same as [SimulateService.authorization].
         */
        @MustBeClosed
        fun authorization(
            id: String,
         ...
         * otherwise the same as [SimulateService.clearing].
         */
        @MustBeClosed
        fun clearing(
            id: String,
