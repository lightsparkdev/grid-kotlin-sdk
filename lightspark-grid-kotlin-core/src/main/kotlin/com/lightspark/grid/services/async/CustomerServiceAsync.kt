...
interface CustomerServiceAsync {
    ...
    /** @see create */
    suspend fun create(
        individual: IndividualCustomerCreateRequest,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CustomerOneOf = create(CustomerCreateRequestOneOf.ofIndividual(individual), requestOptions)

    /** @see create */
    suspend fun create(
        business: BusinessCustomerCreateRequest,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CustomerOneOf = create(CustomerCreateRequestOneOf.ofBusiness(business), requestOptions)
    ...
    /** @see createKycLink */
    suspend fun createKycLink(customerId: String, requestOptions: RequestOptions): KycLinkResponse =
    ...
    /** @see listAgreements */
    suspend fun listAgreements(requestOptions: RequestOptions): AgreementDocumentListResponse =
    ...
    @Deprecated("deprecated")
    suspend fun retrieveEndUserTerms(requestOptions: RequestOptions): EndUserTerms =
    ...
    interface WithRawResponse {
        ...
        suspend fun create(
            ...
            create(CustomerCreateRequestOneOf.ofIndividual(individual), requestOptions)
        ...
        suspend fun create(
            ...
            create(CustomerCreateRequestOneOf.ofBusiness(business), requestOptions)
         ...
         * the same as [CustomerServiceAsync.createKycLink].
         */
        @MustBeClosed
        suspend fun createKycLink(
            customerId: String,
         ...
         * [CustomerServiceAsync.listAgreements].
         */
        @MustBeClosed
        suspend fun listAgreements(
            params: CustomerListAgreementsParams = CustomerListAgreementsParams.none(),
         ...
         * same as [CustomerServiceAsync.retrieveEndUserTerms].
         */
        @Deprecated("deprecated")
        @MustBeClosed
        suspend fun retrieveEndUserTerms(
