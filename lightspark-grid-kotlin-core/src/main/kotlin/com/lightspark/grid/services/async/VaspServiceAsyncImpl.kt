 ...
 */
class VaspServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    VaspServiceAsync {

    private val withRawResponse: VaspServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): VaspServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): VaspServiceAsync =
        VaspServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        VaspServiceAsync.WithRawResponse {
        ...
        override fun withOptions(
            ...
            VaspServiceAsyncImpl.WithRawResponseImpl(
