...
class SimulateServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    SimulateServiceAsync {

    private val withRawResponse: SimulateServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): SimulateServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): SimulateServiceAsync =
        SimulateServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SimulateServiceAsyncImpl.WithRawResponseImpl(
