...
interface DiscoveryService {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): DiscoveryService
    ...
    /** @see list */
    fun list(requestOptions: RequestOptions): DiscoveryListResponse =
        list(DiscoveryListParams.none(), requestOptions)

    /** A view of [DiscoveryService] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): DiscoveryService.WithRawResponse
        ...
        /** @see list */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): HttpResponseFor<DiscoveryListResponse> =
            list(DiscoveryListParams.none(), requestOptions)
    }
}
