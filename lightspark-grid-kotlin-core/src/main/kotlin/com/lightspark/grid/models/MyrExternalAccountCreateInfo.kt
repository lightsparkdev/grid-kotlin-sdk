...
class MyrExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MyrExternalAccountCreateInfo].
         *
    ...
    /** A builder for [MyrExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(myrExternalAccountCreateInfo: MyrExternalAccountCreateInfo) = apply {
            accountNumber = myrExternalAccountCreateInfo.accountNumber
            accountType = myrExternalAccountCreateInfo.accountType
            bankName = myrExternalAccountCreateInfo.bankName
            beneficiary = myrExternalAccountCreateInfo.beneficiary
            swiftCode = myrExternalAccountCreateInfo.swiftCode
            additionalProperties = myrExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MyrExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): MyrExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): MyrExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MyrExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "MyrExternalAccountCreateInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
}
