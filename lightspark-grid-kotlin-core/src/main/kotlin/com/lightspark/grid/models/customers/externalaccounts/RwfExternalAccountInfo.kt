...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<RwfAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    class Builder internal constructor() {
         ...
         * [RwfAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<RwfAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<RwfAccountInfo.PaymentRail>>) = apply {
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: RwfBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
    ...
    override fun toString() =
        "RwfExternalAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
