 ...
 * /agents/{agentId}/transactions/{transactionId}/approve`. This endpoint should only be used for
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(meCreateTransferInParams: MeCreateTransferInParams) = apply {
            ...
            body = meCreateTransferInParams.body.toBuilder()
    ...
    override fun toString() =
        "MeCreateTransferInParams{idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
