...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TzsAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tzsAccountInfo: TzsAccountInfo) = apply {
            accountType = tzsAccountInfo.accountType
            paymentRails = tzsAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = tzsAccountInfo.phoneNumber
            provider = tzsAccountInfo.provider
            additionalProperties = tzsAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TzsAccountInfo].
         *
    ...
    fun validate(): TzsAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TzsAccountInfo &&
    ...
    override fun toString() =
        "TzsAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
}
