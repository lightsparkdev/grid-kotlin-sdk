...
class DkkExternalAccountCreateInfo
...
private constructor(
    ...
    ) : this(accountType, beneficiary, iban, swiftCode, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DkkExternalAccountCreateInfo].
         *
    ...
    /** A builder for [DkkExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(dkkExternalAccountCreateInfo: DkkExternalAccountCreateInfo) = apply {
            accountType = dkkExternalAccountCreateInfo.accountType
            beneficiary = dkkExternalAccountCreateInfo.beneficiary
            iban = dkkExternalAccountCreateInfo.iban
            swiftCode = dkkExternalAccountCreateInfo.swiftCode
            additionalProperties = dkkExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DkkExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): DkkExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): DkkExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: DkkBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DkkExternalAccountCreateInfo &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountType, beneficiary, iban, swiftCode, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "DkkExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, iban=$iban, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
}
