...
class BeneficialOwnerRetrieveResponse
...
private constructor(
    ...
    /** A builder for [BeneficialOwnerRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(beneficialOwnerRetrieveResponse: BeneficialOwnerRetrieveResponse) =
            apply {
                id = beneficialOwnerRetrieveResponse.id
                createdAt = beneficialOwnerRetrieveResponse.createdAt
                customerId = beneficialOwnerRetrieveResponse.customerId
                kycStatus = beneficialOwnerRetrieveResponse.kycStatus
                personalInfo = beneficialOwnerRetrieveResponse.personalInfo
                roles = beneficialOwnerRetrieveResponse.roles.map { it.toMutableList() }
                ownershipPercentage = beneficialOwnerRetrieveResponse.ownershipPercentage
                updatedAt = beneficialOwnerRetrieveResponse.updatedAt
                additionalProperties =
                    beneficialOwnerRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BeneficialOwnerRetrieveResponse].
         *
         ...
         */
        fun build(): BeneficialOwnerRetrieveResponse =
            BeneficialOwnerRetrieveResponse(
                checkRequired("id", id),
    ...
    fun validate(): BeneficialOwnerRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BeneficialOwnerRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "BeneficialOwnerRetrieveResponse{id=$id, createdAt=$createdAt, customerId=$customerId, kycStatus=$kycStatus, personalInfo=$personalInfo, roles=$roles, ownershipPercentage=$ownershipPercentage, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
