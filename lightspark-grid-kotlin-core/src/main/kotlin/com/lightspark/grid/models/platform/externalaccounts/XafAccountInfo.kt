...
private constructor(
    ...
    ) : this(accountType, paymentRails, phoneNumber, provider, region, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [XafAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(xafAccountInfo: XafAccountInfo) = apply {
            accountType = xafAccountInfo.accountType
            paymentRails = xafAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = xafAccountInfo.phoneNumber
            provider = xafAccountInfo.provider
            region = xafAccountInfo.region
            additionalProperties = xafAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [XafAccountInfo].
         *
    ...
    fun validate(): XafAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is XafAccountInfo &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountType, paymentRails, phoneNumber, provider, region, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "XafAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, region=$region, additionalProperties=$additionalProperties}"
}
