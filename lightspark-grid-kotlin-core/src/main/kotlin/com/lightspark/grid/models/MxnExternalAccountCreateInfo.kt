...
class MxnExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MxnExternalAccountCreateInfo].
         *
    ...
    /** A builder for [MxnExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(mxnExternalAccountCreateInfo: MxnExternalAccountCreateInfo) = apply {
            accountType = mxnExternalAccountCreateInfo.accountType
            beneficiary = mxnExternalAccountCreateInfo.beneficiary
            clabeNumber = mxnExternalAccountCreateInfo.clabeNumber
            additionalProperties = mxnExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MxnExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): MxnExternalAccountCreateInfo =
    ...
    fun validate(): MxnExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MxnExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "MxnExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, clabeNumber=$clabeNumber, additionalProperties=$additionalProperties}"
}
