...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = incomingPaymentWebhook.type().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IncomingPaymentWebhook].
         *
    ...
    /** A builder for [IncomingPaymentWebhook]. */
    class Builder internal constructor() {
        ...
        internal fun from(incomingPaymentWebhook: IncomingPaymentWebhook) = apply {
            id = incomingPaymentWebhook.id
            timestamp = incomingPaymentWebhook.timestamp
            type = incomingPaymentWebhook.type
            data = incomingPaymentWebhook.data
            additionalProperties = incomingPaymentWebhook.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IncomingPaymentWebhook].
         *
         ...
         */
        fun build(): IncomingPaymentWebhook =
     ...
     *   expected type.
     */
    fun validate(): IncomingPaymentWebhook = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private val failureReason: JsonField<IncomingTransactionFailureReason>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            failureReason: JsonField<IncomingTransactionFailureReason> = JsonMissing.of(),
         ...
         *   if the server responded with an unexpected value).
         */
        fun failureReason(): IncomingTransactionFailureReason? =
        ...
        @JsonProperty("failureReason")
        @ExcludeMissing
        fun _failureReason(): JsonField<IncomingTransactionFailureReason> = failureReason
        ...
        class Builder internal constructor() {
            ...
            private var failureReason: JsonField<IncomingTransactionFailureReason> =
                JsonMissing.of()
            ...
            /** If the transaction failed, this field provides the reason for failure. */
            fun failureReason(failureReason: IncomingTransactionFailureReason) =
             ...
             * [IncomingTransactionFailureReason] value instead. This method is primarily for
             * setting the field to an undocumented or not yet supported value.
             */
            fun failureReason(failureReason: JsonField<IncomingTransactionFailureReason>) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IncomingPaymentWebhook &&
            id == other.id &&
    ...
    override fun toString() =
        "IncomingPaymentWebhook{id=$id, timestamp=$timestamp, type=$type, data=$data, additionalProperties=$additionalProperties}"
}
