...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgreementConsent].
         *
    ...
    /** A builder for [AgreementConsent]. */
    class Builder internal constructor() {
        ...
        internal fun from(agreementConsent: AgreementConsent) = apply {
            acceptanceMethod = agreementConsent.acceptanceMethod
            acceptedAt = agreementConsent.acceptedAt
            ipAddress = agreementConsent.ipAddress
            termsVersion = agreementConsent.termsVersion
            type = agreementConsent.type
            additionalProperties = agreementConsent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgreementConsent].
         *
     ...
     *   expected type.
     */
    fun validate(): AgreementConsent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgreementConsent &&
    ...
    override fun toString() =
        "AgreementConsent{acceptanceMethod=$acceptanceMethod, acceptedAt=$acceptedAt, ipAddress=$ipAddress, termsVersion=$termsVersion, type=$type, additionalProperties=$additionalProperties}"
}
