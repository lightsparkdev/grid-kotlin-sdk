...
/**
 * Retrieve a paginated list of actions submitted by the authenticated agent. Use this to poll for
 * approval decisions after submitting an action that requires approval.
 */
class ActionListParams
private constructor(
    private val cursor: String?,
    private val limit: Long?,
    private val status: AgentActionStatus?,
     ...
     */
    fun status(): AgentActionStatus? = status
    ...
    companion object {
        ...
        fun none(): ActionListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        private var status: AgentActionStatus? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(actionListParams: ActionListParams) = apply {
            cursor = actionListParams.cursor
            limit = actionListParams.limit
            status = actionListParams.status
         ...
         * |`FAILED`          |Approved but execution failed (e.g. quote expired, insufficient funds)|
         */
        fun status(status: AgentActionStatus?) = apply { this.status = status }
    ...
    override fun toString() =
        "ActionListParams{cursor=$cursor, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
