...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TzsBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tzsBeneficiary: TzsBeneficiary) = apply {
            beneficiaryType = tzsBeneficiary.beneficiaryType
            fullName = tzsBeneficiary.fullName
            address = tzsBeneficiary.address
            birthDate = tzsBeneficiary.birthDate
            countryOfResidence = tzsBeneficiary.countryOfResidence
            email = tzsBeneficiary.email
            nationality = tzsBeneficiary.nationality
            phoneNumber = tzsBeneficiary.phoneNumber
            additionalProperties = tzsBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TzsBeneficiary].
         *
    ...
    fun validate(): TzsBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TzsBeneficiary &&
    ...
    override fun toString() =
        "TzsBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
