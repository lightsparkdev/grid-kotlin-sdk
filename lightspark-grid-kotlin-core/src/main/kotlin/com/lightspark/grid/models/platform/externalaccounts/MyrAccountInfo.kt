...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MyrAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(myrAccountInfo: MyrAccountInfo) = apply {
            accountNumber = myrAccountInfo.accountNumber
            accountType = myrAccountInfo.accountType
            bankName = myrAccountInfo.bankName
            paymentRails = myrAccountInfo.paymentRails.map { it.toMutableList() }
            swiftCode = myrAccountInfo.swiftCode
            additionalProperties = myrAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MyrAccountInfo].
         *
    ...
    fun validate(): MyrAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MyrAccountInfo &&
    ...
    override fun toString() =
        "MyrAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
}
