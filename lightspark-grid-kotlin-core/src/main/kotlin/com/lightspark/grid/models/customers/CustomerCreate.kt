...
private constructor(
    ...
    ) : this(platformCustomerId, currencies, region, umaAddress, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(platformCustomerId, currencies, region, umaAddress, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "CustomerCreate{platformCustomerId=$platformCustomerId, currencies=$currencies, region=$region, umaAddress=$umaAddress, additionalProperties=$additionalProperties}"
}
