...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EgpExternalAccountInfo].
         *
    ...
    /** A builder for [EgpExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(egpExternalAccountInfo: EgpExternalAccountInfo) = apply {
            ...
            beneficiary = egpExternalAccountInfo.beneficiary
            additionalProperties = egpExternalAccountInfo.additionalProperties.toMutableMap()
        }
         ...
         * [EgpAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<EgpAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<EgpAccountInfo.PaymentRail>>) = apply {
        ...
        /**
         * Returns an immutable instance of [EgpExternalAccountInfo].
         *
         ...
         */
        fun build(): EgpExternalAccountInfo =
     ...
     *   expected type.
     */
    fun validate(): EgpExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
