...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AedAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(aedAccountInfo: AedAccountInfo) = apply {
            accountType = aedAccountInfo.accountType
            iban = aedAccountInfo.iban
            paymentRails = aedAccountInfo.paymentRails.map { it.toMutableList() }
            swiftCode = aedAccountInfo.swiftCode
            additionalProperties = aedAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AedAccountInfo].
         *
    ...
    fun validate(): AedAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AedAccountInfo &&
    ...
    override fun toString() =
        "AedAccountInfo{accountType=$accountType, iban=$iban, paymentRails=$paymentRails, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
}
