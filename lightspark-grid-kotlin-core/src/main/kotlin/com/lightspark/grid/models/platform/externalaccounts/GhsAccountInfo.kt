...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GhsAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [GhsAccountInfo].
         *
    ...
    fun validate(): GhsAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "GhsAccountInfo{accountType=$accountType, paymentRails=$paymentRails, accountNumber=$accountNumber, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
