...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         * `Body.ofIdentityDocumentUploadRequest(identityDocumentUploadRequest)`.
         */
        fun body(identityDocumentUploadRequest: Body.IdentityDocumentUploadRequest) =
            body(Body.ofIdentityDocumentUploadRequest(identityDocumentUploadRequest))

        /**
         * Alias for calling [body] with
         * `Body.ofNonIdentityDocumentUploadRequest(nonIdentityDocumentUploadRequest)`.
         */
        fun body(nonIdentityDocumentUploadRequest: Body.NonIdentityDocumentUploadRequest) =
            body(Body.ofNonIdentityDocumentUploadRequest(nonIdentityDocumentUploadRequest))
    ...
    class Body
    private constructor(
        private val identityDocumentUploadRequest: IdentityDocumentUploadRequest? = null,
        private val nonIdentityDocumentUploadRequest: NonIdentityDocumentUploadRequest? = null,
        private val _json: JsonValue? = null,
    ) {

        /** Upload an identity document (passport, driver's license, or national ID). */
        fun identityDocumentUploadRequest(): IdentityDocumentUploadRequest? =
         ...
         */
        fun nonIdentityDocumentUploadRequest(): NonIdentityDocumentUploadRequest? =
            nonIdentityDocumentUploadRequest

        fun isIdentityDocumentUploadRequest(): Boolean = identityDocumentUploadRequest != null

        fun isNonIdentityDocumentUploadRequest(): Boolean = nonIdentityDocumentUploadRequest != null

        /** Upload an identity document (passport, driver's license, or national ID). */
        fun asIdentityDocumentUploadRequest(): IdentityDocumentUploadRequest =
            identityDocumentUploadRequest.getOrThrow("identityDocumentUploadRequest")

        /**
         * Upload a non-identity verification document such as proof of address, business registry
         * documents, or supporting evidence.
         */
        fun asNonIdentityDocumentUploadRequest(): NonIdentityDocumentUploadRequest =
            nonIdentityDocumentUploadRequest.getOrThrow("nonIdentityDocumentUploadRequest")
         ...
         *     override fun visitIdentityDocumentUploadRequest(identityDocumentUploadRequest: IdentityDocumentUploadRequest): String? = identityDocumentUploadRequest.toString()
         *
         *     // ...
         *
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                identityDocumentUploadRequest != null ->
                    visitor.visitIdentityDocumentUploadRequest(identityDocumentUploadRequest)
                nonIdentityDocumentUploadRequest != null ->
                    visitor.visitNonIdentityDocumentUploadRequest(nonIdentityDocumentUploadRequest)
        ...
        fun validate(): Body = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitIdentityDocumentUploadRequest(
                        identityDocumentUploadRequest: IdentityDocumentUploadRequest
                    ) {
                        identityDocumentUploadRequest.validate()
                    }

                    override fun visitNonIdentityDocumentUploadRequest(
                        nonIdentityDocumentUploadRequest: NonIdentityDocumentUploadRequest
                    ) {
                        nonIdentityDocumentUploadRequest.validate()
                    }
                }
            )
            validated = true
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Body &&
                identityDocumentUploadRequest == other.identityDocumentUploadRequest &&
                nonIdentityDocumentUploadRequest == other.nonIdentityDocumentUploadRequest
        }

        override fun hashCode(): Int =
            Objects.hash(identityDocumentUploadRequest, nonIdentityDocumentUploadRequest)

        override fun toString(): String =
            when {
                identityDocumentUploadRequest != null ->
                    "Body{identityDocumentUploadRequest=$identityDocumentUploadRequest}"
                nonIdentityDocumentUploadRequest != null ->
                    "Body{nonIdentityDocumentUploadRequest=$nonIdentityDocumentUploadRequest}"
        ...
        companion object {
            ...
            /** Upload an identity document (passport, driver's license, or national ID). */
            fun ofIdentityDocumentUploadRequest(
                identityDocumentUploadRequest: IdentityDocumentUploadRequest
            ) = Body(identityDocumentUploadRequest = identityDocumentUploadRequest)
             ...
             */
            fun ofNonIdentityDocumentUploadRequest(
                nonIdentityDocumentUploadRequest: NonIdentityDocumentUploadRequest
            ) = Body(nonIdentityDocumentUploadRequest = nonIdentityDocumentUploadRequest)
        }
        ...
        interface Visitor<out T> {
            ...
            /** Upload an identity document (passport, driver's license, or national ID). */
            fun visitIdentityDocumentUploadRequest(
                identityDocumentUploadRequest: IdentityDocumentUploadRequest
            ): T
             ...
             * registry documents, or supporting evidence.
             */
            fun visitNonIdentityDocumentUploadRequest(
                nonIdentityDocumentUploadRequest: NonIdentityDocumentUploadRequest
            ): T
        ...
        internal class Serializer : BaseSerializer<Body>(Body::class) {
            ...
            override fun serialize(
                ...
                when {
                    value.identityDocumentUploadRequest != null ->
                        generator.writeObject(value.identityDocumentUploadRequest)
                    value.nonIdentityDocumentUploadRequest != null ->
                        generator.writeObject(value.nonIdentityDocumentUploadRequest)
        ...
        /** Upload an identity document (passport, driver's license, or national ID). */
        class IdentityDocumentUploadRequest
        private constructor(
            ...
            /** A builder for [IdentityDocumentUploadRequest]. */
            class Builder internal constructor() {
                ...
                internal fun from(identityDocumentUploadRequest: IdentityDocumentUploadRequest) =
                    apply {
                        country = identityDocumentUploadRequest.country
                        documentHolder = identityDocumentUploadRequest.documentHolder
                        documentNumber = identityDocumentUploadRequest.documentNumber
                        documentType = identityDocumentUploadRequest.documentType
                        file = identityDocumentUploadRequest.file
                        issuingAuthority = identityDocumentUploadRequest.issuingAuthority
                        side = identityDocumentUploadRequest.side
                        additionalProperties =
                            identityDocumentUploadRequest.additionalProperties.toMutableMap()
                    }
                ...
                /**
                 * Returns an immutable instance of [IdentityDocumentUploadRequest].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 *
                 * The following fields are required:
                 ...
                 * @throws IllegalStateException if any required field is unset.
                 */
                fun build(): IdentityDocumentUploadRequest =
                    IdentityDocumentUploadRequest(
             ...
             */
            fun validate(): IdentityDocumentUploadRequest = apply {
                if (validated) {
                    return@apply
                }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is IdentityDocumentUploadRequest &&
            ...
            override fun toString() =
                "IdentityDocumentUploadRequest{country=$country, documentHolder=$documentHolder, documentNumber=$documentNumber, documentType=$documentType, file=$file, issuingAuthority=$issuingAuthority, side=$side, additionalProperties=$additionalProperties}"
        }
         ...
         * documents, or supporting evidence.
         */
        class NonIdentityDocumentUploadRequest
        private constructor(
            private val country: MultipartField<String>,
            private val documentHolder: MultipartField<String>,
            private val documentType: MultipartField<DocumentType>,
            ...
            /** A builder for [NonIdentityDocumentUploadRequest]. */
            class Builder internal constructor() {
                ...
                internal fun from(
                    ...
                    country = nonIdentityDocumentUploadRequest.country
                    documentHolder = nonIdentityDocumentUploadRequest.documentHolder
                    documentType = nonIdentityDocumentUploadRequest.documentType
                    file = nonIdentityDocumentUploadRequest.file
                    documentNumber = nonIdentityDocumentUploadRequest.documentNumber
                    issuingAuthority = nonIdentityDocumentUploadRequest.issuingAuthority
                    side = nonIdentityDocumentUploadRequest.side
                    additionalProperties =
                        nonIdentityDocumentUploadRequest.additionalProperties.toMutableMap()
                }
                ...
                /**
                 * Returns an immutable instance of [NonIdentityDocumentUploadRequest].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 *
                 * The following fields are required:
                 ...
                 * @throws IllegalStateException if any required field is unset.
                 */
                fun build(): NonIdentityDocumentUploadRequest =
                    NonIdentityDocumentUploadRequest(
                        checkRequired("country", country),
                        checkRequired("documentHolder", documentHolder),
                        checkRequired("documentType", documentType),
             ...
             *   match its expected type.
             */
            fun validate(): NonIdentityDocumentUploadRequest = apply {
                if (validated) {
                    return@apply
                }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is NonIdentityDocumentUploadRequest &&
                    country == other.country &&
                    documentHolder == other.documentHolder &&
                    documentType == other.documentType &&
                    file == other.file &&
            ...
            override fun toString() =
                "NonIdentityDocumentUploadRequest{country=$country, documentHolder=$documentHolder, documentType=$documentType, file=$file, documentNumber=$documentNumber, issuingAuthority=$issuingAuthority, side=$side, additionalProperties=$additionalProperties}"
        }
    }
