...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("type") @ExcludeMissing type: JsonField<AuthMethod.Type> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.type] with a well-typed [AuthMethod.Type] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
    ...
    override fun toString() =
        "CredentialVerifyResponse{id=$id, accountId=$accountId, createdAt=$createdAt, nickname=$nickname, type=$type, updatedAt=$updatedAt, expiresAt=$expiresAt, encryptedSessionSigningKey=$encryptedSessionSigningKey, additionalProperties=$additionalProperties}"
}
