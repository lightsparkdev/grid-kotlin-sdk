...
private constructor(
     ...
     * import com.lightspark.grid.core.JsonValue
     *
     * val result: String? = customerDeleteResponse.accept(object : CustomerDeleteResponse.Visitor<String?> {
    ...
    companion object {
        ...
        fun ofIndividual(individual: IndividualCustomer) =
            CustomerDeleteResponse(individual = individual)

        fun ofBusiness(business: BusinessCustomer) = CustomerDeleteResponse(business = business)
    }
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw LightsparkGridInvalidDataException("Unknown CustomerDeleteResponse: $json")
        }
    }
        ...
        override fun ObjectCodec.deserialize(node: JsonNode): CustomerDeleteResponse {
            ...
            when (customerType) {
                "INDIVIDUAL" -> {
                    ...
                    } ?: CustomerDeleteResponse(_json = json)
                }
                "BUSINESS" -> {
            ...
            return CustomerDeleteResponse(_json = json)
        }
    }
