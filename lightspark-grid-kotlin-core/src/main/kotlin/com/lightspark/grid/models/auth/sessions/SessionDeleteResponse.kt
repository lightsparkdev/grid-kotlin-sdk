...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sessionDeleteResponse: SessionDeleteResponse) = apply {
            status = sessionDeleteResponse.status
            message = sessionDeleteResponse.message
    ...
    override fun toString() =
        "SessionDeleteResponse{status=$status, message=$message, additionalProperties=$additionalProperties}"
}
