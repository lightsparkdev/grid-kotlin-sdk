...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UgxAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ugxAccountInfo: UgxAccountInfo) = apply {
            accountType = ugxAccountInfo.accountType
            paymentRails = ugxAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = ugxAccountInfo.phoneNumber
            provider = ugxAccountInfo.provider
            additionalProperties = ugxAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UgxAccountInfo].
         *
    ...
    fun validate(): UgxAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UgxAccountInfo &&
    ...
    override fun toString() =
        "UgxAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
}
