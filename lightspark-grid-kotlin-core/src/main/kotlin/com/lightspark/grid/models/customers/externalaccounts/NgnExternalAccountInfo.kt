...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<NgnAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NgnExternalAccountInfo].
         *
    ...
    /** A builder for [NgnExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(ngnExternalAccountInfo: NgnExternalAccountInfo) = apply {
            accountNumber = ngnExternalAccountInfo.accountNumber
            accountType = ngnExternalAccountInfo.accountType
            bankName = ngnExternalAccountInfo.bankName
            paymentRails = ngnExternalAccountInfo.paymentRails.map { it.toMutableList() }
            beneficiary = ngnExternalAccountInfo.beneficiary
            additionalProperties = ngnExternalAccountInfo.additionalProperties.toMutableMap()
        }
         ...
         * `List<NgnAccountInfo.PaymentRail>` value instead. This method is primarily for setting
        ...
        /**
         * Returns an immutable instance of [NgnExternalAccountInfo].
         *
         ...
         */
        fun build(): NgnExternalAccountInfo =
     ...
     *   expected type.
     */
    fun validate(): NgnExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: NgnBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: NgnBeneficiary) = individual.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NgnExternalAccountInfo &&
    ...
    override fun toString() =
        "NgnExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
