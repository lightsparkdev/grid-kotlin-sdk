...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThbBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(thbBeneficiary: ThbBeneficiary) = apply {
            beneficiaryType = thbBeneficiary.beneficiaryType
            fullName = thbBeneficiary.fullName
            address = thbBeneficiary.address
            birthDate = thbBeneficiary.birthDate
            countryOfResidence = thbBeneficiary.countryOfResidence
            email = thbBeneficiary.email
            nationality = thbBeneficiary.nationality
            phoneNumber = thbBeneficiary.phoneNumber
            registrationNumber = thbBeneficiary.registrationNumber
            additionalProperties = thbBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ThbBeneficiary].
         *
    ...
    fun validate(): ThbBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThbBeneficiary &&
    ...
    override fun toString() =
        "ThbBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, registrationNumber=$registrationNumber, additionalProperties=$additionalProperties}"
}
