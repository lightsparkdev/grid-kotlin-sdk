...
class IdrExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IdrExternalAccountCreateInfo].
         *
    ...
    /** A builder for [IdrExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(idrExternalAccountCreateInfo: IdrExternalAccountCreateInfo) = apply {
            accountNumber = idrExternalAccountCreateInfo.accountNumber
            accountType = idrExternalAccountCreateInfo.accountType
            bankName = idrExternalAccountCreateInfo.bankName
            beneficiary = idrExternalAccountCreateInfo.beneficiary
            phoneNumber = idrExternalAccountCreateInfo.phoneNumber
            swiftCode = idrExternalAccountCreateInfo.swiftCode
            additionalProperties = idrExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IdrExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): IdrExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): IdrExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IdrExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "IdrExternalAccountCreateInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, phoneNumber=$phoneNumber, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
}
