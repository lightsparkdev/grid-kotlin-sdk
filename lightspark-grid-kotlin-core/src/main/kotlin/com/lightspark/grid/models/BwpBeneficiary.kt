...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BwpBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bwpBeneficiary: BwpBeneficiary) = apply {
            beneficiaryType = bwpBeneficiary.beneficiaryType
            fullName = bwpBeneficiary.fullName
            address = bwpBeneficiary.address
            birthDate = bwpBeneficiary.birthDate
            countryOfResidence = bwpBeneficiary.countryOfResidence
            email = bwpBeneficiary.email
            nationality = bwpBeneficiary.nationality
            phoneNumber = bwpBeneficiary.phoneNumber
            additionalProperties = bwpBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BwpBeneficiary].
         *
    ...
    fun validate(): BwpBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BwpBeneficiary &&
    ...
    override fun toString() =
        "BwpBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
