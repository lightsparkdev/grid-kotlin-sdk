...
private constructor(
     ...
     * import com.lightspark.grid.core.JsonValue
     *
     * val result: String? = customerRetrieveResponse.accept(object : CustomerRetrieveResponse.Visitor<String?> {
    ...
    companion object {
        ...
        fun ofIndividual(individual: IndividualCustomer) =
            CustomerRetrieveResponse(individual = individual)

        fun ofBusiness(business: BusinessCustomer) = CustomerRetrieveResponse(business = business)
    }
        ...
        override fun ObjectCodec.deserialize(node: JsonNode): CustomerRetrieveResponse {
            ...
            when (customerType) {
                "INDIVIDUAL" -> {
                    ...
                    } ?: CustomerRetrieveResponse(_json = json)
                }
                "BUSINESS" -> {
            ...
            return CustomerRetrieveResponse(_json = json)
        }
    }
