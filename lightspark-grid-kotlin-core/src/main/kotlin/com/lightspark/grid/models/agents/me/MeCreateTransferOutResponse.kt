 ...
 * operation type.
 */
class MeCreateTransferOutResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MeCreateTransferOutResponse].
         *
    ...
    /** A builder for [MeCreateTransferOutResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(meCreateTransferOutResponse: MeCreateTransferOutResponse) = apply {
            id = meCreateTransferOutResponse.id
            agentId = meCreateTransferOutResponse.agentId
            createdAt = meCreateTransferOutResponse.createdAt
            customerId = meCreateTransferOutResponse.customerId
            platformCustomerId = meCreateTransferOutResponse.platformCustomerId
            status = meCreateTransferOutResponse.status
            type = meCreateTransferOutResponse.type
            updatedAt = meCreateTransferOutResponse.updatedAt
            quote = meCreateTransferOutResponse.quote
            rejectionReason = meCreateTransferOutResponse.rejectionReason
            transaction = meCreateTransferOutResponse.transaction
            transferDetails = meCreateTransferOutResponse.transferDetails
            additionalProperties = meCreateTransferOutResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MeCreateTransferOutResponse].
         *
         ...
         */
        fun build(): MeCreateTransferOutResponse =
     ...
     *   expected type.
     */
    fun validate(): MeCreateTransferOutResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MeCreateTransferOutResponse &&
            id == other.id &&
