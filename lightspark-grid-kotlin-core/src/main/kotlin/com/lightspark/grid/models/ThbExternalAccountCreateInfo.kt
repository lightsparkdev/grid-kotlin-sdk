...
class ThbExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThbExternalAccountCreateInfo].
         *
    ...
    /** A builder for [ThbExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(thbExternalAccountCreateInfo: ThbExternalAccountCreateInfo) = apply {
            accountNumber = thbExternalAccountCreateInfo.accountNumber
            accountType = thbExternalAccountCreateInfo.accountType
            bankName = thbExternalAccountCreateInfo.bankName
            beneficiary = thbExternalAccountCreateInfo.beneficiary
            swiftCode = thbExternalAccountCreateInfo.swiftCode
            additionalProperties = thbExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        fun beneficiary(individual: ThbBeneficiary) =
        ...
        /**
         * Returns an immutable instance of [ThbExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): ThbExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): ThbExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    class Beneficiary
    private constructor(
        private val individual: ThbBeneficiary? = null,
        private val business: BusinessBeneficiary? = null,
        private val _json: JsonValue? = null,
    ) {

        fun individual(): ThbBeneficiary? = individual
        ...
        fun asIndividual(): ThbBeneficiary = individual.getOrThrow("individual")
         ...
         *     override fun visitIndividual(individual: ThbBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        fun validate(): Beneficiary = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitIndividual(individual: ThbBeneficiary) {
                        individual.validate()
                    }
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: ThbBeneficiary) = individual.validity()
        ...
        companion object {
            ...
            fun ofIndividual(individual: ThbBeneficiary) = Beneficiary(individual = individual)
        ...
        interface Visitor<out T> {
            ...
            fun visitIndividual(individual: ThbBeneficiary): T
        ...
        internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                ...
                when (beneficiaryType) {
                    "INDIVIDUAL" -> {
                        return tryDeserialize(node, jacksonTypeRef<ThbBeneficiary>())?.let {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThbExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "ThbExternalAccountCreateInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
}
