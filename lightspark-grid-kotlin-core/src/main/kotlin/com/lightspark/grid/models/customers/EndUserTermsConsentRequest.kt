...
class EndUserTermsConsentRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EndUserTermsConsentRequest].
         *
    ...
    /** A builder for [EndUserTermsConsentRequest]. */
    class Builder internal constructor() {
        ...
        internal fun from(endUserTermsConsentRequest: EndUserTermsConsentRequest) = apply {
            acceptanceMethod = endUserTermsConsentRequest.acceptanceMethod
            acceptedAt = endUserTermsConsentRequest.acceptedAt
            ipAddress = endUserTermsConsentRequest.ipAddress
            termsVersion = endUserTermsConsentRequest.termsVersion
            additionalProperties = endUserTermsConsentRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EndUserTermsConsentRequest].
         *
         ...
         */
        fun build(): EndUserTermsConsentRequest =
     ...
     *   expected type.
     */
    fun validate(): EndUserTermsConsentRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EndUserTermsConsentRequest &&
    ...
    override fun toString() =
        "EndUserTermsConsentRequest{acceptanceMethod=$acceptanceMethod, acceptedAt=$acceptedAt, ipAddress=$ipAddress, termsVersion=$termsVersion, additionalProperties=$additionalProperties}"
}
