 ...
 */
class CardState @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        fun of(value: String) = CardState(JsonField.of(value))
    }

    /** An enum containing [CardState]'s known values. */
    enum class Known {
        PENDING_KYC,
        PENDING_ISSUE,
        ACTIVE,
    ...
    /**
     * An enum containing [CardState]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [CardState] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        FROZEN,
        CLOSED,
        /** An enum member indicating that [CardState] was instantiated with an unknown value. */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            FROZEN -> Known.FROZEN
            CLOSED -> Known.CLOSED
            else -> throw LightsparkGridInvalidDataException("Unknown CardState: $value")
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CardState && value == other.value
    }
