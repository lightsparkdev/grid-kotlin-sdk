 ...
 * operation type.
 */
class AgentListApprovalsResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentListApprovalsResponse].
         *
    ...
    /** A builder for [AgentListApprovalsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(agentListApprovalsResponse: AgentListApprovalsResponse) = apply {
            id = agentListApprovalsResponse.id
            agentId = agentListApprovalsResponse.agentId
            createdAt = agentListApprovalsResponse.createdAt
            customerId = agentListApprovalsResponse.customerId
            platformCustomerId = agentListApprovalsResponse.platformCustomerId
            status = agentListApprovalsResponse.status
            type = agentListApprovalsResponse.type
            updatedAt = agentListApprovalsResponse.updatedAt
            quote = agentListApprovalsResponse.quote
            rejectionReason = agentListApprovalsResponse.rejectionReason
            transaction = agentListApprovalsResponse.transaction
            transferDetails = agentListApprovalsResponse.transferDetails
            additionalProperties = agentListApprovalsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentListApprovalsResponse].
         *
         ...
         */
        fun build(): AgentListApprovalsResponse =
     ...
     *   expected type.
     */
    fun validate(): AgentListApprovalsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentListApprovalsResponse &&
            id == other.id &&
