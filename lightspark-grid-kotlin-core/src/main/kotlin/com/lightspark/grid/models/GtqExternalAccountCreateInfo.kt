...
class GtqExternalAccountCreateInfo
...
private constructor(
    ...
    /**
     * The name of the beneficiary's bank. Must be one of the `bankName` values `GET /discoveries`
     * returns for this country and currency. Send it exactly as returned; any other name is
     * rejected.
     *
     * @throws LightsparkGridInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GtqExternalAccountCreateInfo].
         *
    ...
    /** A builder for [GtqExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(gtqExternalAccountCreateInfo: GtqExternalAccountCreateInfo) = apply {
            accountNumber = gtqExternalAccountCreateInfo.accountNumber
            accountType = gtqExternalAccountCreateInfo.accountType
            bankAccountType = gtqExternalAccountCreateInfo.bankAccountType
            bankName = gtqExternalAccountCreateInfo.bankName
            beneficiary = gtqExternalAccountCreateInfo.beneficiary
            additionalProperties = gtqExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * The name of the beneficiary's bank. Must be one of the `bankName` values `GET
         * /discoveries` returns for this country and currency. Send it exactly as returned; any
        ...
        /**
         * Returns an immutable instance of [GtqExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): GtqExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): GtqExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: GtqBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: GtqBeneficiary) = individual.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GtqExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "GtqExternalAccountCreateInfo{accountNumber=$accountNumber, accountType=$accountType, bankAccountType=$bankAccountType, bankName=$bankName, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
