...
private constructor(
    ...
    ) : this(accountNumber, accountType, beneficiary, phoneNumber, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(gtqExternalAccountCreateInfo: GtqExternalAccountCreateInfo) = apply {
            ...
            phoneNumber = gtqExternalAccountCreateInfo.phoneNumber
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountNumber, accountType, beneficiary, phoneNumber, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "GtqExternalAccountCreateInfo{accountNumber=$accountNumber, accountType=$accountType, beneficiary=$beneficiary, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
