...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SlvBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(slvBeneficiary: SlvBeneficiary) = apply {
            beneficiaryType = slvBeneficiary.beneficiaryType
            fullName = slvBeneficiary.fullName
            address = slvBeneficiary.address
            birthDate = slvBeneficiary.birthDate
            countryOfResidence = slvBeneficiary.countryOfResidence
            email = slvBeneficiary.email
            nationality = slvBeneficiary.nationality
            phoneNumber = slvBeneficiary.phoneNumber
            additionalProperties = slvBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SlvBeneficiary].
         *
     ...
     *   expected type.
     */
    fun validate(): SlvBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SlvBeneficiary &&
    ...
    override fun toString() =
        "SlvBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
