...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
        ...
        fun build(): ZmwExternalAccountInfo =
            ZmwExternalAccountInfo(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ZmwExternalAccountInfo && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ZmwExternalAccountInfo{additionalProperties=$additionalProperties}"
}
