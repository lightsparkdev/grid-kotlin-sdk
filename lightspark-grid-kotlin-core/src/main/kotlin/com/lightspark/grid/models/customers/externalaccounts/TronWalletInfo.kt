...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): TronWalletInfo = TronWalletInfo(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TronWalletInfo && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "TronWalletInfo{additionalProperties=$additionalProperties}"
}
