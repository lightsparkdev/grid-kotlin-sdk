...
class EstimateCryptoWithdrawalFeeResponse
...
private constructor(
    ...
    /** A builder for [EstimateCryptoWithdrawalFeeResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            estimateCryptoWithdrawalFeeResponse: EstimateCryptoWithdrawalFeeResponse
        ) = apply {
            applicationFee = estimateCryptoWithdrawalFeeResponse.applicationFee
            netAmount = estimateCryptoWithdrawalFeeResponse.netAmount
            networkFee = estimateCryptoWithdrawalFeeResponse.networkFee
            networkFeeAsset = estimateCryptoWithdrawalFeeResponse.networkFeeAsset
            totalFee = estimateCryptoWithdrawalFeeResponse.totalFee
            additionalProperties =
                estimateCryptoWithdrawalFeeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EstimateCryptoWithdrawalFeeResponse].
         *
         ...
         */
        fun build(): EstimateCryptoWithdrawalFeeResponse =
            EstimateCryptoWithdrawalFeeResponse(
     ...
     *   expected type.
     */
    fun validate(): EstimateCryptoWithdrawalFeeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EstimateCryptoWithdrawalFeeResponse &&
    ...
    override fun toString() =
        "EstimateCryptoWithdrawalFeeResponse{applicationFee=$applicationFee, netAmount=$netAmount, networkFee=$networkFee, networkFeeAsset=$networkFeeAsset, totalFee=$totalFee, additionalProperties=$additionalProperties}"
}
