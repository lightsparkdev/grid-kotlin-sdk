...
package com.lightspark.grid.models.agents.me.transactions
...
private constructor(
    ...
    override fun toString() =
        "TransactionListParams{accountIdentifier=$accountIdentifier, cursor=$cursor, endDate=$endDate, limit=$limit, receiverAccountIdentifier=$receiverAccountIdentifier, reference=$reference, senderAccountIdentifier=$senderAccountIdentifier, sortOrder=$sortOrder, startDate=$startDate, status=$status, type=$type, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
