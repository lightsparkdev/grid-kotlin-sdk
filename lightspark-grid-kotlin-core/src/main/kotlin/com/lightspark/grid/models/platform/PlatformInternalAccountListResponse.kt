...
class PlatformInternalAccountListResponse
...
private constructor(
    ...
    /** A builder for [PlatformInternalAccountListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            platformInternalAccountListResponse: PlatformInternalAccountListResponse
        ) = apply {
            data = platformInternalAccountListResponse.data.map { it.toMutableList() }
            additionalProperties =
                platformInternalAccountListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PlatformInternalAccountListResponse].
         *
         ...
         */
        fun build(): PlatformInternalAccountListResponse =
            PlatformInternalAccountListResponse(
     ...
     *   expected type.
     */
    fun validate(): PlatformInternalAccountListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlatformInternalAccountListResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "PlatformInternalAccountListResponse{data=$data, additionalProperties=$additionalProperties}"
}
