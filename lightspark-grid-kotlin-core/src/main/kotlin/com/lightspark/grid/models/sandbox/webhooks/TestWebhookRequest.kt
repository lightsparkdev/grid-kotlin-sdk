...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TestWebhookRequest].
         *
    ...
    /** A builder for [TestWebhookRequest]. */
    class Builder internal constructor() {
        ...
        internal fun from(testWebhookRequest: TestWebhookRequest) = apply {
            id = testWebhookRequest.id
            timestamp = testWebhookRequest.timestamp
            type = testWebhookRequest.type
            additionalProperties = testWebhookRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TestWebhookRequest].
         *
     ...
     *   expected type.
     */
    fun validate(): TestWebhookRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "TestWebhookRequest{id=$id, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
