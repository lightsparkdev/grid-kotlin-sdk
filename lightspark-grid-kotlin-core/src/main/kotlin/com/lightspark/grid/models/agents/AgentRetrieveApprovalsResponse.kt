...
class AgentRetrieveApprovalsResponse
...
private constructor(
    ...
    /** A builder for [AgentRetrieveApprovalsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(agentRetrieveApprovalsResponse: AgentRetrieveApprovalsResponse) = apply {
            data = agentRetrieveApprovalsResponse.data.map { it.toMutableList() }
            hasMore = agentRetrieveApprovalsResponse.hasMore
            nextCursor = agentRetrieveApprovalsResponse.nextCursor
            totalCount = agentRetrieveApprovalsResponse.totalCount
            additionalProperties =
                agentRetrieveApprovalsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentRetrieveApprovalsResponse].
         *
         ...
         */
        fun build(): AgentRetrieveApprovalsResponse =
            AgentRetrieveApprovalsResponse(
     ...
     *   expected type.
     */
    fun validate(): AgentRetrieveApprovalsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentRetrieveApprovalsResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "AgentRetrieveApprovalsResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
