...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VndBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(vndBeneficiary: VndBeneficiary) = apply {
            beneficiaryType = vndBeneficiary.beneficiaryType
            fullName = vndBeneficiary.fullName
            address = vndBeneficiary.address
            birthDate = vndBeneficiary.birthDate
            countryOfResidence = vndBeneficiary.countryOfResidence
            email = vndBeneficiary.email
            nationality = vndBeneficiary.nationality
            phoneNumber = vndBeneficiary.phoneNumber
            registrationNumber = vndBeneficiary.registrationNumber
            additionalProperties = vndBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VndBeneficiary].
         *
    ...
    fun validate(): VndBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VndBeneficiary &&
    ...
    override fun toString() =
        "VndBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, registrationNumber=$registrationNumber, additionalProperties=$additionalProperties}"
}
