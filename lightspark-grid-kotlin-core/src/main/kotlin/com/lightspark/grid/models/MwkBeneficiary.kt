...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MwkBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(mwkBeneficiary: MwkBeneficiary) = apply {
            beneficiaryType = mwkBeneficiary.beneficiaryType
            fullName = mwkBeneficiary.fullName
            address = mwkBeneficiary.address
            birthDate = mwkBeneficiary.birthDate
            countryOfResidence = mwkBeneficiary.countryOfResidence
            email = mwkBeneficiary.email
            nationality = mwkBeneficiary.nationality
            phoneNumber = mwkBeneficiary.phoneNumber
            additionalProperties = mwkBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MwkBeneficiary].
         *
    ...
    fun validate(): MwkBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MwkBeneficiary &&
    ...
    override fun toString() =
        "MwkBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
