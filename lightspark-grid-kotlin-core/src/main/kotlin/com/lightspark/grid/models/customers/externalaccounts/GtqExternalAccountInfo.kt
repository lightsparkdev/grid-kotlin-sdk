...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<GtqAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GtqExternalAccountInfo].
         *
    ...
    /** A builder for [GtqExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(gtqExternalAccountInfo: GtqExternalAccountInfo) = apply {
            ...
            phoneNumber = gtqExternalAccountInfo.phoneNumber
         ...
         * [GtqAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<GtqAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<GtqAccountInfo.PaymentRail>>) = apply {
        ...
        /**
         * Returns an immutable instance of [GtqExternalAccountInfo].
         *
         ...
         */
        fun build(): GtqExternalAccountInfo =
    ...
    fun validate(): GtqExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GtqExternalAccountInfo &&
    ...
    override fun toString() =
        "GtqExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
