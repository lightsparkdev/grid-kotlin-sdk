 ...
 */
class AgentListApprovalsParams
private constructor(
    ...
    companion object {
        ...
        fun none(): AgentListApprovalsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AgentListApprovalsParams]. */
        fun builder() = Builder()
    }

    /** A builder for [AgentListApprovalsParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(agentListApprovalsParams: AgentListApprovalsParams) = apply {
            agentId = agentListApprovalsParams.agentId
            cursor = agentListApprovalsParams.cursor
            customerId = agentListApprovalsParams.customerId
            endDate = agentListApprovalsParams.endDate
            limit = agentListApprovalsParams.limit
            sortOrder = agentListApprovalsParams.sortOrder
            startDate = agentListApprovalsParams.startDate
            additionalHeaders = agentListApprovalsParams.additionalHeaders.toBuilder()
            additionalQueryParams = agentListApprovalsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AgentListApprovalsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AgentListApprovalsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentListApprovalsParams &&
    ...
    override fun toString() =
        "AgentListApprovalsParams{agentId=$agentId, cursor=$cursor, customerId=$customerId, endDate=$endDate, limit=$limit, sortOrder=$sortOrder, startDate=$startDate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
