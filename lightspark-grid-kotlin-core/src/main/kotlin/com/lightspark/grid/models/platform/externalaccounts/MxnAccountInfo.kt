...
private constructor(
    ...
    ) : this(accountType, clabeNumber, paymentRails, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MxnAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(mxnAccountInfo: MxnAccountInfo) = apply {
            accountType = mxnAccountInfo.accountType
            clabeNumber = mxnAccountInfo.clabeNumber
            paymentRails = mxnAccountInfo.paymentRails.map { it.toMutableList() }
            additionalProperties = mxnAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MxnAccountInfo].
         *
    ...
    fun validate(): MxnAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MxnAccountInfo &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountType, clabeNumber, paymentRails, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "MxnAccountInfo{accountType=$accountType, clabeNumber=$clabeNumber, paymentRails=$paymentRails, additionalProperties=$additionalProperties}"
}
