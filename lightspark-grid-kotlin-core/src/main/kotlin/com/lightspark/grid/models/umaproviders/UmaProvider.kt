...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [UmaProvider]. */
        fun builder() = Builder()
    }

    /** A builder for [UmaProvider]. */
    class Builder internal constructor() {
        ...
        internal fun from(umaProvider: UmaProvider) = apply {
            allowListStatus = umaProvider.allowListStatus
            domain = umaProvider.domain
            lei = umaProvider.lei
            logoUrl = umaProvider.logoUrl
            name = umaProvider.name
            supportedCurrencies = umaProvider.supportedCurrencies.map { it.toMutableList() }
            supportedRegions = umaProvider.supportedRegions.map { it.toMutableList() }
            additionalProperties = umaProvider.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UmaProvider].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UmaProvider =
            UmaProvider(
                allowListStatus,
                domain,
                lei,
     ...
     *   expected type.
     */
    fun validate(): UmaProvider = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "UmaProvider{allowListStatus=$allowListStatus, domain=$domain, lei=$lei, logoUrl=$logoUrl, name=$name, supportedCurrencies=$supportedCurrencies, supportedRegions=$supportedRegions, additionalProperties=$additionalProperties}"
}
