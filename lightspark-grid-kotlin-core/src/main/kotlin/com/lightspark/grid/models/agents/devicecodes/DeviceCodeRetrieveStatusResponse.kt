...
class DeviceCodeRetrieveStatusResponse
...
private constructor(
    ...
    /** A builder for [DeviceCodeRetrieveStatusResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(deviceCodeRetrieveStatusResponse: DeviceCodeRetrieveStatusResponse) =
            apply {
                code = deviceCodeRetrieveStatusResponse.code
                redeemed = deviceCodeRetrieveStatusResponse.redeemed
                additionalProperties =
                    deviceCodeRetrieveStatusResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [DeviceCodeRetrieveStatusResponse].
         *
         ...
         */
        fun build(): DeviceCodeRetrieveStatusResponse =
            DeviceCodeRetrieveStatusResponse(
     ...
     *   expected type.
     */
    fun validate(): DeviceCodeRetrieveStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeviceCodeRetrieveStatusResponse &&
            code == other.code &&
    ...
    override fun toString() =
        "DeviceCodeRetrieveStatusResponse{code=$code, redeemed=$redeemed, additionalProperties=$additionalProperties}"
}
