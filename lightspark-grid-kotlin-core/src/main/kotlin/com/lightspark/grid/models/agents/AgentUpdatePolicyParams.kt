...
private constructor(
     ...
     */
    fun accountRestrictions(): AgentAccountRestrictions? = body.accountRestrictions()
     ...
     *   the server responded with an unexpected value).
     */
    fun approvalThresholds(): AgentApprovalThresholds? = body.approvalThresholds()
     ...
     * type.
     */
    fun _accountRestrictions(): JsonField<AgentAccountRestrictions> = body._accountRestrictions()
     ...
     * type.
     */
    fun _approvalThresholds(): JsonField<AgentApprovalThresholds> = body._approvalThresholds()
    ...
    class Builder internal constructor() {
         ...
         * account.
         */
        fun accountRestrictions(accountRestrictions: AgentAccountRestrictions) = apply {
         ...
         */
        fun approvalThresholds(approvalThresholds: AgentApprovalThresholds) = apply {
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.accountRestrictions] with a well-typed
             * [AgentAccountRestrictions] value instead. This method is primarily for setting the
             * field to an undocumented or not yet supported value.
             */
            fun accountRestrictions(accountRestrictions: JsonField<AgentAccountRestrictions>) =
                apply {
             ...
             *
             * You should usually call [Builder.approvalThresholds] with a well-typed
             * [AgentApprovalThresholds] value instead. This method is primarily for setting the
             * field to an undocumented or not yet supported value.
             */
            fun approvalThresholds(approvalThresholds: JsonField<AgentApprovalThresholds>) = apply {
