...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         * ```
         */
        fun bdtAccountAccountInfo(beneficiary: BdtExternalAccountCreateInfo.Beneficiary) = apply {
            body.bdtAccountAccountInfo(beneficiary)
        }
         ...
         */
        fun bdtAccountAccountInfo(individual: BdtBeneficiary) = apply {
            body.bdtAccountAccountInfo(individual)
        }
         ...
         */
        fun bdtAccountAccountInfo(business: BusinessBeneficiary) = apply {
            body.bdtAccountAccountInfo(business)
        }
         ...
         * ```
         */
        fun businessBdtAccountAccountInfo(legalName: String) = apply {
            body.businessBdtAccountAccountInfo(legalName)
        }
         ...
         * ```
         */
        fun copAccountAccountInfo(beneficiary: CopExternalAccountCreateInfo.Beneficiary) = apply {
            body.copAccountAccountInfo(beneficiary)
        }
         ...
         */
        fun copAccountAccountInfo(individual: CopBeneficiary) = apply {
            body.copAccountAccountInfo(individual)
        }
         ...
         * ```
         */
        fun individualCopAccountAccountInfo(fullName: String) = apply {
            body.individualCopAccountAccountInfo(fullName)
        }
         ...
         */
        fun copAccountAccountInfo(business: BusinessBeneficiary) = apply {
            body.copAccountAccountInfo(business)
        }
         ...
         * ```
         */
        fun businessCopAccountAccountInfo(legalName: String) = apply {
            body.businessCopAccountAccountInfo(legalName)
        }
         ...
         * ```
         */
        fun ghsAccountAccountInfo(beneficiary: GhsExternalAccountCreateInfo.Beneficiary) = apply {
            body.ghsAccountAccountInfo(beneficiary)
        }
         ...
         */
        fun ghsAccountAccountInfo(business: BusinessBeneficiary) = apply {
            body.ghsAccountAccountInfo(business)
        }
         ...
         * ```
         */
        fun businessGhsAccountAccountInfo(legalName: String) = apply {
            body.businessGhsAccountAccountInfo(legalName)
        }
         ...
         * ```
         */
        fun pkrAccountAccountInfo(beneficiary: PkrExternalAccountCreateInfo.Beneficiary) = apply {
            body.pkrAccountAccountInfo(beneficiary)
        }
         ...
         */
        fun pkrAccountAccountInfo(business: BusinessBeneficiary) = apply {
            body.pkrAccountAccountInfo(business)
        }
         ...
         * ```
         */
        fun businessPkrAccountAccountInfo(legalName: String) = apply {
            body.businessPkrAccountAccountInfo(legalName)
        }

        /** Alias for calling [accountInfo] with `AccountInfo.ofSlvAccount(slvAccount)`. */
        fun accountInfo(slvAccount: AccountInfo.SlvAccount) = apply { body.accountInfo(slvAccount) }

        /**
         * Alias for calling [accountInfo] with the following:
         * ```kotlin
         * AccountInfo.SlvAccount.builder()
         *     .beneficiary(beneficiary)
         *     .build()
         * ```
         */
        fun slvAccountAccountInfo(beneficiary: AccountInfo.SlvAccount.Beneficiary) = apply {
            body.slvAccountAccountInfo(beneficiary)
        }

        /**
         * Alias for calling [slvAccountAccountInfo] with
         * `AccountInfo.SlvAccount.Beneficiary.ofIndividual(individual)`.
         */
        fun slvAccountAccountInfo(individual: AccountInfo.SlvAccount.Beneficiary.Individual) =
            apply {
         ...
         * ```kotlin
         * AccountInfo.SlvAccount.Beneficiary.Individual.builder()
         *     .fullName(fullName)
         *     .build()
         * ```
         */
        ...
        /**
         * Alias for calling [slvAccountAccountInfo] with
         * `AccountInfo.SlvAccount.Beneficiary.ofBusiness(business)`.
         */
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [accountInfo] with `AccountInfo.ofSlvAccount(slvAccount)`. */
            fun accountInfo(slvAccount: AccountInfo.SlvAccount) =
             ...
             * ```
             */
            fun slvAccountAccountInfo(beneficiary: AccountInfo.SlvAccount.Beneficiary) =
                accountInfo(AccountInfo.SlvAccount.builder().beneficiary(beneficiary).build())
             ...
             */
            fun slvAccountAccountInfo(individual: AccountInfo.SlvAccount.Beneficiary.Individual) =
                slvAccountAccountInfo(AccountInfo.SlvAccount.Beneficiary.ofIndividual(individual))
            ...
            fun slvAccountAccountInfo(business: BusinessBeneficiary) =
                slvAccountAccountInfo(AccountInfo.SlvAccount.Beneficiary.ofBusiness(business))
    ...
    private constructor(
        ...
        companion object {
            ...
            fun ofSlvAccount(slvAccount: SlvAccount) = AccountInfo(slvAccount = slvAccount)
                ...
                when (accountType) {
                    ...
                    "SLV_ACCOUNT" -> {
                        return tryDeserialize(node, jacksonTypeRef<SlvAccount>())?.let {
                            AccountInfo(slvAccount = it, _json = json)
                        } ?: AccountInfo(_json = json)
                    }
                }
        ...
        private constructor(
            ...
            override fun toString() =
                "SlvAccount{accountType=$accountType, beneficiary=$beneficiary, accountNumber=$accountNumber, bankAccountType=$bankAccountType, bankName=$bankName, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
        }
    }
