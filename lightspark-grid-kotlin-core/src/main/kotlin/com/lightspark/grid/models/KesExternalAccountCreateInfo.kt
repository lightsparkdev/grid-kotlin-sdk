...
class KesExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [KesExternalAccountCreateInfo].
         *
    ...
    /** A builder for [KesExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(kesExternalAccountCreateInfo: KesExternalAccountCreateInfo) = apply {
            accountType = kesExternalAccountCreateInfo.accountType
            beneficiary = kesExternalAccountCreateInfo.beneficiary
            phoneNumber = kesExternalAccountCreateInfo.phoneNumber
            provider = kesExternalAccountCreateInfo.provider
            additionalProperties = kesExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [KesExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): KesExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): KesExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: KesBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is KesExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "KesExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
}
