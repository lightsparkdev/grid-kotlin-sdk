 ...
 * in the response.
 */
class CredentialRevokeResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CredentialRevokeResponse].
         *
    ...
    /** A builder for [CredentialRevokeResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(credentialRevokeResponse: CredentialRevokeResponse) = apply {
            expiresAt = credentialRevokeResponse.expiresAt
            payloadToSign = credentialRevokeResponse.payloadToSign
            requestId = credentialRevokeResponse.requestId
            type = credentialRevokeResponse.type
            additionalProperties = credentialRevokeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CredentialRevokeResponse].
         *
         ...
         */
        fun build(): CredentialRevokeResponse =
    ...
    fun validate(): CredentialRevokeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CredentialRevokeResponse &&
    ...
    override fun toString() =
        "CredentialRevokeResponse{expiresAt=$expiresAt, payloadToSign=$payloadToSign, requestId=$requestId, type=$type, additionalProperties=$additionalProperties}"
}
