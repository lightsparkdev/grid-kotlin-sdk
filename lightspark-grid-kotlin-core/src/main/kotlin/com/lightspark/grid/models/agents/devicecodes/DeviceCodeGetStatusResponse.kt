...
class DeviceCodeGetStatusResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DeviceCodeGetStatusResponse].
         *
    ...
    /** A builder for [DeviceCodeGetStatusResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(deviceCodeGetStatusResponse: DeviceCodeGetStatusResponse) = apply {
            code = deviceCodeGetStatusResponse.code
            redeemed = deviceCodeGetStatusResponse.redeemed
            additionalProperties = deviceCodeGetStatusResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DeviceCodeGetStatusResponse].
         *
         ...
         */
        fun build(): DeviceCodeGetStatusResponse =
     ...
     *   expected type.
     */
    fun validate(): DeviceCodeGetStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeviceCodeGetStatusResponse &&
            code == other.code &&
    ...
    override fun toString() =
        "DeviceCodeGetStatusResponse{code=$code, redeemed=$redeemed, additionalProperties=$additionalProperties}"
}
