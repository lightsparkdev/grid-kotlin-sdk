...
class BrlExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrlExternalAccountCreateInfo].
         *
    ...
    /** A builder for [BrlExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(brlExternalAccountCreateInfo: BrlExternalAccountCreateInfo) = apply {
            accountType = brlExternalAccountCreateInfo.accountType
            beneficiary = brlExternalAccountCreateInfo.beneficiary
            pixKey = brlExternalAccountCreateInfo.pixKey
            pixKeyType = brlExternalAccountCreateInfo.pixKeyType
            taxId = brlExternalAccountCreateInfo.taxId
            additionalProperties = brlExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrlExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): BrlExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): BrlExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: BrlBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrlExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "BrlExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, pixKey=$pixKey, pixKeyType=$pixKeyType, taxId=$taxId, additionalProperties=$additionalProperties}"
}
