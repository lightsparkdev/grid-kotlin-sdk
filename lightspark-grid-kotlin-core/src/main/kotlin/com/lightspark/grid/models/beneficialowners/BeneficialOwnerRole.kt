...
class BeneficialOwnerRole @JsonCreator private constructor(private val value: JsonField<String>) :
    Enum {
    ...
    companion object {
        ...
        fun of(value: String) = BeneficialOwnerRole(JsonField.of(value))
    }

    /** An enum containing [BeneficialOwnerRole]'s known values. */
    enum class Known {
        UBO,
        DIRECTOR,
        COMPANY_OFFICER,
    ...
    /**
     * An enum containing [BeneficialOwnerRole]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [BeneficialOwnerRole] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        GENERAL_PARTNER,
        /**
         * An enum member indicating that [BeneficialOwnerRole] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw LightsparkGridInvalidDataException("Unknown BeneficialOwnerRole: $value")
        }
     ...
     *   expected type.
     */
    fun validate(): BeneficialOwnerRole = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BeneficialOwnerRole && value == other.value
    }
