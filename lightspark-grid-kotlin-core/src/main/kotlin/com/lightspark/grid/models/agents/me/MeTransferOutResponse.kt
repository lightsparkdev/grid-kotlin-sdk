...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MeTransferOutResponse].
         *
    ...
    /** A builder for [MeTransferOutResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(meTransferOutResponse: MeTransferOutResponse) = apply {
            id = meTransferOutResponse.id
            agentId = meTransferOutResponse.agentId
            createdAt = meTransferOutResponse.createdAt
            customerId = meTransferOutResponse.customerId
            platformCustomerId = meTransferOutResponse.platformCustomerId
            status = meTransferOutResponse.status
            type = meTransferOutResponse.type
            updatedAt = meTransferOutResponse.updatedAt
            quote = meTransferOutResponse.quote
            rejectionReason = meTransferOutResponse.rejectionReason
            transaction = meTransferOutResponse.transaction
            transferDetails = meTransferOutResponse.transferDetails
            additionalProperties = meTransferOutResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MeTransferOutResponse].
         *
         ...
         */
        fun build(): MeTransferOutResponse =
     ...
     *   expected type.
     */
    fun validate(): MeTransferOutResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MeTransferOutResponse &&
            id == other.id &&
