...
/**
 * Retrieve an external account belonging to the authenticated agent's customer. Returns 404 if the
 * account exists but belongs to a different customer. Requires the MANAGE_EXTERNAL_ACCOUNTS
