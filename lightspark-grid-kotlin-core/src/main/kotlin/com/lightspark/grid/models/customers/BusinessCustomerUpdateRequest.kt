...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(businessCustomerUpdateRequest: BusinessCustomerUpdateRequest) = apply {
            ...
            agreementConsents =
                businessCustomerUpdateRequest.agreementConsents.map { it.toMutableList() }
    ...
    override fun toString() =
        "BusinessCustomerUpdateRequest{customerType=$customerType, address=$address, agreementConsents=$agreementConsents, businessInfo=$businessInfo, currencies=$currencies, email=$email, endUserTermsConsent=$endUserTermsConsent, kybStatus=$kybStatus, phoneNumber=$phoneNumber, umaAddress=$umaAddress, additionalProperties=$additionalProperties}"
}
