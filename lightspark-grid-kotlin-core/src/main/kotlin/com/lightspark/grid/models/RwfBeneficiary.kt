...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RwfBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(rwfBeneficiary: RwfBeneficiary) = apply {
            beneficiaryType = rwfBeneficiary.beneficiaryType
            fullName = rwfBeneficiary.fullName
            address = rwfBeneficiary.address
            birthDate = rwfBeneficiary.birthDate
            countryOfResidence = rwfBeneficiary.countryOfResidence
            email = rwfBeneficiary.email
            nationality = rwfBeneficiary.nationality
            phoneNumber = rwfBeneficiary.phoneNumber
            additionalProperties = rwfBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RwfBeneficiary].
         *
    ...
    fun validate(): RwfBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RwfBeneficiary &&
    ...
    override fun toString() =
        "RwfBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
