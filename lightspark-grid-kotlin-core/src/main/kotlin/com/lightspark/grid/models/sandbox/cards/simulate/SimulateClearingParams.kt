...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(simulateClearingParams: SimulateClearingParams) = apply {
            ...
            body = simulateClearingParams.body.toBuilder()
    ...
    override fun toString() =
        "SimulateClearingParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
