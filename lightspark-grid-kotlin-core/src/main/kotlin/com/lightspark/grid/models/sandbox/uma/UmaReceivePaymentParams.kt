...
private constructor(
    private val receiveRequest: ReceiveRequest,
    private val additionalHeaders: Headers,
    private val additionalQueryParams: QueryParams,
) : Params {

    fun receiveRequest(): ReceiveRequest = receiveRequest

    fun _additionalBodyProperties(): Map<String, JsonValue> = receiveRequest._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var receiveRequest: ReceiveRequest? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(umaReceivePaymentParams: UmaReceivePaymentParams) = apply {
            receiveRequest = umaReceivePaymentParams.receiveRequest
        ...
        fun receiveRequest(receiveRequest: ReceiveRequest) = apply {
        ...
        fun build(): UmaReceivePaymentParams =
            UmaReceivePaymentParams(
                checkRequired("receiveRequest", receiveRequest),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): ReceiveRequest = receiveRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UmaReceivePaymentParams &&
            receiveRequest == other.receiveRequest &&
            additionalHeaders == other.additionalHeaders &&
            additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int =
        Objects.hash(receiveRequest, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "UmaReceivePaymentParams{receiveRequest=$receiveRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
