...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(hkdExternalAccountInfo: HkdExternalAccountInfo) = apply {
            ...
            countries = hkdExternalAccountInfo.countries.map { it.toMutableList() }
    ...
    override fun toString() =
        "HkdExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, countries=$countries, paymentRails=$paymentRails, additionalProperties=$additionalProperties}"
}
