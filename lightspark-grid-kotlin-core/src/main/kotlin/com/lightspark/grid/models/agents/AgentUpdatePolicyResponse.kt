 ...
 * workflows.
 */
class AgentUpdatePolicyResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentUpdatePolicyResponse].
         *
    ...
    /** A builder for [AgentUpdatePolicyResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(agentUpdatePolicyResponse: AgentUpdatePolicyResponse) = apply {
            id = agentUpdatePolicyResponse.id
            createdAt = agentUpdatePolicyResponse.createdAt
            customerId = agentUpdatePolicyResponse.customerId
            isConnected = agentUpdatePolicyResponse.isConnected
            isPaused = agentUpdatePolicyResponse.isPaused
            name = agentUpdatePolicyResponse.name
            policy = agentUpdatePolicyResponse.policy
            updatedAt = agentUpdatePolicyResponse.updatedAt
            usage = agentUpdatePolicyResponse.usage
            additionalProperties = agentUpdatePolicyResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentUpdatePolicyResponse].
         *
         ...
         */
        fun build(): AgentUpdatePolicyResponse =
    ...
    fun validate(): AgentUpdatePolicyResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentUpdatePolicyResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "AgentUpdatePolicyResponse{id=$id, createdAt=$createdAt, customerId=$customerId, isConnected=$isConnected, isPaused=$isPaused, name=$name, policy=$policy, updatedAt=$updatedAt, usage=$usage, additionalProperties=$additionalProperties}"
}
