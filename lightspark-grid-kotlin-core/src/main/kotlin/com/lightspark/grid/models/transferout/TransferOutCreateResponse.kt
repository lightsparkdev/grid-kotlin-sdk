...
@JsonDeserialize(using = TransferOutCreateResponse.Deserializer::class)
@JsonSerialize(using = TransferOutCreateResponse.Serializer::class)
class TransferOutCreateResponse
private constructor(
    ...
    fun validate(): TransferOutCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferOutCreateResponse &&
    ...
    override fun toString(): String =
        when {
            incomingTransaction != null ->
                "TransferOutCreateResponse{incomingTransaction=$incomingTransaction}"
            outgoingTransaction != null ->
                "TransferOutCreateResponse{outgoingTransaction=$outgoingTransaction}"
            _json != null -> "TransferOutCreateResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid TransferOutCreateResponse")
        }
    ...
    /**
     * An interface that defines how to map each variant of [TransferOutCreateResponse] to a value
     * of type [T].
     */
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [TransferOutCreateResponse] to a value of type [T].
         *
         * An instance of [TransferOutCreateResponse] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw LightsparkGridInvalidDataException("Unknown TransferOutCreateResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<TransferOutCreateResponse>(TransferOutCreateResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): TransferOutCreateResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<IncomingTransaction>())?.let {
                            TransferOutCreateResponse(incomingTransaction = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<OutgoingTransaction>())?.let {
                            TransferOutCreateResponse(outgoingTransaction = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> TransferOutCreateResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<TransferOutCreateResponse>(TransferOutCreateResponse::class) {

        override fun serialize(
            value: TransferOutCreateResponse,
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun umaAddressDestination(umaAddress: String) =
                destination(
                    Transaction.Destination.UmaAddress.builder().umaAddress(umaAddress).build()
                )
