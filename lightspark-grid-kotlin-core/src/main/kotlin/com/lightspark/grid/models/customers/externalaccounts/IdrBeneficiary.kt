...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IdrBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(idrBeneficiary: IdrBeneficiary) = apply {
            beneficiaryType = idrBeneficiary.beneficiaryType
            fullName = idrBeneficiary.fullName
            address = idrBeneficiary.address
            birthDate = idrBeneficiary.birthDate
            countryOfResidence = idrBeneficiary.countryOfResidence
            email = idrBeneficiary.email
            nationality = idrBeneficiary.nationality
            phoneNumber = idrBeneficiary.phoneNumber
            registrationNumber = idrBeneficiary.registrationNumber
            additionalProperties = idrBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IdrBeneficiary].
         *
    ...
    fun validate(): IdrBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IdrBeneficiary &&
    ...
    override fun toString() =
        "IdrBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, registrationNumber=$registrationNumber, additionalProperties=$additionalProperties}"
}
