...
class ZmwExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ZmwExternalAccountCreateInfo].
         *
    ...
    /** A builder for [ZmwExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(zmwExternalAccountCreateInfo: ZmwExternalAccountCreateInfo) = apply {
            accountType = zmwExternalAccountCreateInfo.accountType
            beneficiary = zmwExternalAccountCreateInfo.beneficiary
            phoneNumber = zmwExternalAccountCreateInfo.phoneNumber
            provider = zmwExternalAccountCreateInfo.provider
            additionalProperties = zmwExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ZmwExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): ZmwExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): ZmwExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: ZmwBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: ZmwBeneficiary) = individual.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ZmwExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "ZmwExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
}
