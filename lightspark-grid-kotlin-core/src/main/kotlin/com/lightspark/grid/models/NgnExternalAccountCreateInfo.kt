...
class NgnExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NgnExternalAccountCreateInfo].
         *
    ...
    /** A builder for [NgnExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(ngnExternalAccountCreateInfo: NgnExternalAccountCreateInfo) = apply {
            accountNumber = ngnExternalAccountCreateInfo.accountNumber
            accountType = ngnExternalAccountCreateInfo.accountType
            bankName = ngnExternalAccountCreateInfo.bankName
            beneficiary = ngnExternalAccountCreateInfo.beneficiary
            additionalProperties = ngnExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NgnExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): NgnExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): NgnExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NgnExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "NgnExternalAccountCreateInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
