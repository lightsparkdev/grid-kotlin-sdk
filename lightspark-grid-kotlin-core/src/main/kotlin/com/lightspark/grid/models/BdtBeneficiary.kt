...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BdtBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bdtBeneficiary: BdtBeneficiary) = apply {
            beneficiaryType = bdtBeneficiary.beneficiaryType
            countryOfResidence = bdtBeneficiary.countryOfResidence
            fullName = bdtBeneficiary.fullName
            address = bdtBeneficiary.address
            birthDate = bdtBeneficiary.birthDate
            email = bdtBeneficiary.email
            nationality = bdtBeneficiary.nationality
            phoneNumber = bdtBeneficiary.phoneNumber
            additionalProperties = bdtBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BdtBeneficiary].
         *
    ...
    fun validate(): BdtBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BdtBeneficiary &&
    ...
    override fun toString() =
        "BdtBeneficiary{beneficiaryType=$beneficiaryType, countryOfResidence=$countryOfResidence, fullName=$fullName, address=$address, birthDate=$birthDate, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
