...
class InternalAccountStatusWebhookEvent
...
private constructor(
    ...
    /** A builder for [InternalAccountStatusWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(internalAccountStatusWebhookEvent: InternalAccountStatusWebhookEvent) =
            apply {
                id = internalAccountStatusWebhookEvent.id
                data = internalAccountStatusWebhookEvent.data
                timestamp = internalAccountStatusWebhookEvent.timestamp
                type = internalAccountStatusWebhookEvent.type
                additionalProperties =
                    internalAccountStatusWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [InternalAccountStatusWebhookEvent].
         *
         ...
         */
        fun build(): InternalAccountStatusWebhookEvent =
            InternalAccountStatusWebhookEvent(
                checkRequired("id", id),
    ...
    fun validate(): InternalAccountStatusWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            private var fundingPaymentInstructions: JsonField<MutableList<PaymentInstructions>>? =
                null
            ...
            internal fun from(data: Data) = apply {
                ...
                fundingPaymentInstructions =
                    data.fundingPaymentInstructions.map { it.toMutableList() }
            ...
            fun fundingPaymentInstructions(
                ...
                this.fundingPaymentInstructions =
                    fundingPaymentInstructions.map { it.toMutableList() }
            }
             ...
             */
            fun addFundingPaymentInstruction(fundingPaymentInstruction: PaymentInstructions) =
                apply {
                    fundingPaymentInstructions =
                        (fundingPaymentInstructions ?: JsonField.of(mutableListOf())).also {
                            checkKnown("fundingPaymentInstructions", it)
                                .add(fundingPaymentInstruction)
                        }
                }
            ...
            /**
             * The ID of the customer associated with the internal account. If this field is empty,
             * the internal account belongs to the platform.
             */
        ...
        override fun toString() =
            "Data{id=$id, balance=$balance, createdAt=$createdAt, fundingPaymentInstructions=$fundingPaymentInstructions, updatedAt=$updatedAt, customerId=$customerId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InternalAccountStatusWebhookEvent &&
            id == other.id &&
            data == other.data &&
    ...
    override fun toString() =
        "InternalAccountStatusWebhookEvent{id=$id, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
