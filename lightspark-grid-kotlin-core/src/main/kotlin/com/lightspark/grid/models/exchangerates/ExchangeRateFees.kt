...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ExchangeRateFees]. */
        fun builder() = Builder()
    }

    /** A builder for [ExchangeRateFees]. */
    class Builder internal constructor() {

        private var fixed: JsonField<Long> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(exchangeRateFees: ExchangeRateFees) = apply {
            fixed = exchangeRateFees.fixed
            additionalProperties = exchangeRateFees.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExchangeRateFees].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExchangeRateFees = ExchangeRateFees(fixed, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ExchangeRateFees = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExchangeRateFees &&
            fixed == other.fixed &&
    ...
    override fun toString() =
        "ExchangeRateFees{fixed=$fixed, additionalProperties=$additionalProperties}"
}
