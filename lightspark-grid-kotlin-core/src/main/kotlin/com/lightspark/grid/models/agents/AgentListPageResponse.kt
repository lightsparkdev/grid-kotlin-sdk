...
private constructor(
    private val data: JsonField<List<AgentListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<AgentListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<AgentListResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<AgentListResponse>> = data
    ...
    /** A builder for [AgentListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<AgentListResponse>>? = null
        private var hasMore: JsonField<Boolean>? = null
        private var nextCursor: JsonField<String> = JsonMissing.of()
        private var totalCount: JsonField<Long> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(agentListPageResponse: AgentListPageResponse) = apply {
            data = agentListPageResponse.data.map { it.toMutableList() }
            hasMore = agentListPageResponse.hasMore
            nextCursor = agentListPageResponse.nextCursor
            totalCount = agentListPageResponse.totalCount
            additionalProperties = agentListPageResponse.additionalProperties.toMutableMap()
        }

        /** List of agents matching the filter criteria. */
        fun data(data: List<AgentListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<AgentListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<AgentListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [AgentListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: AgentListResponse) = apply {
            this.data =
    ...
    fun validate(): AgentListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "AgentListPageResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
