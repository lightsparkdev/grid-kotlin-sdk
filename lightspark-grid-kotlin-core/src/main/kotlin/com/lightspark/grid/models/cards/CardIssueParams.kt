...
private constructor(
     ...
     */
    fun cardholderId(): String = body.cardholderId()
     ...
     */
    fun platformCardId(): String? = body.platformCardId()
     ...
     */
    fun _cardholderId(): JsonField<String> = body._cardholderId()
     ...
     */
    fun _form(): JsonField<Form> = body._form()
     ...
     */
    fun _platformCardId(): JsonField<String> = body._platformCardId()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardIssueParams: CardIssueParams) = apply {
            body = cardIssueParams.body.toBuilder()
         ...
         */
        fun cardholderId(cardholderId: String) = apply { body.cardholderId(cardholderId) }
        ...
        fun cardholderId(cardholderId: JsonField<String>) = apply {
            body.cardholderId(cardholderId)
        }
         ...
         */
        fun form(form: Form) = apply { body.form(form) }
         ...
         */
        fun form(form: JsonField<Form>) = apply { body.form(form) }
         ...
         * `platformCustomerId` semantics.
         */
        fun platformCardId(platformCardId: String) = apply { body.platformCardId(platformCardId) }
        ...
        fun platformCardId(platformCardId: JsonField<String>) = apply {
            body.platformCardId(platformCardId)
        }
        ...
        fun build(): CardIssueParams =
            CardIssueParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                platformCardId = body.platformCardId
             ...
             * is tried first by Authorization Decisioning. Every card must be bound to at least one
             * source, and every source must belong to the cardholder and be denominated in a
             * card-eligible currency (USDB in v1); otherwise the request is rejected with
             * `FUNDING_SOURCE_INELIGIBLE`.
             */
        ...
        override fun toString() =
            "Body{cardholderId=$cardholderId, form=$form, fundingSources=$fundingSources, platformCardId=$platformCardId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "CardIssueParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
