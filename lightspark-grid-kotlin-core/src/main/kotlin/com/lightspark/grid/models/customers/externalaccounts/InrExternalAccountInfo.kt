...
private constructor(
    ...
    ) : this(accountType, paymentRails, vpa, beneficiary, mutableMapOf())
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<InrAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InrExternalAccountInfo].
         *
    ...
    /** A builder for [InrExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(inrExternalAccountInfo: InrExternalAccountInfo) = apply {
            accountType = inrExternalAccountInfo.accountType
            paymentRails = inrExternalAccountInfo.paymentRails.map { it.toMutableList() }
            vpa = inrExternalAccountInfo.vpa
            beneficiary = inrExternalAccountInfo.beneficiary
            additionalProperties = inrExternalAccountInfo.additionalProperties.toMutableMap()
        }
         ...
         * [InrAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<InrAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<InrAccountInfo.PaymentRail>>) = apply {
        ...
        /**
         * Returns an immutable instance of [InrExternalAccountInfo].
         *
         ...
         */
        fun build(): InrExternalAccountInfo =
    ...
    fun validate(): InrExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InrExternalAccountInfo &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountType, paymentRails, vpa, beneficiary, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "InrExternalAccountInfo{accountType=$accountType, paymentRails=$paymentRails, vpa=$vpa, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
