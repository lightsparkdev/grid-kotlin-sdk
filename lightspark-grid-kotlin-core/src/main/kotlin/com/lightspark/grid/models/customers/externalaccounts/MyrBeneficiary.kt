...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MyrBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(myrBeneficiary: MyrBeneficiary) = apply {
            beneficiaryType = myrBeneficiary.beneficiaryType
            fullName = myrBeneficiary.fullName
            address = myrBeneficiary.address
            birthDate = myrBeneficiary.birthDate
            countryOfResidence = myrBeneficiary.countryOfResidence
            email = myrBeneficiary.email
            nationality = myrBeneficiary.nationality
            phoneNumber = myrBeneficiary.phoneNumber
            registrationNumber = myrBeneficiary.registrationNumber
            additionalProperties = myrBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MyrBeneficiary].
         *
    ...
    fun validate(): MyrBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MyrBeneficiary &&
    ...
    override fun toString() =
        "MyrBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, registrationNumber=$registrationNumber, additionalProperties=$additionalProperties}"
}
