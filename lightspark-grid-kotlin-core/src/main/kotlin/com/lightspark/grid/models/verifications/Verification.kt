...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(verification: Verification) = apply {
            ...
            errors = verification.errors.map { it.toMutableList() }
    ...
    override fun toString() =
        "Verification{id=$id, createdAt=$createdAt, customerId=$customerId, errors=$errors, verificationStatus=$verificationStatus, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
