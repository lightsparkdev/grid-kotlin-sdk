...
/**
 * Retrieve a specific transaction belonging to the authenticated agent's customer. Returns 404 if
 * the transaction exists but belongs to a different customer.
 */
