...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         *     .destinationType(OutgoingTransaction.Destination.ExternalAccountDetails.DestinationType.EXTERNAL_ACCOUNT_DETAILS)
        ...
        fun externalAccountDetailsDestination(externalAccountDetails: ExternalAccountCreate) =
            destination(
                Destination.ExternalAccountDetails.builder()
                    .destinationType(
                        OutgoingTransaction.Destination.ExternalAccountDetails.DestinationType
