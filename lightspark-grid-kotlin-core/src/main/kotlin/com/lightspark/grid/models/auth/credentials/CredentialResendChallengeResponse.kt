...
private constructor(
     ...
     * import com.lightspark.grid.core.JsonValue
     *
     * val result: String? = credentialResendChallengeResponse.accept(object : CredentialResendChallengeResponse.Visitor<String?> {
     *     override fun visitAuthMethod(authMethod: AuthMethod): String? = authMethod.toString()
     *
     *     // ...
     *
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * token; for PASSKEY credentials it is the validated nickname provided at registration
             * time.
             */
