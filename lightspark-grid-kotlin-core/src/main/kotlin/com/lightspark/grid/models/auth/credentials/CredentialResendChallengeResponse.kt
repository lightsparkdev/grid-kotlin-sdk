...
private constructor(
    ...
    /** A builder for [CredentialResendChallengeResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(credentialResendChallengeResponse: CredentialResendChallengeResponse) =
            apply {
                id = credentialResendChallengeResponse.id
                accountId = credentialResendChallengeResponse.accountId
                createdAt = credentialResendChallengeResponse.createdAt
                nickname = credentialResendChallengeResponse.nickname
                type = credentialResendChallengeResponse.type
                updatedAt = credentialResendChallengeResponse.updatedAt
                additionalProperties =
                    credentialResendChallengeResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CredentialResendChallengeResponse].
         *
         ...
         */
        fun build(): CredentialResendChallengeResponse =
            CredentialResendChallengeResponse(
                checkRequired("id", id),
    ...
    override fun toString() =
        "CredentialResendChallengeResponse{id=$id, accountId=$accountId, createdAt=$createdAt, nickname=$nickname, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
