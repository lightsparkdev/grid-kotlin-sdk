...
class MwkExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MwkExternalAccountCreateInfo].
         *
    ...
    /** A builder for [MwkExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(mwkExternalAccountCreateInfo: MwkExternalAccountCreateInfo) = apply {
            accountType = mwkExternalAccountCreateInfo.accountType
            beneficiary = mwkExternalAccountCreateInfo.beneficiary
            phoneNumber = mwkExternalAccountCreateInfo.phoneNumber
            provider = mwkExternalAccountCreateInfo.provider
            additionalProperties = mwkExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MwkExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): MwkExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): MwkExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: MwkBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: MwkBeneficiary) = individual.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MwkExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "MwkExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
}
