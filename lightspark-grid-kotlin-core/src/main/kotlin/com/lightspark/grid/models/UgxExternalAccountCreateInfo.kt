...
class UgxExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UgxExternalAccountCreateInfo].
         *
    ...
    /** A builder for [UgxExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(ugxExternalAccountCreateInfo: UgxExternalAccountCreateInfo) = apply {
            accountType = ugxExternalAccountCreateInfo.accountType
            beneficiary = ugxExternalAccountCreateInfo.beneficiary
            phoneNumber = ugxExternalAccountCreateInfo.phoneNumber
            provider = ugxExternalAccountCreateInfo.provider
            additionalProperties = ugxExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UgxExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): UgxExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): UgxExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: UgxBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: UgxBeneficiary) = individual.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UgxExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "UgxExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
}
