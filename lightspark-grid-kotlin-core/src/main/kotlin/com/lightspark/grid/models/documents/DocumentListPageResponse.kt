...
private constructor(
    private val data: JsonField<List<DocumentListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<DocumentListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<DocumentListResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<DocumentListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<DocumentListResponse>>? = null
        ...
        internal fun from(documentListPageResponse: DocumentListPageResponse) = apply {
            ...
            hasMore = documentListPageResponse.hasMore
        ...
        /** List of documents matching the filter criteria */
        fun data(data: List<DocumentListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<DocumentListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<DocumentListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [DocumentListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: DocumentListResponse) = apply {
            this.data =
    ...
    override fun toString() =
        "DocumentListPageResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
