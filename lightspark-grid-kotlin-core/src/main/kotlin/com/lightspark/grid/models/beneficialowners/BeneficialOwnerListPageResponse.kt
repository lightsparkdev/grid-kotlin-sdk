...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(beneficialOwnerListPageResponse: BeneficialOwnerListPageResponse) =
            apply {
                ...
                hasMore = beneficialOwnerListPageResponse.hasMore
                nextCursor = beneficialOwnerListPageResponse.nextCursor
                totalCount = beneficialOwnerListPageResponse.totalCount
    ...
    override fun toString() =
        "BeneficialOwnerListPageResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
