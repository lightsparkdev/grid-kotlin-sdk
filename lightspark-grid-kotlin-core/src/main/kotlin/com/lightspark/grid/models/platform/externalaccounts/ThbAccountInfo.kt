...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThbAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(thbAccountInfo: ThbAccountInfo) = apply {
            accountNumber = thbAccountInfo.accountNumber
            accountType = thbAccountInfo.accountType
            bankName = thbAccountInfo.bankName
            paymentRails = thbAccountInfo.paymentRails.map { it.toMutableList() }
            swiftCode = thbAccountInfo.swiftCode
            additionalProperties = thbAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ThbAccountInfo].
         *
    ...
    fun validate(): ThbAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThbAccountInfo &&
    ...
    override fun toString() =
        "ThbAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
}
