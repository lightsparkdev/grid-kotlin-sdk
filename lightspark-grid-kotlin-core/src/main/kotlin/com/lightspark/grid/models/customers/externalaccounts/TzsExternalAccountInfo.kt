...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<TzsAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    class Builder internal constructor() {
         ...
         * [TzsAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<TzsAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<TzsAccountInfo.PaymentRail>>) = apply {
    ...
    override fun toString() =
        "TzsExternalAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
