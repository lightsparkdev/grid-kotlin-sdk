...
private constructor(
    ...
    ) : this(accountType, paymentRails, phoneNumber, provider, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BwpAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bwpAccountInfo: BwpAccountInfo) = apply {
            accountType = bwpAccountInfo.accountType
            paymentRails = bwpAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = bwpAccountInfo.phoneNumber
            provider = bwpAccountInfo.provider
            additionalProperties = bwpAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BwpAccountInfo].
         *
    ...
    fun validate(): BwpAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BwpAccountInfo &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountType, paymentRails, phoneNumber, provider, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BwpAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
}
