...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SlvExternalAccountCreateInfo].
         *
    ...
    /** A builder for [SlvExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(slvExternalAccountCreateInfo: SlvExternalAccountCreateInfo) = apply {
            accountType = slvExternalAccountCreateInfo.accountType
            beneficiary = slvExternalAccountCreateInfo.beneficiary
            accountNumber = slvExternalAccountCreateInfo.accountNumber
            bankAccountType = slvExternalAccountCreateInfo.bankAccountType
            bankName = slvExternalAccountCreateInfo.bankName
            phoneNumber = slvExternalAccountCreateInfo.phoneNumber
            additionalProperties = slvExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SlvExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): SlvExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): SlvExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: SlvBeneficiary) = individual.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SlvExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "SlvExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, accountNumber=$accountNumber, bankAccountType=$bankAccountType, bankName=$bankName, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
