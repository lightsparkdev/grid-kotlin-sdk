...
private constructor(
     ...
     */
    fun isPaused(): Boolean? = body.isPaused()
     ...
     */
    fun _isPaused(): JsonField<Boolean> = body._isPaused()
    ...
    class Builder internal constructor() {
        ...
        /** Set to true to pause the agent or false to resume it. */
        fun isPaused(isPaused: Boolean) = apply { body.isPaused(isPaused) }
         ...
         * value.
         */
        fun isPaused(isPaused: JsonField<Boolean>) = apply { body.isPaused(isPaused) }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(isPaused, name, additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Body{isPaused=$isPaused, name=$name, additionalProperties=$additionalProperties}"
    }
