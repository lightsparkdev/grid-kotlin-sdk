...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [KesAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(kesAccountInfo: KesAccountInfo) = apply {
            accountType = kesAccountInfo.accountType
            paymentRails = kesAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = kesAccountInfo.phoneNumber
            provider = kesAccountInfo.provider
            additionalProperties = kesAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [KesAccountInfo].
         *
    ...
    fun validate(): KesAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is KesAccountInfo &&
    ...
    override fun toString() =
        "KesAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
}
