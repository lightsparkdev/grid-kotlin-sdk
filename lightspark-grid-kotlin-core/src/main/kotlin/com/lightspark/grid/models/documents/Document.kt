...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(document: Document) = apply {
            ...
            documentHolder = document.documentHolder
    ...
    override fun toString() =
        "Document{id=$id, country=$country, createdAt=$createdAt, documentHolder=$documentHolder, documentType=$documentType, fileName=$fileName, documentNumber=$documentNumber, issuingAuthority=$issuingAuthority, side=$side, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
