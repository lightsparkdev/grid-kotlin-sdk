...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(beneficialOwnerListResponse: BeneficialOwnerListResponse) = apply {
            data = beneficialOwnerListResponse.data.map { it.toMutableList() }
            hasMore = beneficialOwnerListResponse.hasMore
            nextCursor = beneficialOwnerListResponse.nextCursor
            totalCount = beneficialOwnerListResponse.totalCount
    ...
    override fun toString() =
        "BeneficialOwnerListResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
