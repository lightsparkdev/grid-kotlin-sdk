...
class BeneficialOwnerListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BeneficialOwnerListResponse].
         *
    ...
    /** A builder for [BeneficialOwnerListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(beneficialOwnerListResponse: BeneficialOwnerListResponse) = apply {
            id = beneficialOwnerListResponse.id
            createdAt = beneficialOwnerListResponse.createdAt
            customerId = beneficialOwnerListResponse.customerId
            kycStatus = beneficialOwnerListResponse.kycStatus
            personalInfo = beneficialOwnerListResponse.personalInfo
            roles = beneficialOwnerListResponse.roles.map { it.toMutableList() }
            ownershipPercentage = beneficialOwnerListResponse.ownershipPercentage
            updatedAt = beneficialOwnerListResponse.updatedAt
            additionalProperties = beneficialOwnerListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BeneficialOwnerListResponse].
         *
         ...
         */
        fun build(): BeneficialOwnerListResponse =
    ...
    fun validate(): BeneficialOwnerListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BeneficialOwnerListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "BeneficialOwnerListResponse{id=$id, createdAt=$createdAt, customerId=$customerId, kycStatus=$kycStatus, personalInfo=$personalInfo, roles=$roles, ownershipPercentage=$ownershipPercentage, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
