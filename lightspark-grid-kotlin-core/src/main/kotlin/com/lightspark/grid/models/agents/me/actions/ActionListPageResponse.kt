...
private constructor(
    private val data: JsonField<List<ActionListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<ActionListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<ActionListResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ActionListResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ActionListPageResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<ActionListResponse>>? = null
        private var hasMore: JsonField<Boolean>? = null
        private var nextCursor: JsonField<String> = JsonMissing.of()
        private var totalCount: JsonField<Long> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(actionListPageResponse: ActionListPageResponse) = apply {
            data = actionListPageResponse.data.map { it.toMutableList() }
            hasMore = actionListPageResponse.hasMore
            nextCursor = actionListPageResponse.nextCursor
            totalCount = actionListPageResponse.totalCount
            additionalProperties = actionListPageResponse.additionalProperties.toMutableMap()
        }

        /** List of agent actions matching the filter criteria. */
        fun data(data: List<ActionListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<ActionListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<ActionListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ActionListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ActionListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [ActionListPageResponse].
         *
         ...
         */
        fun build(): ActionListPageResponse =
            ActionListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): ActionListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ActionListPageResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
