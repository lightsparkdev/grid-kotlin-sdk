 ...
 * operation type.
 */
class TransactionApproveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransactionApproveResponse].
         *
    ...
    /** A builder for [TransactionApproveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(transactionApproveResponse: TransactionApproveResponse) = apply {
            id = transactionApproveResponse.id
            agentId = transactionApproveResponse.agentId
            createdAt = transactionApproveResponse.createdAt
            customerId = transactionApproveResponse.customerId
            platformCustomerId = transactionApproveResponse.platformCustomerId
            status = transactionApproveResponse.status
            type = transactionApproveResponse.type
            updatedAt = transactionApproveResponse.updatedAt
            quote = transactionApproveResponse.quote
            rejectionReason = transactionApproveResponse.rejectionReason
            transaction = transactionApproveResponse.transaction
            transferDetails = transactionApproveResponse.transferDetails
            additionalProperties = transactionApproveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TransactionApproveResponse].
         *
         ...
         */
        fun build(): TransactionApproveResponse =
     ...
     *   expected type.
     */
    fun validate(): TransactionApproveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransactionApproveResponse &&
            id == other.id &&
