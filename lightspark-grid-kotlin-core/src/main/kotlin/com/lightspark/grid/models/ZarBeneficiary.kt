...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ZarBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(zarBeneficiary: ZarBeneficiary) = apply {
            beneficiaryType = zarBeneficiary.beneficiaryType
            fullName = zarBeneficiary.fullName
            address = zarBeneficiary.address
            birthDate = zarBeneficiary.birthDate
            countryOfResidence = zarBeneficiary.countryOfResidence
            email = zarBeneficiary.email
            nationality = zarBeneficiary.nationality
            phoneNumber = zarBeneficiary.phoneNumber
            additionalProperties = zarBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ZarBeneficiary].
         *
    ...
    fun validate(): ZarBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ZarBeneficiary &&
    ...
    override fun toString() =
        "ZarBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
