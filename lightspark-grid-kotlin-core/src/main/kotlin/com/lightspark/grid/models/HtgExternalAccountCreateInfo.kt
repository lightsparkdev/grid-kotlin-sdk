...
class HtgExternalAccountCreateInfo
...
private constructor(
    ...
    ) : this(accountType, beneficiary, phoneNumber, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HtgExternalAccountCreateInfo].
         *
    ...
    /** A builder for [HtgExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(htgExternalAccountCreateInfo: HtgExternalAccountCreateInfo) = apply {
            accountType = htgExternalAccountCreateInfo.accountType
            beneficiary = htgExternalAccountCreateInfo.beneficiary
            phoneNumber = htgExternalAccountCreateInfo.phoneNumber
            additionalProperties = htgExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HtgExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): HtgExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): HtgExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HtgExternalAccountCreateInfo &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountType, beneficiary, phoneNumber, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "HtgExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
