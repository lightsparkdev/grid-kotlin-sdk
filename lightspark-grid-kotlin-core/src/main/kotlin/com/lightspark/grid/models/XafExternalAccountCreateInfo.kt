...
class XafExternalAccountCreateInfo
...
private constructor(
    ...
    ) : this(accountType, beneficiary, phoneNumber, provider, region, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [XafExternalAccountCreateInfo].
         *
    ...
    /** A builder for [XafExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(xafExternalAccountCreateInfo: XafExternalAccountCreateInfo) = apply {
            accountType = xafExternalAccountCreateInfo.accountType
            beneficiary = xafExternalAccountCreateInfo.beneficiary
            phoneNumber = xafExternalAccountCreateInfo.phoneNumber
            provider = xafExternalAccountCreateInfo.provider
            region = xafExternalAccountCreateInfo.region
            additionalProperties = xafExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [XafExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): XafExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): XafExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: XafBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is XafExternalAccountCreateInfo &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountType, beneficiary, phoneNumber, provider, region, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "XafExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, phoneNumber=$phoneNumber, provider=$provider, region=$region, additionalProperties=$additionalProperties}"
}
