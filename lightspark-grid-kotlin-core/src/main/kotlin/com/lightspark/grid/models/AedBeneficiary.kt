...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AedBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(aedBeneficiary: AedBeneficiary) = apply {
            ...
            nationality = aedBeneficiary.nationality
        ...
        /**
         * Returns an immutable instance of [AedBeneficiary].
         *
