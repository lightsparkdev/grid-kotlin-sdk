...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ngnAccountInfo: NgnAccountInfo) = apply {
            ...
            paymentRails = ngnAccountInfo.paymentRails.map { it.toMutableList() }
    ...
    override fun toString() =
        "NgnAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, additionalProperties=$additionalProperties}"
}
