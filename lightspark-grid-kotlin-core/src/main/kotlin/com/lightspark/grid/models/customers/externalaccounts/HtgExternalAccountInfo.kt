...
private constructor(
    ...
    ) : this(accountType, paymentRails, phoneNumber, beneficiary, mutableMapOf())
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<HtgAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HtgExternalAccountInfo].
         *
    ...
    /** A builder for [HtgExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(htgExternalAccountInfo: HtgExternalAccountInfo) = apply {
            accountType = htgExternalAccountInfo.accountType
            paymentRails = htgExternalAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = htgExternalAccountInfo.phoneNumber
            beneficiary = htgExternalAccountInfo.beneficiary
            additionalProperties = htgExternalAccountInfo.additionalProperties.toMutableMap()
        }
         ...
         * [HtgAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<HtgAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<HtgAccountInfo.PaymentRail>>) = apply {
        ...
        /**
         * Returns an immutable instance of [HtgExternalAccountInfo].
         *
         ...
         */
        fun build(): HtgExternalAccountInfo =
     ...
     *   expected type.
     */
    fun validate(): HtgExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: HtgBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: HtgBeneficiary) = individual.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HtgExternalAccountInfo &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountType, paymentRails, phoneNumber, beneficiary, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "HtgExternalAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
