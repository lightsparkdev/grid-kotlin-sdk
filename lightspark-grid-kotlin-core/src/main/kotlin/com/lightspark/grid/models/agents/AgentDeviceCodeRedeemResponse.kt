...
class AgentDeviceCodeRedeemResponse
...
private constructor(
    ...
    /** A builder for [AgentDeviceCodeRedeemResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(agentDeviceCodeRedeemResponse: AgentDeviceCodeRedeemResponse) = apply {
            accessToken = agentDeviceCodeRedeemResponse.accessToken
            agentId = agentDeviceCodeRedeemResponse.agentId
            agentName = agentDeviceCodeRedeemResponse.agentName
            policy = agentDeviceCodeRedeemResponse.policy
            additionalProperties = agentDeviceCodeRedeemResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentDeviceCodeRedeemResponse].
         *
         ...
         */
        fun build(): AgentDeviceCodeRedeemResponse =
            AgentDeviceCodeRedeemResponse(
     ...
     *   expected type.
     */
    fun validate(): AgentDeviceCodeRedeemResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentDeviceCodeRedeemResponse &&
    ...
    override fun toString() =
        "AgentDeviceCodeRedeemResponse{accessToken=$accessToken, agentId=$agentId, agentName=$agentName, policy=$policy, additionalProperties=$additionalProperties}"
}
