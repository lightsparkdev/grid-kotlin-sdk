...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
        ...
        fun build(): CopExternalAccountInfo =
            CopExternalAccountInfo(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CopExternalAccountInfo && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CopExternalAccountInfo{additionalProperties=$additionalProperties}"
}
