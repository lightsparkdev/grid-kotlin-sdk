...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MwkAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(mwkAccountInfo: MwkAccountInfo) = apply {
            accountType = mwkAccountInfo.accountType
            paymentRails = mwkAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = mwkAccountInfo.phoneNumber
            provider = mwkAccountInfo.provider
            additionalProperties = mwkAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MwkAccountInfo].
         *
    ...
    fun validate(): MwkAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MwkAccountInfo &&
    ...
    override fun toString() =
        "MwkAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
}
