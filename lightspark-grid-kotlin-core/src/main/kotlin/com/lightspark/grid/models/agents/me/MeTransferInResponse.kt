...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MeTransferInResponse].
         *
    ...
    /** A builder for [MeTransferInResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(meTransferInResponse: MeTransferInResponse) = apply {
            id = meTransferInResponse.id
            agentId = meTransferInResponse.agentId
            createdAt = meTransferInResponse.createdAt
            customerId = meTransferInResponse.customerId
            platformCustomerId = meTransferInResponse.platformCustomerId
            status = meTransferInResponse.status
            type = meTransferInResponse.type
            updatedAt = meTransferInResponse.updatedAt
            quote = meTransferInResponse.quote
            rejectionReason = meTransferInResponse.rejectionReason
            transaction = meTransferInResponse.transaction
            transferDetails = meTransferInResponse.transferDetails
            additionalProperties = meTransferInResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MeTransferInResponse].
         *
         ...
         */
        fun build(): MeTransferInResponse =
     ...
     *   expected type.
     */
    fun validate(): MeTransferInResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MeTransferInResponse &&
            id == other.id &&
