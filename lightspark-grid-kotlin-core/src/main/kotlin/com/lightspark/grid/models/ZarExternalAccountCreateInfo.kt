...
class ZarExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ZarExternalAccountCreateInfo].
         *
    ...
    /** A builder for [ZarExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(zarExternalAccountCreateInfo: ZarExternalAccountCreateInfo) = apply {
            accountNumber = zarExternalAccountCreateInfo.accountNumber
            accountType = zarExternalAccountCreateInfo.accountType
            bankName = zarExternalAccountCreateInfo.bankName
            beneficiary = zarExternalAccountCreateInfo.beneficiary
            additionalProperties = zarExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ZarExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): ZarExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): ZarExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: ZarBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: ZarBeneficiary) = individual.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ZarExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "ZarExternalAccountCreateInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
