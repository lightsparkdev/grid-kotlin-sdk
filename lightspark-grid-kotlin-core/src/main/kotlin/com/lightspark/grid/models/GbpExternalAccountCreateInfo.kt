...
class GbpExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GbpExternalAccountCreateInfo].
         *
    ...
    /** A builder for [GbpExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(gbpExternalAccountCreateInfo: GbpExternalAccountCreateInfo) = apply {
            accountNumber = gbpExternalAccountCreateInfo.accountNumber
            accountType = gbpExternalAccountCreateInfo.accountType
            beneficiary = gbpExternalAccountCreateInfo.beneficiary
            sortCode = gbpExternalAccountCreateInfo.sortCode
            additionalProperties = gbpExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GbpExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): GbpExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): GbpExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GbpExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "GbpExternalAccountCreateInfo{accountNumber=$accountNumber, accountType=$accountType, beneficiary=$beneficiary, sortCode=$sortCode, additionalProperties=$additionalProperties}"
}
