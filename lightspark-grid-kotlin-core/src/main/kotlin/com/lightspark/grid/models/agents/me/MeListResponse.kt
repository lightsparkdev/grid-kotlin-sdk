...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MeListResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(meListResponse: MeListResponse) = apply {
            id = meListResponse.id
            createdAt = meListResponse.createdAt
            customerId = meListResponse.customerId
            isConnected = meListResponse.isConnected
            isPaused = meListResponse.isPaused
            name = meListResponse.name
            policy = meListResponse.policy
            updatedAt = meListResponse.updatedAt
            usage = meListResponse.usage
            additionalProperties = meListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MeListResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): MeListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MeListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "MeListResponse{id=$id, createdAt=$createdAt, customerId=$customerId, isConnected=$isConnected, isPaused=$isPaused, name=$name, policy=$policy, updatedAt=$updatedAt, usage=$usage, additionalProperties=$additionalProperties}"
}
