...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [JmdBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(jmdBeneficiary: JmdBeneficiary) = apply {
            address = jmdBeneficiary.address
            beneficiaryType = jmdBeneficiary.beneficiaryType
            fullName = jmdBeneficiary.fullName
            phoneNumber = jmdBeneficiary.phoneNumber
            birthDate = jmdBeneficiary.birthDate
            countryOfResidence = jmdBeneficiary.countryOfResidence
            email = jmdBeneficiary.email
            nationality = jmdBeneficiary.nationality
            additionalProperties = jmdBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [JmdBeneficiary].
         *
    ...
    fun validate(): JmdBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JmdBeneficiary &&
    ...
    override fun toString() =
        "JmdBeneficiary{address=$address, beneficiaryType=$beneficiaryType, fullName=$fullName, phoneNumber=$phoneNumber, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, additionalProperties=$additionalProperties}"
}
