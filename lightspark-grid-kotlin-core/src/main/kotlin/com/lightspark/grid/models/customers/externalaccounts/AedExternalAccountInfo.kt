...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
        ...
        fun build(): AedExternalAccountInfo =
            AedExternalAccountInfo(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AedExternalAccountInfo && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "AedExternalAccountInfo{additionalProperties=$additionalProperties}"
}
