...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(actionRetrieveResponse: ActionRetrieveResponse) = apply {
            id = actionRetrieveResponse.id
            agentId = actionRetrieveResponse.agentId
            createdAt = actionRetrieveResponse.createdAt
            customerId = actionRetrieveResponse.customerId
            platformCustomerId = actionRetrieveResponse.platformCustomerId
            status = actionRetrieveResponse.status
            type = actionRetrieveResponse.type
            updatedAt = actionRetrieveResponse.updatedAt
            quote = actionRetrieveResponse.quote
            rejectionReason = actionRetrieveResponse.rejectionReason
            transaction = actionRetrieveResponse.transaction
