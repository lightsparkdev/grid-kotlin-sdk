...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(documentRetrieveResponse: DocumentRetrieveResponse) = apply {
            id = documentRetrieveResponse.id
            country = documentRetrieveResponse.country
            createdAt = documentRetrieveResponse.createdAt
            documentHolder = documentRetrieveResponse.documentHolder
            documentType = documentRetrieveResponse.documentType
            fileName = documentRetrieveResponse.fileName
            documentNumber = documentRetrieveResponse.documentNumber
            issuingAuthority = documentRetrieveResponse.issuingAuthority
            side = documentRetrieveResponse.side
            updatedAt = documentRetrieveResponse.updatedAt
    ...
    override fun toString() =
        "DocumentRetrieveResponse{id=$id, country=$country, createdAt=$createdAt, documentHolder=$documentHolder, documentType=$documentType, fileName=$fileName, documentNumber=$documentNumber, issuingAuthority=$issuingAuthority, side=$side, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
