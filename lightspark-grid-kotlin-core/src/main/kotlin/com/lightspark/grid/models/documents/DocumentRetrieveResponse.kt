...
private constructor(
    ...
    override fun toString() =
        "DocumentRetrieveResponse{id=$id, country=$country, createdAt=$createdAt, documentHolder=$documentHolder, documentType=$documentType, fileName=$fileName, documentNumber=$documentNumber, side=$side, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
