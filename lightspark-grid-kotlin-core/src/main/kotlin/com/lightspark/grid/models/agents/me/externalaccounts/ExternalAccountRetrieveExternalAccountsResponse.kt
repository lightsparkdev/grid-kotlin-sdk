...
class ExternalAccountRetrieveExternalAccountsResponse
...
private constructor(
    ...
    /** A builder for [ExternalAccountRetrieveExternalAccountsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = externalAccountRetrieveExternalAccountsResponse.data.map { it.toMutableList() }
            hasMore = externalAccountRetrieveExternalAccountsResponse.hasMore
            nextCursor = externalAccountRetrieveExternalAccountsResponse.nextCursor
            totalCount = externalAccountRetrieveExternalAccountsResponse.totalCount
            additionalProperties =
                externalAccountRetrieveExternalAccountsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalAccountRetrieveExternalAccountsResponse].
         *
         ...
         */
        fun build(): ExternalAccountRetrieveExternalAccountsResponse =
            ExternalAccountRetrieveExternalAccountsResponse(
     ...
     *   expected type.
     */
    fun validate(): ExternalAccountRetrieveExternalAccountsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalAccountRetrieveExternalAccountsResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ExternalAccountRetrieveExternalAccountsResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
