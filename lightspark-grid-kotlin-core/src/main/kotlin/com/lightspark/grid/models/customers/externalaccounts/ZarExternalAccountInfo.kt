...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<ZarAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    class Builder internal constructor() {
         ...
         * [ZarAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<ZarAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<ZarAccountInfo.PaymentRail>>) = apply {
    ...
    override fun toString() =
        "ZarExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
