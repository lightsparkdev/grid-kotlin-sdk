...
class AedExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AedExternalAccountCreateInfo].
         *
    ...
    /** A builder for [AedExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(aedExternalAccountCreateInfo: AedExternalAccountCreateInfo) = apply {
            accountType = aedExternalAccountCreateInfo.accountType
            beneficiary = aedExternalAccountCreateInfo.beneficiary
            iban = aedExternalAccountCreateInfo.iban
            swiftCode = aedExternalAccountCreateInfo.swiftCode
            additionalProperties = aedExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AedExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): AedExternalAccountCreateInfo =
    ...
    fun validate(): AedExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AedExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "AedExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, iban=$iban, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
}
