...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentDeviceCode].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(agentDeviceCode: AgentDeviceCode) = apply {
            agentId = agentDeviceCode.agentId
            code = agentDeviceCode.code
            expiresAt = agentDeviceCode.expiresAt
            redeemed = agentDeviceCode.redeemed
            additionalProperties = agentDeviceCode.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentDeviceCode].
         *
     ...
     *   expected type.
     */
    fun validate(): AgentDeviceCode = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentDeviceCode &&
    ...
    override fun toString() =
        "AgentDeviceCode{agentId=$agentId, code=$code, expiresAt=$expiresAt, redeemed=$redeemed, additionalProperties=$additionalProperties}"
}
