    ...
    private constructor(
        ...
        private constructor(
            ...
            override fun toString() =
                "Individual{currencies=$currencies, platformCustomerId=$platformCustomerId, region=$region, umaAddress=$umaAddress, customerType=$customerType, address=$address, birthDate=$birthDate, fullName=$fullName, kycStatus=$kycStatus, nationality=$nationality, additionalProperties=$additionalProperties}"
        }
        ...
        private constructor(
            ...
            override fun toString() =
                "Business{currencies=$currencies, platformCustomerId=$platformCustomerId, region=$region, umaAddress=$umaAddress, customerType=$customerType, address=$address, businessInfo=$businessInfo, kybStatus=$kybStatus, additionalProperties=$additionalProperties}"
        }
    }
