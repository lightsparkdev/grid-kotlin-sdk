...
private constructor(
     ...
     * of the receiving currency (eg. cents). This is the receiving amount times
     * gridApiVariableFeeRate.
     *
     * @throws LightsparkGridInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IncomingRateDetails].
         *
    ...
    /** A builder for [IncomingRateDetails]. */
    class Builder internal constructor() {
        ...
        internal fun from(incomingRateDetails: IncomingRateDetails) = apply {
            gridApiFixedFee = incomingRateDetails.gridApiFixedFee
            gridApiMultiplier = incomingRateDetails.gridApiMultiplier
            gridApiVariableFeeAmount = incomingRateDetails.gridApiVariableFeeAmount
            gridApiVariableFeeRate = incomingRateDetails.gridApiVariableFeeRate
            additionalProperties = incomingRateDetails.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IncomingRateDetails].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IncomingRateDetails &&
    ...
    override fun toString() =
        "IncomingRateDetails{gridApiFixedFee=$gridApiFixedFee, gridApiMultiplier=$gridApiMultiplier, gridApiVariableFeeAmount=$gridApiVariableFeeAmount, gridApiVariableFeeRate=$gridApiVariableFeeRate, additionalProperties=$additionalProperties}"
}
