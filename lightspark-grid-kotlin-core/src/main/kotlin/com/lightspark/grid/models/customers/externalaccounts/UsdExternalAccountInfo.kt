...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(usdExternalAccountInfo: UsdExternalAccountInfo) = apply {
            ...
            countries = usdExternalAccountInfo.countries.map { it.toMutableList() }
    ...
    override fun toString() =
        "UsdExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, beneficiary=$beneficiary, countries=$countries, paymentRails=$paymentRails, routingNumber=$routingNumber, additionalProperties=$additionalProperties}"
}
