...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<BwpAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BwpExternalAccountInfo].
         *
    ...
    /** A builder for [BwpExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(bwpExternalAccountInfo: BwpExternalAccountInfo) = apply {
            accountType = bwpExternalAccountInfo.accountType
            paymentRails = bwpExternalAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = bwpExternalAccountInfo.phoneNumber
            provider = bwpExternalAccountInfo.provider
            beneficiary = bwpExternalAccountInfo.beneficiary
            additionalProperties = bwpExternalAccountInfo.additionalProperties.toMutableMap()
        }
         ...
         * [BwpAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<BwpAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<BwpAccountInfo.PaymentRail>>) = apply {
        ...
        /**
         * Returns an immutable instance of [BwpExternalAccountInfo].
         *
         ...
         */
        fun build(): BwpExternalAccountInfo =
     ...
     *   expected type.
     */
    fun validate(): BwpExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: BwpBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: BwpBeneficiary) = individual.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BwpExternalAccountInfo &&
    ...
    override fun toString() =
        "BwpExternalAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
