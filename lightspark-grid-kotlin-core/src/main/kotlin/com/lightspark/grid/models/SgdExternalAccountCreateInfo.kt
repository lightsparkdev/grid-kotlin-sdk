...
class SgdExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SgdExternalAccountCreateInfo].
         *
    ...
    /** A builder for [SgdExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [SgdExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): SgdExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): SgdExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
