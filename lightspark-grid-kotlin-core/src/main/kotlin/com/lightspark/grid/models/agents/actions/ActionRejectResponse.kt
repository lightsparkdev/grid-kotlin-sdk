...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ActionRejectResponse].
         *
    ...
    /** A builder for [ActionRejectResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(actionRejectResponse: ActionRejectResponse) = apply {
            id = actionRejectResponse.id
            agentId = actionRejectResponse.agentId
            createdAt = actionRejectResponse.createdAt
            customerId = actionRejectResponse.customerId
            platformCustomerId = actionRejectResponse.platformCustomerId
            status = actionRejectResponse.status
            type = actionRejectResponse.type
            updatedAt = actionRejectResponse.updatedAt
            quote = actionRejectResponse.quote
            rejectionReason = actionRejectResponse.rejectionReason
            transaction = actionRejectResponse.transaction
            transferDetails = actionRejectResponse.transferDetails
            additionalProperties = actionRejectResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionRejectResponse].
         *
         ...
         */
        fun build(): ActionRejectResponse =
     ...
     *   expected type.
     */
    fun validate(): ActionRejectResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionRejectResponse &&
            id == other.id &&
