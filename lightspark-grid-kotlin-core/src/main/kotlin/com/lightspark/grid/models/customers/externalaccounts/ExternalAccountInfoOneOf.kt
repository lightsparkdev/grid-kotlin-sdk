...
private constructor(
    ...
    companion object {
        ...
        fun ofAedAccount(aedAccount: AedAccount) = ExternalAccountInfoOneOf(aedAccount = aedAccount)

        fun ofBwpAccount(bwpAccount: BwpAccount) = ExternalAccountInfoOneOf(bwpAccount = bwpAccount)

        fun ofXafAccount(xafAccount: XafAccount) = ExternalAccountInfoOneOf(xafAccount = xafAccount)

        fun ofBdtAccount(bdtAccount: BdtAccount) = ExternalAccountInfoOneOf(bdtAccount = bdtAccount)

        fun ofCopAccount(copAccount: CopAccount) = ExternalAccountInfoOneOf(copAccount = copAccount)

        fun ofEgpAccount(egpAccount: EgpAccount) = ExternalAccountInfoOneOf(egpAccount = egpAccount)

        fun ofGhsAccount(ghsAccount: GhsAccount) = ExternalAccountInfoOneOf(ghsAccount = ghsAccount)

        fun ofGtqAccount(gtqAccount: GtqAccount) = ExternalAccountInfoOneOf(gtqAccount = gtqAccount)

        fun ofHtgAccount(htgAccount: HtgAccount) = ExternalAccountInfoOneOf(htgAccount = htgAccount)

        fun ofJmdAccount(jmdAccount: JmdAccount) = ExternalAccountInfoOneOf(jmdAccount = jmdAccount)

        fun ofPkrAccount(pkrAccount: PkrAccount) = ExternalAccountInfoOneOf(pkrAccount = pkrAccount)
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun beneficiary(individual: CadBeneficiary) =
        ...
        class Beneficiary
        private constructor(
            private val individual: CadBeneficiary? = null,
            private val business: BusinessBeneficiary? = null,
            private val _json: JsonValue? = null,
        ) {

            fun individual(): CadBeneficiary? = individual
            ...
            fun asIndividual(): CadBeneficiary = individual.getOrThrow("individual")
            ...
            fun validate(): Beneficiary = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        override fun visitIndividual(individual: CadBeneficiary) {
                            individual.validate()
                        }
            ...
            companion object {
                ...
                fun ofIndividual(individual: CadBeneficiary) = Beneficiary(individual = individual)
            ...
            interface Visitor<out T> {
                ...
                fun visitIndividual(individual: CadBeneficiary): T
            ...
            internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                    ...
                    when (beneficiaryType) {
                        "INDIVIDUAL" -> {
                            return tryDeserialize(node, jacksonTypeRef<CadBeneficiary>())?.let {
    ...
    private constructor(
        ...
        override fun toString() =
            "EurAccount{accountType=$accountType, iban=$iban, paymentRails=$paymentRails, swiftCode=$swiftCode, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [beneficiary] with `Beneficiary.ofIndividual(individual)`. */
            fun beneficiary(individual: MwkBeneficiary) =
                beneficiary(Beneficiary.ofIndividual(individual))
        ...
        class Beneficiary
        private constructor(
            private val individual: MwkBeneficiary? = null,
            private val business: BusinessBeneficiary? = null,
            private val _json: JsonValue? = null,
        ) {

            fun individual(): MwkBeneficiary? = individual
            ...
            fun asIndividual(): MwkBeneficiary = individual.getOrThrow("individual")
            ...
            fun validate(): Beneficiary = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        override fun visitIndividual(individual: MwkBeneficiary) {
                            individual.validate()
                        }
            ...
            companion object {
                ...
                fun ofIndividual(individual: MwkBeneficiary) = Beneficiary(individual = individual)
            ...
            interface Visitor<out T> {
                ...
                fun visitIndividual(individual: MwkBeneficiary): T
            ...
            internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                    ...
                    when (beneficiaryType) {
                        "INDIVIDUAL" -> {
                            return tryDeserialize(node, jacksonTypeRef<MwkBeneficiary>())?.let {
                                Beneficiary(individual = it, _json = json)
                            } ?: Beneficiary(_json = json)
                        }
                        "BUSINESS" -> {
        ...
        override fun toString() =
            "MwkExternalAccountInfo{accountType=$accountType, beneficiary=$beneficiary, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [beneficiary] with `Beneficiary.ofIndividual(individual)`. */
            fun beneficiary(individual: NgnBeneficiary) =
                beneficiary(Beneficiary.ofIndividual(individual))
        ...
        class Beneficiary
        private constructor(
            private val individual: NgnBeneficiary? = null,
            private val business: BusinessBeneficiary? = null,
            private val _json: JsonValue? = null,
        ) {

            fun individual(): NgnBeneficiary? = individual
            ...
            fun asIndividual(): NgnBeneficiary = individual.getOrThrow("individual")
            ...
            fun validate(): Beneficiary = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        override fun visitIndividual(individual: NgnBeneficiary) {
                            individual.validate()
                        }
            ...
            companion object {
                ...
                fun ofIndividual(individual: NgnBeneficiary) = Beneficiary(individual = individual)
            ...
            interface Visitor<out T> {
                ...
                fun visitIndividual(individual: NgnBeneficiary): T
            ...
            internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                    ...
                    when (beneficiaryType) {
                        "INDIVIDUAL" -> {
                            return tryDeserialize(node, jacksonTypeRef<NgnBeneficiary>())?.let {
                                Beneficiary(individual = it, _json = json)
                            } ?: Beneficiary(_json = json)
                        }
                        "BUSINESS" -> {
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [beneficiary] with `Beneficiary.ofIndividual(individual)`. */
            fun beneficiary(individual: TzsBeneficiary) =
                beneficiary(Beneficiary.ofIndividual(individual))
        ...
        class Beneficiary
        private constructor(
            private val individual: TzsBeneficiary? = null,
            private val business: BusinessBeneficiary? = null,
            private val _json: JsonValue? = null,
        ) {

            fun individual(): TzsBeneficiary? = individual
            ...
            fun asIndividual(): TzsBeneficiary = individual.getOrThrow("individual")
            ...
            fun validate(): Beneficiary = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        override fun visitIndividual(individual: TzsBeneficiary) {
                            individual.validate()
                        }
            ...
            companion object {
                ...
                fun ofIndividual(individual: TzsBeneficiary) = Beneficiary(individual = individual)
            ...
            interface Visitor<out T> {
                ...
                fun visitIndividual(individual: TzsBeneficiary): T
            ...
            internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                    ...
                    when (beneficiaryType) {
                        "INDIVIDUAL" -> {
                            return tryDeserialize(node, jacksonTypeRef<TzsBeneficiary>())?.let {
                                Beneficiary(individual = it, _json = json)
                            } ?: Beneficiary(_json = json)
                        }
                        "BUSINESS" -> {
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [beneficiary] with `Beneficiary.ofIndividual(individual)`. */
            fun beneficiary(individual: UgxBeneficiary) =
                beneficiary(Beneficiary.ofIndividual(individual))
        ...
        class Beneficiary
        private constructor(
            private val individual: UgxBeneficiary? = null,
            private val business: BusinessBeneficiary? = null,
            private val _json: JsonValue? = null,
        ) {

            fun individual(): UgxBeneficiary? = individual
            ...
            fun asIndividual(): UgxBeneficiary = individual.getOrThrow("individual")
            ...
            fun validate(): Beneficiary = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        override fun visitIndividual(individual: UgxBeneficiary) {
                            individual.validate()
                        }
            ...
            companion object {
                ...
                fun ofIndividual(individual: UgxBeneficiary) = Beneficiary(individual = individual)
            ...
            interface Visitor<out T> {
                ...
                fun visitIndividual(individual: UgxBeneficiary): T
            ...
            internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                    ...
                    when (beneficiaryType) {
                        "INDIVIDUAL" -> {
                            return tryDeserialize(node, jacksonTypeRef<UgxBeneficiary>())?.let {
                                Beneficiary(individual = it, _json = json)
                            } ?: Beneficiary(_json = json)
                        }
                        "BUSINESS" -> {
        ...
        override fun toString() =
            "UgxExternalAccountInfo{accountType=$accountType, beneficiary=$beneficiary, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        override fun toString() =
            "XofExternalAccountInfo{accountType=$accountType, beneficiary=$beneficiary, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, region=$region, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [beneficiary] with `Beneficiary.ofIndividual(individual)`. */
            fun beneficiary(individual: ZarBeneficiary) =
                beneficiary(Beneficiary.ofIndividual(individual))
        ...
        class Beneficiary
        private constructor(
            private val individual: ZarBeneficiary? = null,
            private val business: BusinessBeneficiary? = null,
            private val _json: JsonValue? = null,
        ) {

            fun individual(): ZarBeneficiary? = individual
            ...
            fun asIndividual(): ZarBeneficiary = individual.getOrThrow("individual")
            ...
            fun validate(): Beneficiary = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        override fun visitIndividual(individual: ZarBeneficiary) {
                            individual.validate()
                        }
            ...
            companion object {
                ...
                fun ofIndividual(individual: ZarBeneficiary) = Beneficiary(individual = individual)
            ...
            interface Visitor<out T> {
                ...
                fun visitIndividual(individual: ZarBeneficiary): T
            ...
            internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                    ...
                    when (beneficiaryType) {
                        "INDIVIDUAL" -> {
                            return tryDeserialize(node, jacksonTypeRef<ZarBeneficiary>())?.let {
                                Beneficiary(individual = it, _json = json)
                            } ?: Beneficiary(_json = json)
                        }
                        "BUSINESS" -> {
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [beneficiary] with `Beneficiary.ofIndividual(individual)`. */
            fun beneficiary(individual: ZmwBeneficiary) =
                beneficiary(Beneficiary.ofIndividual(individual))
        ...
        class Beneficiary
        private constructor(
            private val individual: ZmwBeneficiary? = null,
            private val business: BusinessBeneficiary? = null,
            private val _json: JsonValue? = null,
        ) {

            fun individual(): ZmwBeneficiary? = individual
            ...
            fun asIndividual(): ZmwBeneficiary = individual.getOrThrow("individual")
            ...
            fun validate(): Beneficiary = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        override fun visitIndividual(individual: ZmwBeneficiary) {
                            individual.validate()
                        }
            ...
            companion object {
                ...
                fun ofIndividual(individual: ZmwBeneficiary) = Beneficiary(individual = individual)
            ...
            interface Visitor<out T> {
                ...
                fun visitIndividual(individual: ZmwBeneficiary): T
            ...
            internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                    ...
                    when (beneficiaryType) {
                        "INDIVIDUAL" -> {
                            return tryDeserialize(node, jacksonTypeRef<ZmwBeneficiary>())?.let {
                                Beneficiary(individual = it, _json = json)
                            } ?: Beneficiary(_json = json)
                        }
                        "BUSINESS" -> {
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            swiftCode: JsonField<String> = JsonMissing.of(),
        ) : this(accountType, beneficiary, iban, paymentRails, swiftCode, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            internal fun from(aedAccount: AedAccount) = apply {
                ...
                beneficiary = aedAccount.beneficiary
        ...
        override fun toString() =
            "AedAccount{accountType=$accountType, beneficiary=$beneficiary, iban=$iban, paymentRails=$paymentRails, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(bwpAccount: BwpAccount) = apply {
                ...
                beneficiary = bwpAccount.beneficiary
            ...
            /** Alias for calling [beneficiary] with `Beneficiary.ofIndividual(individual)`. */
            fun beneficiary(individual: BwpBeneficiary) =
                beneficiary(Beneficiary.ofIndividual(individual))
        ...
        class Beneficiary
        private constructor(
            private val individual: BwpBeneficiary? = null,
            private val business: BusinessBeneficiary? = null,
            private val _json: JsonValue? = null,
        ) {

            fun individual(): BwpBeneficiary? = individual
            ...
            fun asIndividual(): BwpBeneficiary = individual.getOrThrow("individual")
            ...
            fun validate(): Beneficiary = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        override fun visitIndividual(individual: BwpBeneficiary) {
                            individual.validate()
                        }
            ...
            companion object {
                ...
                fun ofIndividual(individual: BwpBeneficiary) = Beneficiary(individual = individual)
            ...
            interface Visitor<out T> {
                ...
                fun visitIndividual(individual: BwpBeneficiary): T
            ...
            internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                    ...
                    when (beneficiaryType) {
                        "INDIVIDUAL" -> {
                            return tryDeserialize(node, jacksonTypeRef<BwpBeneficiary>())?.let {
                                Beneficiary(individual = it, _json = json)
                            } ?: Beneficiary(_json = json)
                        }
                        "BUSINESS" -> {
        ...
        override fun toString() =
            "BwpAccount{accountType=$accountType, beneficiary=$beneficiary, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(xafAccount: XafAccount) = apply {
                ...
                beneficiary = xafAccount.beneficiary
        ...
        override fun toString() =
            "XafAccount{accountType=$accountType, beneficiary=$beneficiary, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, region=$region, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            private var accountNumber: JsonField<String>? = null
            private var accountType: JsonValue = JsonValue.from("BDT_ACCOUNT")
            private var beneficiary: JsonField<Beneficiary>? = null
            private var branchCode: JsonField<String>? = null
            private var paymentRails: JsonField<MutableList<PaymentRail>>? = null
            private var phoneNumber: JsonField<String>? = null
            ...
            internal fun from(bdtAccount: BdtAccount) = apply {
                ...
                beneficiary = bdtAccount.beneficiary
        ...
        fun validate(): BdtAccount = apply {
            ...
            accountNumber()
            _accountType().let {
                if (it != JsonValue.from("BDT_ACCOUNT")) {
                    throw LightsparkGridInvalidDataException(
                        "'accountType' is invalid, received $it"
                    )
                }
        ...
        internal fun validity(): Int =
            (if (accountNumber.asKnown() == null) 0 else 1) +
                accountType.let { if (it == JsonValue.from("BDT_ACCOUNT")) 1 else 0 } +
                (beneficiary.asKnown()?.validity() ?: 0) +
                (if (branchCode.asKnown() == null) 0 else 1) +
                (paymentRails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (phoneNumber.asKnown() == null) 0 else 1) +
        ...
        override fun toString() =
            "BdtAccount{accountNumber=$accountNumber, accountType=$accountType, beneficiary=$beneficiary, branchCode=$branchCode, paymentRails=$paymentRails, phoneNumber=$phoneNumber, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            private var accountNumber: JsonField<String>? = null
            private var accountType: JsonValue = JsonValue.from("COP_ACCOUNT")
            ...
            internal fun from(copAccount: CopAccount) = apply {
                accountNumber = copAccount.accountNumber
                accountType = copAccount.accountType
                bankAccountType = copAccount.bankAccountType
                beneficiary = copAccount.beneficiary
                paymentRails = copAccount.paymentRails.map { it.toMutableList() }
                phoneNumber = copAccount.phoneNumber
        ...
        fun validate(): CopAccount = apply {
            ...
            accountNumber()
            _accountType().let {
                if (it != JsonValue.from("COP_ACCOUNT")) {
                    throw LightsparkGridInvalidDataException(
                        "'accountType' is invalid, received $it"
                    )
                }
        ...
        internal fun validity(): Int =
            (if (accountNumber.asKnown() == null) 0 else 1) +
                accountType.let { if (it == JsonValue.from("COP_ACCOUNT")) 1 else 0 } +
        ...
        override fun toString() =
            "CopAccount{accountNumber=$accountNumber, accountType=$accountType, bankAccountType=$bankAccountType, beneficiary=$beneficiary, paymentRails=$paymentRails, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            private var accountNumber: JsonField<String>? = null
            private var accountType: JsonValue = JsonValue.from("EGP_ACCOUNT")
            private var beneficiary: JsonField<Beneficiary>? = null
            private var paymentRails: JsonField<MutableList<PaymentRail>>? = null
            ...
            internal fun from(egpAccount: EgpAccount) = apply {
                ...
                beneficiary = egpAccount.beneficiary
            ...
            /** Alias for calling [beneficiary] with `Beneficiary.ofIndividual(individual)`. */
            fun beneficiary(individual: EgpBeneficiary) =
                beneficiary(Beneficiary.ofIndividual(individual))
        ...
        fun validate(): EgpAccount = apply {
            ...
            accountNumber()
            _accountType().let {
                if (it != JsonValue.from("EGP_ACCOUNT")) {
                    throw LightsparkGridInvalidDataException(
                        "'accountType' is invalid, received $it"
                    )
                }
        ...
        internal fun validity(): Int =
            (if (accountNumber.asKnown() == null) 0 else 1) +
                accountType.let { if (it == JsonValue.from("EGP_ACCOUNT")) 1 else 0 } +
                (beneficiary.asKnown()?.validity() ?: 0) +
                (paymentRails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (iban.asKnown() == null) 0 else 1) +
                (if (swiftCode.asKnown() == null) 0 else 1)
        ...
        class Beneficiary
        private constructor(
            private val individual: EgpBeneficiary? = null,
            private val business: BusinessBeneficiary? = null,
            private val _json: JsonValue? = null,
        ) {

            fun individual(): EgpBeneficiary? = individual
            ...
            fun asIndividual(): EgpBeneficiary = individual.getOrThrow("individual")
            ...
            fun validate(): Beneficiary = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        override fun visitIndividual(individual: EgpBeneficiary) {
                            individual.validate()
                        }
            ...
            companion object {
                ...
                fun ofIndividual(individual: EgpBeneficiary) = Beneficiary(individual = individual)
            ...
            interface Visitor<out T> {
                ...
                fun visitIndividual(individual: EgpBeneficiary): T
            ...
            internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                    ...
                    when (beneficiaryType) {
                        "INDIVIDUAL" -> {
                            return tryDeserialize(node, jacksonTypeRef<EgpBeneficiary>())?.let {
                                Beneficiary(individual = it, _json = json)
                            } ?: Beneficiary(_json = json)
                        }
                        "BUSINESS" -> {
        ...
        override fun toString() =
            "EgpAccount{accountNumber=$accountNumber, accountType=$accountType, beneficiary=$beneficiary, paymentRails=$paymentRails, iban=$iban, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            phoneNumber: JsonField<String> = JsonMissing.of(),
        ) : this(accountNumber, accountType, beneficiary, paymentRails, phoneNumber, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            private var accountNumber: JsonField<String>? = null
            private var accountType: JsonValue = JsonValue.from("GHS_ACCOUNT")
            private var beneficiary: JsonField<Beneficiary>? = null
            private var paymentRails: JsonField<MutableList<PaymentRail>>? = null
            private var phoneNumber: JsonField<String>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            internal fun from(ghsAccount: GhsAccount) = apply {
                ...
                beneficiary = ghsAccount.beneficiary
        ...
        fun validate(): GhsAccount = apply {
            ...
            accountNumber()
            _accountType().let {
                if (it != JsonValue.from("GHS_ACCOUNT")) {
                    throw LightsparkGridInvalidDataException(
                        "'accountType' is invalid, received $it"
                    )
                }
        ...
        internal fun validity(): Int =
            (if (accountNumber.asKnown() == null) 0 else 1) +
                accountType.let { if (it == JsonValue.from("GHS_ACCOUNT")) 1 else 0 } +
                (beneficiary.asKnown()?.validity() ?: 0) +
                (paymentRails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (phoneNumber.asKnown() == null) 0 else 1)
        ...
        override fun toString() =
            "GhsAccount{accountNumber=$accountNumber, accountType=$accountType, beneficiary=$beneficiary, paymentRails=$paymentRails, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            private var accountNumber: JsonField<String>? = null
            private var accountType: JsonValue = JsonValue.from("GTQ_ACCOUNT")
            private var beneficiary: JsonField<Beneficiary>? = null
            private var paymentRails: JsonField<MutableList<PaymentRail>>? = null
            private var phoneNumber: JsonField<String>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            internal fun from(gtqAccount: GtqAccount) = apply {
                ...
                beneficiary = gtqAccount.beneficiary
                paymentRails = gtqAccount.paymentRails.map { it.toMutableList() }
                phoneNumber = gtqAccount.phoneNumber
            ...
            /** Alias for calling [beneficiary] with `Beneficiary.ofIndividual(individual)`. */
            fun beneficiary(individual: GtqBeneficiary) =
                beneficiary(Beneficiary.ofIndividual(individual))
        ...
        fun validate(): GtqAccount = apply {
            ...
            accountNumber()
            _accountType().let {
                if (it != JsonValue.from("GTQ_ACCOUNT")) {
                    throw LightsparkGridInvalidDataException(
                        "'accountType' is invalid, received $it"
                    )
                }
        ...
        internal fun validity(): Int =
            (if (accountNumber.asKnown() == null) 0 else 1) +
                accountType.let { if (it == JsonValue.from("GTQ_ACCOUNT")) 1 else 0 } +
                (beneficiary.asKnown()?.validity() ?: 0) +
                (paymentRails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (phoneNumber.asKnown() == null) 0 else 1)
        ...
        class Beneficiary
        private constructor(
            private val individual: GtqBeneficiary? = null,
            private val business: BusinessBeneficiary? = null,
            private val _json: JsonValue? = null,
        ) {

            fun individual(): GtqBeneficiary? = individual
            ...
            fun asIndividual(): GtqBeneficiary = individual.getOrThrow("individual")
            ...
            fun validate(): Beneficiary = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        override fun visitIndividual(individual: GtqBeneficiary) {
                            individual.validate()
                        }
            ...
            companion object {
                ...
                fun ofIndividual(individual: GtqBeneficiary) = Beneficiary(individual = individual)
            ...
            interface Visitor<out T> {
                ...
                fun visitIndividual(individual: GtqBeneficiary): T
            ...
            internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                    ...
                    when (beneficiaryType) {
                        "INDIVIDUAL" -> {
                            return tryDeserialize(node, jacksonTypeRef<GtqBeneficiary>())?.let {
                                Beneficiary(individual = it, _json = json)
                            } ?: Beneficiary(_json = json)
                        }
                        "BUSINESS" -> {
        ...
        override fun toString() =
            "GtqAccount{accountNumber=$accountNumber, accountType=$accountType, beneficiary=$beneficiary, paymentRails=$paymentRails, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            phoneNumber: JsonField<String> = JsonMissing.of(),
        ) : this(accountType, beneficiary, paymentRails, phoneNumber, mutableMapOf())

        /**
         * Expected to always return the following:
         * ```kotlin
         * JsonValue.from("HTG_ACCOUNT")
         * ```
         *
         * However, this method can be useful for debugging and logging (e.g. if the server
         * responded with an unexpected value).
        ...
        class Builder internal constructor() {
            ...
            private var accountType: JsonValue = JsonValue.from("HTG_ACCOUNT")
            private var beneficiary: JsonField<Beneficiary>? = null
            private var paymentRails: JsonField<MutableList<PaymentRail>>? = null
            private var phoneNumber: JsonField<String>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            internal fun from(htgAccount: HtgAccount) = apply {
                ...
                beneficiary = htgAccount.beneficiary
        ...
        fun validate(): HtgAccount = apply {
            ...
            _accountType().let {
                if (it != JsonValue.from("HTG_ACCOUNT")) {
                    throw LightsparkGridInvalidDataException(
                        "'accountType' is invalid, received $it"
                    )
                }
         ...
         */
        internal fun validity(): Int =
            accountType.let { if (it == JsonValue.from("HTG_ACCOUNT")) 1 else 0 } +
                (beneficiary.asKnown()?.validity() ?: 0) +
                (paymentRails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (phoneNumber.asKnown() == null) 0 else 1)
        ...
        class Beneficiary
        private constructor(
            private val individual: HtgBeneficiary? = null,
            private val business: BusinessBeneficiary? = null,
            private val _json: JsonValue? = null,
        ) {

            fun individual(): HtgBeneficiary? = individual
            ...
            fun asIndividual(): HtgBeneficiary = individual.getOrThrow("individual")
            ...
            fun validate(): Beneficiary = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        override fun visitIndividual(individual: HtgBeneficiary) {
                            individual.validate()
                        }
            ...
            companion object {
                ...
                fun ofIndividual(individual: HtgBeneficiary) = Beneficiary(individual = individual)
            ...
            interface Visitor<out T> {
                ...
                fun visitIndividual(individual: HtgBeneficiary): T
            ...
            internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                    ...
                    when (beneficiaryType) {
                        "INDIVIDUAL" -> {
                            return tryDeserialize(node, jacksonTypeRef<HtgBeneficiary>())?.let {
                                Beneficiary(individual = it, _json = json)
                            } ?: Beneficiary(_json = json)
                        }
                        "BUSINESS" -> {
        ...
        private val hashCode: Int by lazy {
            Objects.hash(accountType, beneficiary, paymentRails, phoneNumber, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "HtgAccount{accountType=$accountType, beneficiary=$beneficiary, paymentRails=$paymentRails, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            private var accountNumber: JsonField<String>? = null
            private var accountType: JsonValue = JsonValue.from("JMD_ACCOUNT")
            private var bankAccountType: JsonField<BankAccountType>? = null
            private var beneficiary: JsonField<Beneficiary>? = null
            private var branchCode: JsonField<String>? = null
            private var paymentRails: JsonField<MutableList<PaymentRail>>? = null
            ...
            internal fun from(jmdAccount: JmdAccount) = apply {
                ...
                beneficiary = jmdAccount.beneficiary
        ...
        fun validate(): JmdAccount = apply {
            ...
            accountNumber()
            _accountType().let {
                if (it != JsonValue.from("JMD_ACCOUNT")) {
                    throw LightsparkGridInvalidDataException(
                        "'accountType' is invalid, received $it"
                    )
                }
        ...
        internal fun validity(): Int =
            (if (accountNumber.asKnown() == null) 0 else 1) +
                accountType.let { if (it == JsonValue.from("JMD_ACCOUNT")) 1 else 0 } +
                (bankAccountType.asKnown()?.validity() ?: 0) +
                (beneficiary.asKnown()?.validity() ?: 0) +
                (if (branchCode.asKnown() == null) 0 else 1) +
                (paymentRails.asKnown()?.sumOf { it.validity().toInt() } ?: 0)
        ...
        override fun toString() =
            "JmdAccount{accountNumber=$accountNumber, accountType=$accountType, bankAccountType=$bankAccountType, beneficiary=$beneficiary, branchCode=$branchCode, paymentRails=$paymentRails, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            private var accountNumber: JsonField<String>? = null
            private var accountType: JsonValue = JsonValue.from("PKR_ACCOUNT")
            private var beneficiary: JsonField<Beneficiary>? = null
            private var paymentRails: JsonField<MutableList<PaymentRail>>? = null
            private var phoneNumber: JsonField<String>? = null
            private var iban: JsonField<String> = JsonMissing.of()
            ...
            internal fun from(pkrAccount: PkrAccount) = apply {
                ...
                beneficiary = pkrAccount.beneficiary
        ...
        fun validate(): PkrAccount = apply {
            ...
            accountNumber()
            _accountType().let {
                if (it != JsonValue.from("PKR_ACCOUNT")) {
                    throw LightsparkGridInvalidDataException(
                        "'accountType' is invalid, received $it"
                    )
                }
        ...
        internal fun validity(): Int =
            (if (accountNumber.asKnown() == null) 0 else 1) +
                accountType.let { if (it == JsonValue.from("PKR_ACCOUNT")) 1 else 0 } +
                (beneficiary.asKnown()?.validity() ?: 0) +
                (paymentRails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (phoneNumber.asKnown() == null) 0 else 1) +
                (if (iban.asKnown() == null) 0 else 1)
        ...
        override fun toString() =
            "PkrAccount{accountNumber=$accountNumber, accountType=$accountType, beneficiary=$beneficiary, paymentRails=$paymentRails, phoneNumber=$phoneNumber, iban=$iban, additionalProperties=$additionalProperties}"
    }
}
