...
private constructor(
    ...
    /**
     * Required fields depend on the selected paymentRails:
     * - BANK_TRANSFER: accountNumber, bankName. Business-to-business only, so the beneficiary must
     *   be a business.
     * - MOBILE_MONEY: bankName, phoneNumber. Pays an AliPay or WeChat Pay wallet; bankName selects
     *   the wallet.
     */
    ...
    companion object {
         ...
         *   selects the wallet.
         */
        fun ofCnyAccount(cnyAccount: CnyAccount) = ExternalAccountInfoOneOf(cnyAccount = cnyAccount)

        fun ofIlsAccount(ilsAccount: IlsAccount) = ExternalAccountInfoOneOf(ilsAccount = ilsAccount)

        fun ofTryAccount(tryAccount: TryAccount) = ExternalAccountInfoOneOf(tryAccount = tryAccount)
    }
            ...
            when (accountType) {
                ...
                "CNY_ACCOUNT" -> {
                    return tryDeserialize(node, jacksonTypeRef<CnyAccount>())?.let {
                        ExternalAccountInfoOneOf(cnyAccount = it, _json = json)
                    } ?: ExternalAccountInfoOneOf(_json = json)
                }
                "ILS_ACCOUNT" -> {
                    return tryDeserialize(node, jacksonTypeRef<IlsAccount>())?.let {
                        ExternalAccountInfoOneOf(ilsAccount = it, _json = json)
                    } ?: ExternalAccountInfoOneOf(_json = json)
                }
                "TRY_ACCOUNT" -> {
                    return tryDeserialize(node, jacksonTypeRef<TryAccount>())?.let {
                        ExternalAccountInfoOneOf(tryAccount = it, _json = json)
                    } ?: ExternalAccountInfoOneOf(_json = json)
                }
            }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [beneficiary] with `Beneficiary.ofIndividual(individual)`. */
            fun beneficiary(individual: SwiftBeneficiary) =
                beneficiary(Beneficiary.ofIndividual(individual))
        ...
        class Beneficiary
        private constructor(
            private val individual: SwiftBeneficiary? = null,
            private val business: BusinessBeneficiary? = null,
            private val _json: JsonValue? = null,
        ) {

            fun individual(): SwiftBeneficiary? = individual
            ...
            fun asIndividual(): SwiftBeneficiary = individual.getOrThrow("individual")
             ...
             *
             * val result: String? = beneficiary.accept(object : Beneficiary.Visitor<String?> {
             *     override fun visitIndividual(individual: SwiftBeneficiary): String? = individual.toString()
             *
             *     // ...
             *
             *     override fun unknown(json: JsonValue?): String? {
            ...
            fun validate(): Beneficiary = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        override fun visitIndividual(individual: SwiftBeneficiary) {
                            individual.validate()
                        }
            ...
            companion object {
                ...
                fun ofIndividual(individual: SwiftBeneficiary) =
            ...
            interface Visitor<out T> {
                ...
                fun visitIndividual(individual: SwiftBeneficiary): T
            ...
            internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                    ...
                    when (beneficiaryType) {
                        "INDIVIDUAL" -> {
                            return tryDeserialize(node, jacksonTypeRef<SwiftBeneficiary>())?.let {
                                Beneficiary(individual = it, _json = json)
                            } ?: Beneficiary(_json = json)
                        }
                        "BUSINESS" -> {
    ...
    private constructor(
        ...
        override fun toString() =
            "CnyAccount{accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, paymentRails=$paymentRails, accountNumber=$accountNumber, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            paymentRails: JsonField<List<PaymentRail>> = JsonMissing.of(),
        ) : this(accountType, bankName, beneficiary, iban, paymentRails, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            internal fun from(ilsAccount: IlsAccount) = apply {
                ...
                paymentRails = ilsAccount.paymentRails.map { it.toMutableList() }
        ...
        override fun toString() =
            "IlsAccount{accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, iban=$iban, paymentRails=$paymentRails, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(tryAccount: TryAccount) = apply {
                ...
                paymentRails = tryAccount.paymentRails.map { it.toMutableList() }
        ...
        override fun toString() =
            "TryAccount{accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, iban=$iban, paymentRails=$paymentRails, additionalProperties=$additionalProperties}"
    }
}
