...
class InternalAccountListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InternalAccountListResponse].
         *
    ...
    /** A builder for [InternalAccountListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(internalAccountListResponse: InternalAccountListResponse) = apply {
            data = internalAccountListResponse.data.map { it.toMutableList() }
            hasMore = internalAccountListResponse.hasMore
            nextCursor = internalAccountListResponse.nextCursor
            totalCount = internalAccountListResponse.totalCount
            additionalProperties = internalAccountListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InternalAccountListResponse].
         *
         ...
         */
        fun build(): InternalAccountListResponse =
     ...
     *   expected type.
     */
    fun validate(): InternalAccountListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InternalAccountListResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "InternalAccountListResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
