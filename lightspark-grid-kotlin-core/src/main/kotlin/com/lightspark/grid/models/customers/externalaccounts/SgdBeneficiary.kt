...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SgdBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sgdBeneficiary: SgdBeneficiary) = apply {
            beneficiaryType = sgdBeneficiary.beneficiaryType
            fullName = sgdBeneficiary.fullName
            address = sgdBeneficiary.address
            birthDate = sgdBeneficiary.birthDate
            countryOfResidence = sgdBeneficiary.countryOfResidence
            email = sgdBeneficiary.email
            nationality = sgdBeneficiary.nationality
            phoneNumber = sgdBeneficiary.phoneNumber
            registrationNumber = sgdBeneficiary.registrationNumber
            additionalProperties = sgdBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SgdBeneficiary].
         *
    ...
    fun validate(): SgdBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SgdBeneficiary &&
    ...
    override fun toString() =
        "SgdBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, registrationNumber=$registrationNumber, additionalProperties=$additionalProperties}"
}
