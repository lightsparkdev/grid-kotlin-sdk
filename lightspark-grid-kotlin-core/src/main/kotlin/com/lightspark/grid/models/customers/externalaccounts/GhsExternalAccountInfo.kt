...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
        ...
        fun build(): GhsExternalAccountInfo =
            GhsExternalAccountInfo(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GhsExternalAccountInfo && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "GhsExternalAccountInfo{additionalProperties=$additionalProperties}"
}
