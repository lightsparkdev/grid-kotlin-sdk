...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(credentialCreateResponse: CredentialCreateResponse) = apply {
            status = credentialCreateResponse.status
            message = credentialCreateResponse.message
    ...
    override fun toString() =
        "CredentialCreateResponse{status=$status, message=$message, additionalProperties=$additionalProperties}"
}
