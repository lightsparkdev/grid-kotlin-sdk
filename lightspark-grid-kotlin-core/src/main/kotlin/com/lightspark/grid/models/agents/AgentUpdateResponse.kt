...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(agentUpdateResponse: AgentUpdateResponse) = apply {
            id = agentUpdateResponse.id
            createdAt = agentUpdateResponse.createdAt
            customerId = agentUpdateResponse.customerId
            isConnected = agentUpdateResponse.isConnected
            isPaused = agentUpdateResponse.isPaused
    ...
    override fun toString() =
        "AgentUpdateResponse{id=$id, createdAt=$createdAt, customerId=$customerId, isConnected=$isConnected, isPaused=$isPaused, name=$name, policy=$policy, updatedAt=$updatedAt, usage=$usage, additionalProperties=$additionalProperties}"
}
