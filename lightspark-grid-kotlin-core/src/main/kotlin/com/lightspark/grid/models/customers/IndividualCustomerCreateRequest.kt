...
private constructor(
     ...
     * consent is recorded. This can be supplied during customer creation or in a later customer
     * update.
     *
     * @throws LightsparkGridInvalidDataException if the JSON field has an unexpected type (e.g. if
     *   the server responded with an unexpected value).
    ...
    class Builder internal constructor() {
        ...
        internal fun from(individualCustomerCreateRequest: IndividualCustomerCreateRequest) =
            apply {
                ...
                taxIdCountryOfIssuance = individualCustomerCreateRequest.taxIdCountryOfIssuance
                taxIdentifier = individualCustomerCreateRequest.taxIdentifier
                taxIdType = individualCustomerCreateRequest.taxIdType
         ...
         * until consent is recorded. This can be supplied during customer creation or in a later
         * customer update.
         */
