...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CadBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cadBeneficiary: CadBeneficiary) = apply {
            beneficiaryType = cadBeneficiary.beneficiaryType
            fullName = cadBeneficiary.fullName
            address = cadBeneficiary.address
            birthDate = cadBeneficiary.birthDate
            countryOfResidence = cadBeneficiary.countryOfResidence
            email = cadBeneficiary.email
            nationality = cadBeneficiary.nationality
            phoneNumber = cadBeneficiary.phoneNumber
            registrationNumber = cadBeneficiary.registrationNumber
            additionalProperties = cadBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CadBeneficiary].
         *
    ...
    fun validate(): CadBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CadBeneficiary &&
    ...
    override fun toString() =
        "CadBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, registrationNumber=$registrationNumber, additionalProperties=$additionalProperties}"
}
