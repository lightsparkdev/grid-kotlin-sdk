...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ZmwBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(zmwBeneficiary: ZmwBeneficiary) = apply {
            beneficiaryType = zmwBeneficiary.beneficiaryType
            fullName = zmwBeneficiary.fullName
            address = zmwBeneficiary.address
            birthDate = zmwBeneficiary.birthDate
            countryOfResidence = zmwBeneficiary.countryOfResidence
            email = zmwBeneficiary.email
            nationality = zmwBeneficiary.nationality
            phoneNumber = zmwBeneficiary.phoneNumber
            additionalProperties = zmwBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ZmwBeneficiary].
         *
    ...
    fun validate(): ZmwBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ZmwBeneficiary &&
    ...
    override fun toString() =
        "ZmwBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
