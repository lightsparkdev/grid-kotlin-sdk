...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TestWebhookWebhookEvent].
         *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [TestWebhookWebhookEvent].
         *
    ...
    fun validate(): TestWebhookWebhookEvent = apply {
        if (validated) {
            return@apply
        }
