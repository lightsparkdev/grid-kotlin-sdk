...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sgdExternalAccountInfo: SgdExternalAccountInfo) = apply {
            ...
            countries = sgdExternalAccountInfo.countries.map { it.toMutableList() }
    ...
    override fun toString() =
        "SgdExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, countries=$countries, paymentRails=$paymentRails, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
}
