...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SgdExternalAccountInfo].
         *
    ...
    /** A builder for [SgdExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(sgdExternalAccountInfo: SgdExternalAccountInfo) = apply {
            accountNumber = sgdExternalAccountInfo.accountNumber
            accountType = sgdExternalAccountInfo.accountType
            bankName = sgdExternalAccountInfo.bankName
            paymentRails = sgdExternalAccountInfo.paymentRails.map { it.toMutableList() }
            swiftCode = sgdExternalAccountInfo.swiftCode
            beneficiary = sgdExternalAccountInfo.beneficiary
            additionalProperties = sgdExternalAccountInfo.additionalProperties.toMutableMap()
        }
         ...
         * [SgdAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<SgdAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<SgdAccountInfo.PaymentRail>>) = apply {
        ...
        fun beneficiary(individual: SgdBeneficiary) =
        ...
        /**
         * Returns an immutable instance of [SgdExternalAccountInfo].
         *
         ...
         */
        fun build(): SgdExternalAccountInfo =
     ...
     *   expected type.
     */
    fun validate(): SgdExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    class Beneficiary
    private constructor(
        private val individual: SgdBeneficiary? = null,
        private val business: BusinessBeneficiary? = null,
        private val _json: JsonValue? = null,
    ) {

        fun individual(): SgdBeneficiary? = individual
        ...
        fun asIndividual(): SgdBeneficiary = individual.getOrThrow("individual")
         ...
         *     override fun visitIndividual(individual: SgdBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        fun validate(): Beneficiary = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitIndividual(individual: SgdBeneficiary) {
                        individual.validate()
                    }
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: SgdBeneficiary) = individual.validity()
        ...
        companion object {
            ...
            fun ofIndividual(individual: SgdBeneficiary) = Beneficiary(individual = individual)
        ...
        interface Visitor<out T> {
            ...
            fun visitIndividual(individual: SgdBeneficiary): T
        ...
        internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                ...
                when (beneficiaryType) {
                    "INDIVIDUAL" -> {
                        return tryDeserialize(node, jacksonTypeRef<SgdBeneficiary>())?.let {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SgdExternalAccountInfo &&
    ...
    override fun toString() =
        "SgdExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, swiftCode=$swiftCode, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
