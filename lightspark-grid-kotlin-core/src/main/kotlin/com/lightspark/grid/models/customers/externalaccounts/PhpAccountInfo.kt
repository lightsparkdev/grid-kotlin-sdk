...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PhpAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(phpAccountInfo: PhpAccountInfo) = apply {
            accountNumber = phpAccountInfo.accountNumber
            accountType = phpAccountInfo.accountType
            bankName = phpAccountInfo.bankName
            beneficiary = phpAccountInfo.beneficiary
        ...
        /**
         * Returns an immutable instance of [PhpAccountInfo].
         *
    ...
    fun validate(): PhpAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhpAccountInfo &&
    ...
    override fun toString() =
        "PhpAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
