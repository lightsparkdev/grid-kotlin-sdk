...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GbpBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(gbpBeneficiary: GbpBeneficiary) = apply {
            beneficiaryType = gbpBeneficiary.beneficiaryType
            fullName = gbpBeneficiary.fullName
            address = gbpBeneficiary.address
            birthDate = gbpBeneficiary.birthDate
            countryOfResidence = gbpBeneficiary.countryOfResidence
        ...
        /**
         * Returns an immutable instance of [GbpBeneficiary].
         *
    ...
    fun validate(): GbpBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GbpBeneficiary &&
