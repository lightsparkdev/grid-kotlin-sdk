...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(gbpExternalAccountInfo: GbpExternalAccountInfo) = apply {
            ...
            countries = gbpExternalAccountInfo.countries.map { it.toMutableList() }
    ...
    override fun toString() =
        "GbpExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, beneficiary=$beneficiary, countries=$countries, paymentRails=$paymentRails, sortCode=$sortCode, additionalProperties=$additionalProperties}"
}
