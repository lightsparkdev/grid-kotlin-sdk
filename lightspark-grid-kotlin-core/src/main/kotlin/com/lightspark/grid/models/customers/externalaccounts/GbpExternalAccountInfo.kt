...
private constructor(
    ...
    ) : this(accountNumber, accountType, paymentRails, sortCode, beneficiary, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GbpExternalAccountInfo].
         *
    ...
    /** A builder for [GbpExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(gbpExternalAccountInfo: GbpExternalAccountInfo) = apply {
            accountNumber = gbpExternalAccountInfo.accountNumber
            accountType = gbpExternalAccountInfo.accountType
            paymentRails = gbpExternalAccountInfo.paymentRails.map { it.toMutableList() }
            sortCode = gbpExternalAccountInfo.sortCode
            beneficiary = gbpExternalAccountInfo.beneficiary
            additionalProperties = gbpExternalAccountInfo.additionalProperties.toMutableMap()
        }
         ...
         * [GbpAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<GbpAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<GbpAccountInfo.PaymentRail>>) = apply {
        ...
        fun beneficiary(individual: GbpBeneficiary) =
        ...
        /**
         * Returns an immutable instance of [GbpExternalAccountInfo].
         *
         ...
         */
        fun build(): GbpExternalAccountInfo =
     ...
     *   expected type.
     */
    fun validate(): GbpExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    class Beneficiary
    private constructor(
        private val individual: GbpBeneficiary? = null,
        private val business: BusinessBeneficiary? = null,
        private val _json: JsonValue? = null,
    ) {

        fun individual(): GbpBeneficiary? = individual
        ...
        fun asIndividual(): GbpBeneficiary = individual.getOrThrow("individual")
         ...
         *     override fun visitIndividual(individual: GbpBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        fun validate(): Beneficiary = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitIndividual(individual: GbpBeneficiary) {
                        individual.validate()
                    }
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: GbpBeneficiary) = individual.validity()
        ...
        companion object {
            ...
            fun ofIndividual(individual: GbpBeneficiary) = Beneficiary(individual = individual)
        ...
        interface Visitor<out T> {
            ...
            fun visitIndividual(individual: GbpBeneficiary): T
        ...
        internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                ...
                when (beneficiaryType) {
                    "INDIVIDUAL" -> {
                        return tryDeserialize(node, jacksonTypeRef<GbpBeneficiary>())?.let {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GbpExternalAccountInfo &&
    ...
    override fun toString() =
        "GbpExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, paymentRails=$paymentRails, sortCode=$sortCode, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
