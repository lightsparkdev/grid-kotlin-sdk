...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(dkkAccountInfo: DkkAccountInfo) = apply {
            ...
            swiftBic = dkkAccountInfo.swiftBic
    ...
    override fun toString() =
        "DkkAccountInfo{accountType=$accountType, iban=$iban, paymentRails=$paymentRails, swiftBic=$swiftBic, additionalProperties=$additionalProperties}"
}
