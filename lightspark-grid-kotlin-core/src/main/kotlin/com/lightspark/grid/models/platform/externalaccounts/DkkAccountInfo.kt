...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DkkAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(dkkAccountInfo: DkkAccountInfo) = apply {
            accountType = dkkAccountInfo.accountType
            iban = dkkAccountInfo.iban
            paymentRails = dkkAccountInfo.paymentRails.map { it.toMutableList() }
            swiftCode = dkkAccountInfo.swiftCode
            additionalProperties = dkkAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DkkAccountInfo].
         *
    ...
    fun validate(): DkkAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DkkAccountInfo &&
    ...
    override fun toString() =
        "DkkAccountInfo{accountType=$accountType, iban=$iban, paymentRails=$paymentRails, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
}
