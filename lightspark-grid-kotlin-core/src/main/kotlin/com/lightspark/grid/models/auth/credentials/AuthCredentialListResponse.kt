...
class AuthCredentialListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AuthCredentialListResponse].
         *
    ...
    /** A builder for [AuthCredentialListResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<AuthMethod>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(authCredentialListResponse: AuthCredentialListResponse) = apply {
            data = authCredentialListResponse.data.map { it.toMutableList() }
            additionalProperties = authCredentialListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AuthCredentialListResponse].
         *
         ...
         */
        fun build(): AuthCredentialListResponse =
     ...
     *   expected type.
     */
    fun validate(): AuthCredentialListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthCredentialListResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "AuthCredentialListResponse{data=$data, additionalProperties=$additionalProperties}"
}
