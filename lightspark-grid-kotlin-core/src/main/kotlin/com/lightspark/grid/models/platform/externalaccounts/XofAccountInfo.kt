...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [XofAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(xofAccountInfo: XofAccountInfo) = apply {
            accountType = xofAccountInfo.accountType
            paymentRails = xofAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = xofAccountInfo.phoneNumber
            provider = xofAccountInfo.provider
            region = xofAccountInfo.region
            additionalProperties = xofAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [XofAccountInfo].
         *
    ...
    fun validate(): XofAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is XofAccountInfo &&
    ...
    override fun toString() =
        "XofAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, region=$region, additionalProperties=$additionalProperties}"
}
