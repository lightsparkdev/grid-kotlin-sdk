...
class XofExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [XofExternalAccountCreateInfo].
         *
    ...
    /** A builder for [XofExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(xofExternalAccountCreateInfo: XofExternalAccountCreateInfo) = apply {
            accountType = xofExternalAccountCreateInfo.accountType
            beneficiary = xofExternalAccountCreateInfo.beneficiary
            phoneNumber = xofExternalAccountCreateInfo.phoneNumber
            provider = xofExternalAccountCreateInfo.provider
            region = xofExternalAccountCreateInfo.region
            additionalProperties = xofExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [XofExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): XofExternalAccountCreateInfo =
    ...
    fun validate(): XofExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is XofExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "XofExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, phoneNumber=$phoneNumber, provider=$provider, region=$region, additionalProperties=$additionalProperties}"
}
