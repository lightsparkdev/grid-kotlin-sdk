...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun receivingCurrencyCode(): String = receivingCurrencyCode.getRequired("receivingCurrencyCode")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ReceiveRequest].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(receiveRequest: ReceiveRequest) = apply {
            receivingCurrencyAmount = receiveRequest.receivingCurrencyAmount
            receivingCurrencyCode = receiveRequest.receivingCurrencyCode
            senderUmaAddress = receiveRequest.senderUmaAddress
            customerId = receiveRequest.customerId
            receiverUmaAddress = receiveRequest.receiverUmaAddress
            additionalProperties = receiveRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ReceiveRequest].
         *
     ...
     *   expected type.
     */
    fun validate(): ReceiveRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReceiveRequest &&
    ...
    override fun toString() =
        "ReceiveRequest{receivingCurrencyAmount=$receivingCurrencyAmount, receivingCurrencyCode=$receivingCurrencyCode, senderUmaAddress=$senderUmaAddress, customerId=$customerId, receiverUmaAddress=$receiverUmaAddress, additionalProperties=$additionalProperties}"
}
