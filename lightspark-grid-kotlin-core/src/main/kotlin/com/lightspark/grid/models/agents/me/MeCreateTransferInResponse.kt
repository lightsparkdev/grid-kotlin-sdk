 ...
 * operation type.
 */
class MeCreateTransferInResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MeCreateTransferInResponse].
         *
    ...
    /** A builder for [MeCreateTransferInResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(meCreateTransferInResponse: MeCreateTransferInResponse) = apply {
            id = meCreateTransferInResponse.id
            agentId = meCreateTransferInResponse.agentId
            createdAt = meCreateTransferInResponse.createdAt
            customerId = meCreateTransferInResponse.customerId
            platformCustomerId = meCreateTransferInResponse.platformCustomerId
            status = meCreateTransferInResponse.status
            type = meCreateTransferInResponse.type
            updatedAt = meCreateTransferInResponse.updatedAt
            quote = meCreateTransferInResponse.quote
            rejectionReason = meCreateTransferInResponse.rejectionReason
            transaction = meCreateTransferInResponse.transaction
            transferDetails = meCreateTransferInResponse.transferDetails
            additionalProperties = meCreateTransferInResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MeCreateTransferInResponse].
         *
         ...
         */
        fun build(): MeCreateTransferInResponse =
     ...
     *   expected type.
     */
    fun validate(): MeCreateTransferInResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MeCreateTransferInResponse &&
            id == other.id &&
