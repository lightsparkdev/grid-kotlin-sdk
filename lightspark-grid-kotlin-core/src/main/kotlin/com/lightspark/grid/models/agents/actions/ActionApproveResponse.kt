...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ActionApproveResponse].
         *
    ...
    /** A builder for [ActionApproveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(actionApproveResponse: ActionApproveResponse) = apply {
            id = actionApproveResponse.id
            agentId = actionApproveResponse.agentId
            createdAt = actionApproveResponse.createdAt
            customerId = actionApproveResponse.customerId
            platformCustomerId = actionApproveResponse.platformCustomerId
            status = actionApproveResponse.status
            type = actionApproveResponse.type
            updatedAt = actionApproveResponse.updatedAt
            quote = actionApproveResponse.quote
            rejectionReason = actionApproveResponse.rejectionReason
            transaction = actionApproveResponse.transaction
            transferDetails = actionApproveResponse.transferDetails
            additionalProperties = actionApproveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionApproveResponse].
         *
         ...
         */
        fun build(): ActionApproveResponse =
     ...
     *   expected type.
     */
    fun validate(): ActionApproveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionApproveResponse &&
            id == other.id &&
