...
private constructor(
    ...
    ) : this(accountType, paymentRails, phoneNumber, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HtgAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(htgAccountInfo: HtgAccountInfo) = apply {
            accountType = htgAccountInfo.accountType
            paymentRails = htgAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = htgAccountInfo.phoneNumber
            additionalProperties = htgAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HtgAccountInfo].
         *
    ...
    fun validate(): HtgAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HtgAccountInfo &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountType, paymentRails, phoneNumber, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "HtgAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
