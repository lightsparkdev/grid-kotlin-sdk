...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MeTransferInParams].
         *
    ...
    /** A builder for [MeTransferInParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(meTransferInParams: MeTransferInParams) = apply {
            idempotencyKey = meTransferInParams.idempotencyKey
            body = meTransferInParams.body.toBuilder()
            additionalHeaders = meTransferInParams.additionalHeaders.toBuilder()
            additionalQueryParams = meTransferInParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MeTransferInParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MeTransferInParams &&
    ...
    override fun toString() =
        "MeTransferInParams{idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
