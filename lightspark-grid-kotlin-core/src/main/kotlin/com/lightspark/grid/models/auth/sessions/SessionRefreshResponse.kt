...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SessionRefreshResponse].
         *
    ...
    /** A builder for [SessionRefreshResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(sessionRefreshResponse: SessionRefreshResponse) = apply {
            status = sessionRefreshResponse.status
            message = sessionRefreshResponse.message
            additionalProperties = sessionRefreshResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SessionRefreshResponse].
         *
         ...
         */
        fun build(): SessionRefreshResponse =
     ...
     *   expected type.
     */
    fun validate(): SessionRefreshResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SessionRefreshResponse &&
            status == other.status &&
    ...
    override fun toString() =
        "SessionRefreshResponse{status=$status, message=$message, additionalProperties=$additionalProperties}"
}
