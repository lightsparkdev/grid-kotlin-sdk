...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [XofBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(xofBeneficiary: XofBeneficiary) = apply {
            beneficiaryType = xofBeneficiary.beneficiaryType
            fullName = xofBeneficiary.fullName
            address = xofBeneficiary.address
            birthDate = xofBeneficiary.birthDate
            countryOfResidence = xofBeneficiary.countryOfResidence
            email = xofBeneficiary.email
            nationality = xofBeneficiary.nationality
            phoneNumber = xofBeneficiary.phoneNumber
            additionalProperties = xofBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [XofBeneficiary].
         *
    ...
    fun validate(): XofBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is XofBeneficiary &&
    ...
    override fun toString() =
        "XofBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
