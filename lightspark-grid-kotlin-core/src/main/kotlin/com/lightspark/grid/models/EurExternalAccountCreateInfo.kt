...
class EurExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EurExternalAccountCreateInfo].
         *
    ...
    /** A builder for [EurExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(eurExternalAccountCreateInfo: EurExternalAccountCreateInfo) = apply {
            accountType = eurExternalAccountCreateInfo.accountType
            beneficiary = eurExternalAccountCreateInfo.beneficiary
            iban = eurExternalAccountCreateInfo.iban
            swiftCode = eurExternalAccountCreateInfo.swiftCode
            additionalProperties = eurExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EurExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): EurExternalAccountCreateInfo =
    ...
    fun validate(): EurExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EurExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "EurExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, iban=$iban, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
}
