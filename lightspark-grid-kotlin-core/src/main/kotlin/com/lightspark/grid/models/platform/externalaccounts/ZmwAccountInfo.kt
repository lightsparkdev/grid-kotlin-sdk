...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ZmwAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(zmwAccountInfo: ZmwAccountInfo) = apply {
            accountType = zmwAccountInfo.accountType
            paymentRails = zmwAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = zmwAccountInfo.phoneNumber
            provider = zmwAccountInfo.provider
            additionalProperties = zmwAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ZmwAccountInfo].
         *
    ...
    fun validate(): ZmwAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ZmwAccountInfo &&
    ...
    override fun toString() =
        "ZmwAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
}
