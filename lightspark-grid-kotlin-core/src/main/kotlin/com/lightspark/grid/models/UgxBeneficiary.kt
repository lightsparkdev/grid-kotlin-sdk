...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UgxBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ugxBeneficiary: UgxBeneficiary) = apply {
            beneficiaryType = ugxBeneficiary.beneficiaryType
            fullName = ugxBeneficiary.fullName
            address = ugxBeneficiary.address
            birthDate = ugxBeneficiary.birthDate
            countryOfResidence = ugxBeneficiary.countryOfResidence
            email = ugxBeneficiary.email
            nationality = ugxBeneficiary.nationality
            phoneNumber = ugxBeneficiary.phoneNumber
            additionalProperties = ugxBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UgxBeneficiary].
         *
    ...
    fun validate(): UgxBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UgxBeneficiary &&
    ...
    override fun toString() =
        "UgxBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
