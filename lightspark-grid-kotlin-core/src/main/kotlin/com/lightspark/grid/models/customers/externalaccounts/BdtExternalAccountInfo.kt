...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<BdtAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BdtExternalAccountInfo].
         *
    ...
    /** A builder for [BdtExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(bdtExternalAccountInfo: BdtExternalAccountInfo) = apply {
            accountType = bdtExternalAccountInfo.accountType
            paymentRails = bdtExternalAccountInfo.paymentRails.map { it.toMutableList() }
            accountNumber = bdtExternalAccountInfo.accountNumber
            branchCode = bdtExternalAccountInfo.branchCode
            phoneNumber = bdtExternalAccountInfo.phoneNumber
            swiftCode = bdtExternalAccountInfo.swiftCode
            beneficiary = bdtExternalAccountInfo.beneficiary
            additionalProperties = bdtExternalAccountInfo.additionalProperties.toMutableMap()
        }
         ...
         * [BdtAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<BdtAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<BdtAccountInfo.PaymentRail>>) = apply {
        ...
        /**
         * Returns an immutable instance of [BdtExternalAccountInfo].
         *
         ...
         */
        fun build(): BdtExternalAccountInfo =
     ...
     *   expected type.
     */
    fun validate(): BdtExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: BdtBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BdtExternalAccountInfo &&
    ...
    override fun toString() =
        "BdtExternalAccountInfo{accountType=$accountType, paymentRails=$paymentRails, accountNumber=$accountNumber, branchCode=$branchCode, phoneNumber=$phoneNumber, swiftCode=$swiftCode, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
