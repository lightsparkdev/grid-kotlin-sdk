...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<MyrAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MyrExternalAccountInfo].
         *
    ...
    /** A builder for [MyrExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(myrExternalAccountInfo: MyrExternalAccountInfo) = apply {
            accountNumber = myrExternalAccountInfo.accountNumber
            accountType = myrExternalAccountInfo.accountType
            bankName = myrExternalAccountInfo.bankName
            paymentRails = myrExternalAccountInfo.paymentRails.map { it.toMutableList() }
            swiftCode = myrExternalAccountInfo.swiftCode
            beneficiary = myrExternalAccountInfo.beneficiary
            additionalProperties = myrExternalAccountInfo.additionalProperties.toMutableMap()
        }
         ...
         * [MyrAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<MyrAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<MyrAccountInfo.PaymentRail>>) = apply {
        ...
        fun beneficiary(individual: MyrBeneficiary) =
        ...
        /**
         * Returns an immutable instance of [MyrExternalAccountInfo].
         *
         ...
         */
        fun build(): MyrExternalAccountInfo =
     ...
     *   expected type.
     */
    fun validate(): MyrExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    class Beneficiary
    private constructor(
        private val individual: MyrBeneficiary? = null,
        private val business: BusinessBeneficiary? = null,
        private val _json: JsonValue? = null,
    ) {

        fun individual(): MyrBeneficiary? = individual
        ...
        fun asIndividual(): MyrBeneficiary = individual.getOrThrow("individual")
         ...
         *     override fun visitIndividual(individual: MyrBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        fun validate(): Beneficiary = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitIndividual(individual: MyrBeneficiary) {
                        individual.validate()
                    }
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: MyrBeneficiary) = individual.validity()
        ...
        companion object {
            ...
            fun ofIndividual(individual: MyrBeneficiary) = Beneficiary(individual = individual)
        ...
        interface Visitor<out T> {
            ...
            fun visitIndividual(individual: MyrBeneficiary): T
        ...
        internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                ...
                when (beneficiaryType) {
                    "INDIVIDUAL" -> {
                        return tryDeserialize(node, jacksonTypeRef<MyrBeneficiary>())?.let {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MyrExternalAccountInfo &&
    ...
    override fun toString() =
        "MyrExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, swiftCode=$swiftCode, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
