...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<ThbAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    class Builder internal constructor() {
        ...
        internal fun from(thbExternalAccountInfo: ThbExternalAccountInfo) = apply {
            accountNumber = thbExternalAccountInfo.accountNumber
            accountType = thbExternalAccountInfo.accountType
            bankName = thbExternalAccountInfo.bankName
            paymentRails = thbExternalAccountInfo.paymentRails.map { it.toMutableList() }
            swiftCode = thbExternalAccountInfo.swiftCode
            beneficiary = thbExternalAccountInfo.beneficiary
         ...
         * [ThbAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<ThbAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<ThbAccountInfo.PaymentRail>>) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThbExternalAccountInfo &&
    ...
    override fun toString() =
        "ThbExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, swiftCode=$swiftCode, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
