...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(thbExternalAccountInfo: ThbExternalAccountInfo) = apply {
            ...
            countries = thbExternalAccountInfo.countries.map { it.toMutableList() }
    ...
    override fun toString() =
        "ThbExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, countries=$countries, paymentRails=$paymentRails, additionalProperties=$additionalProperties}"
}
