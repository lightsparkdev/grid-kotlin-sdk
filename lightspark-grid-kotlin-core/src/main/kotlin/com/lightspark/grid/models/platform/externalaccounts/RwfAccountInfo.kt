...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RwfAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(rwfAccountInfo: RwfAccountInfo) = apply {
            accountType = rwfAccountInfo.accountType
            paymentRails = rwfAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = rwfAccountInfo.phoneNumber
            provider = rwfAccountInfo.provider
            additionalProperties = rwfAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RwfAccountInfo].
         *
    ...
    fun validate(): RwfAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RwfAccountInfo &&
    ...
    override fun toString() =
        "RwfAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
}
