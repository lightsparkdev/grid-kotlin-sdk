...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HtgBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(htgBeneficiary: HtgBeneficiary) = apply {
            beneficiaryType = htgBeneficiary.beneficiaryType
            fullName = htgBeneficiary.fullName
            address = htgBeneficiary.address
            birthDate = htgBeneficiary.birthDate
            countryOfResidence = htgBeneficiary.countryOfResidence
            email = htgBeneficiary.email
            nationality = htgBeneficiary.nationality
            phoneNumber = htgBeneficiary.phoneNumber
            additionalProperties = htgBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HtgBeneficiary].
         *
    ...
    fun validate(): HtgBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HtgBeneficiary &&
    ...
    override fun toString() =
        "HtgBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
