...
class CardTransactionWebhookEvent
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val id: JsonField<String>,
    private val data: JsonField<CardTransaction>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<CardTransaction> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): CardTransaction = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CardTransaction> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CardTransactionWebhookEvent].
         *
    ...
    /** A builder for [CardTransactionWebhookEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var data: JsonField<CardTransaction>? = null
        private var timestamp: JsonField<OffsetDateTime>? = null
        private var type: JsonField<Type>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(cardTransactionWebhookEvent: CardTransactionWebhookEvent) = apply {
            id = cardTransactionWebhookEvent.id
            data = cardTransactionWebhookEvent.data
            timestamp = cardTransactionWebhookEvent.timestamp
            type = cardTransactionWebhookEvent.type
            additionalProperties = cardTransactionWebhookEvent.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.data] with a well-typed [CardTransaction] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<CardTransaction>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [CardTransactionWebhookEvent].
         *
         ...
         */
        fun build(): CardTransactionWebhookEvent =
     ...
     *   expected type.
     */
    fun validate(): CardTransactionWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val CARD_TRANSACTION_AUTHORIZED = of("CARD_TRANSACTION.AUTHORIZED")

            val CARD_TRANSACTION_PARTIALLY_SETTLED = of("CARD_TRANSACTION.PARTIALLY_SETTLED")

            val CARD_TRANSACTION_SETTLED = of("CARD_TRANSACTION.SETTLED")

            val CARD_TRANSACTION_DECLINED = of("CARD_TRANSACTION.DECLINED")

            val CARD_TRANSACTION_VOIDED = of("CARD_TRANSACTION.VOIDED")
        ...
        fun value(): Value =
            when (this) {
                ...
                CARD_TRANSACTION_VOIDED -> Value.CARD_TRANSACTION_VOIDED
        ...
        fun known(): Known =
            when (this) {
                ...
                CARD_TRANSACTION_VOIDED -> Known.CARD_TRANSACTION_VOIDED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CardTransactionWebhookEvent &&
            id == other.id &&
            data == other.data &&
    ...
    override fun toString() =
        "CardTransactionWebhookEvent{id=$id, data=$data, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
