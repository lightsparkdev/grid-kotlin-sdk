...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(authMethod: AuthMethod) = apply {
            ...
            credentialId = authMethod.credentialId
    ...
    override fun toString() =
        "AuthMethod{id=$id, accountId=$accountId, createdAt=$createdAt, nickname=$nickname, type=$type, updatedAt=$updatedAt, credentialId=$credentialId, additionalProperties=$additionalProperties}"
}
