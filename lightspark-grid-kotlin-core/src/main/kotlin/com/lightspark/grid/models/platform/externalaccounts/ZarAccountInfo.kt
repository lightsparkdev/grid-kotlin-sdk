...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ZarAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(zarAccountInfo: ZarAccountInfo) = apply {
            accountNumber = zarAccountInfo.accountNumber
            accountType = zarAccountInfo.accountType
            bankName = zarAccountInfo.bankName
            paymentRails = zarAccountInfo.paymentRails.map { it.toMutableList() }
            additionalProperties = zarAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ZarAccountInfo].
         *
    ...
    fun validate(): ZarAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ZarAccountInfo &&
    ...
    override fun toString() =
        "ZarAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, additionalProperties=$additionalProperties}"
}
