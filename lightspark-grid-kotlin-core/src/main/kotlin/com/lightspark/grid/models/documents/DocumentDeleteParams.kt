...
/**
 * Delete an uploaded document. This cannot be undone. Documents that have already been submitted
 * for verification may not be deletable.
 */
...
private constructor(
    ...
    companion object {
        ...
        fun none(): DocumentDeleteParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DocumentDeleteParams]. */
        fun builder() = Builder()
    }

    /** A builder for [DocumentDeleteParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [DocumentDeleteParams].
         *
