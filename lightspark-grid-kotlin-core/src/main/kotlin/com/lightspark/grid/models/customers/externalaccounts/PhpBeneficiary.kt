...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PhpBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(phpBeneficiary: PhpBeneficiary) = apply {
            beneficiaryType = phpBeneficiary.beneficiaryType
            fullName = phpBeneficiary.fullName
            address = phpBeneficiary.address
            birthDate = phpBeneficiary.birthDate
            countryOfResidence = phpBeneficiary.countryOfResidence
            email = phpBeneficiary.email
            nationality = phpBeneficiary.nationality
            phoneNumber = phpBeneficiary.phoneNumber
            registrationNumber = phpBeneficiary.registrationNumber
            additionalProperties = phpBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PhpBeneficiary].
         *
    ...
    fun validate(): PhpBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhpBeneficiary &&
    ...
    override fun toString() =
        "PhpBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, registrationNumber=$registrationNumber, additionalProperties=$additionalProperties}"
}
