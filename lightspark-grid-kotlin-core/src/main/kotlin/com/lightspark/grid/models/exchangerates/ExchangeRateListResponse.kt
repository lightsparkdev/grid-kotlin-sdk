...
private constructor(
    private val data: JsonField<List<ExchangeRate>>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<ExchangeRate>> = JsonMissing.of()
     ...
     */
    fun data(): List<ExchangeRate> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ExchangeRate>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<ExchangeRate>>? = null
        ...
        /** List of exchange rates matching the filter criteria */
        fun data(data: List<ExchangeRate>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<ExchangeRate>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<ExchangeRate>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ExchangeRate] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ExchangeRate) = apply {
            this.data =
