...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<CadAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CadExternalAccountInfo].
         *
    ...
    /** A builder for [CadExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(cadExternalAccountInfo: CadExternalAccountInfo) = apply {
            accountNumber = cadExternalAccountInfo.accountNumber
            accountType = cadExternalAccountInfo.accountType
            bankCode = cadExternalAccountInfo.bankCode
            branchCode = cadExternalAccountInfo.branchCode
            paymentRails = cadExternalAccountInfo.paymentRails.map { it.toMutableList() }
            beneficiary = cadExternalAccountInfo.beneficiary
            additionalProperties = cadExternalAccountInfo.additionalProperties.toMutableMap()
        }
         ...
         * `List<CadAccountInfo.PaymentRail>` value instead. This method is primarily for setting
        ...
        /**
         * Returns an immutable instance of [CadExternalAccountInfo].
         *
         ...
         */
        fun build(): CadExternalAccountInfo =
     ...
     *   expected type.
     */
    fun validate(): CadExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: CadBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: CadBeneficiary) = individual.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CadExternalAccountInfo &&
    ...
    override fun toString() =
        "CadExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankCode=$bankCode, branchCode=$branchCode, paymentRails=$paymentRails, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
