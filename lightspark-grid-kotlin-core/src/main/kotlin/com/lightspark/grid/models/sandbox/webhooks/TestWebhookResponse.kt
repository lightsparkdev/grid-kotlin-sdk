...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TestWebhookResponse].
         *
    ...
    /** A builder for [TestWebhookResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(testWebhookResponse: TestWebhookResponse) = apply {
            responseStatus = testWebhookResponse.responseStatus
            responseBody = testWebhookResponse.responseBody
            url = testWebhookResponse.url
            additionalProperties = testWebhookResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TestWebhookResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): TestWebhookResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TestWebhookResponse &&
    ...
    override fun toString() =
        "TestWebhookResponse{responseStatus=$responseStatus, responseBody=$responseBody, url=$url, additionalProperties=$additionalProperties}"
}
