...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DkkBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(dkkBeneficiary: DkkBeneficiary) = apply {
            beneficiaryType = dkkBeneficiary.beneficiaryType
            fullName = dkkBeneficiary.fullName
            address = dkkBeneficiary.address
            birthDate = dkkBeneficiary.birthDate
            countryOfResidence = dkkBeneficiary.countryOfResidence
            email = dkkBeneficiary.email
            nationality = dkkBeneficiary.nationality
            phoneNumber = dkkBeneficiary.phoneNumber
            registrationNumber = dkkBeneficiary.registrationNumber
            additionalProperties = dkkBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DkkBeneficiary].
         *
    ...
    fun validate(): DkkBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DkkBeneficiary &&
    ...
    override fun toString() =
        "DkkBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, registrationNumber=$registrationNumber, additionalProperties=$additionalProperties}"
}
