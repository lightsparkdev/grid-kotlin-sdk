...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
        ...
        fun build(): JmdExternalAccountInfo =
            JmdExternalAccountInfo(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JmdExternalAccountInfo && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "JmdExternalAccountInfo{additionalProperties=$additionalProperties}"
}
