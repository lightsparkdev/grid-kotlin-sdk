...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [KesBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(kesBeneficiary: KesBeneficiary) = apply {
            beneficiaryType = kesBeneficiary.beneficiaryType
            fullName = kesBeneficiary.fullName
            address = kesBeneficiary.address
            birthDate = kesBeneficiary.birthDate
            countryOfResidence = kesBeneficiary.countryOfResidence
            email = kesBeneficiary.email
            nationality = kesBeneficiary.nationality
            phoneNumber = kesBeneficiary.phoneNumber
            additionalProperties = kesBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [KesBeneficiary].
         *
    ...
    fun validate(): KesBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is KesBeneficiary &&
    ...
    override fun toString() =
        "KesBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
