...
private constructor(
    ...
    ) : this(accountType, bankName, paymentRails, iban, phoneNumber, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EgpAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(egpAccountInfo: EgpAccountInfo) = apply {
            accountType = egpAccountInfo.accountType
            bankName = egpAccountInfo.bankName
            paymentRails = egpAccountInfo.paymentRails.map { it.toMutableList() }
            iban = egpAccountInfo.iban
            phoneNumber = egpAccountInfo.phoneNumber
            additionalProperties = egpAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EgpAccountInfo].
         *
     ...
     *   expected type.
     */
    fun validate(): EgpAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EgpAccountInfo &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountType, bankName, paymentRails, iban, phoneNumber, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "EgpAccountInfo{accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, iban=$iban, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
