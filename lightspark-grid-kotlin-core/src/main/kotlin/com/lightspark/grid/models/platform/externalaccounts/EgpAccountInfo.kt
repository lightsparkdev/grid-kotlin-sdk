...
private constructor(
    ...
    ) : this(accountType, paymentRails, iban, phoneNumber, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountType, paymentRails, iban, phoneNumber, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "EgpAccountInfo{accountType=$accountType, paymentRails=$paymentRails, iban=$iban, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
