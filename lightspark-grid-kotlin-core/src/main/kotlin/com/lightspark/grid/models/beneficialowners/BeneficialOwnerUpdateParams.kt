...
private constructor(
    ...
    private val beneficialOwnerUpdateRequest: BeneficialOwnerUpdateRequest,
    ...
    fun beneficialOwnerUpdateRequest(): BeneficialOwnerUpdateRequest = beneficialOwnerUpdateRequest

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        beneficialOwnerUpdateRequest._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var beneficialOwnerUpdateRequest: BeneficialOwnerUpdateRequest? = null
        ...
        internal fun from(beneficialOwnerUpdateParams: BeneficialOwnerUpdateParams) = apply {
            ...
            beneficialOwnerUpdateRequest = beneficialOwnerUpdateParams.beneficialOwnerUpdateRequest
        ...
        fun beneficialOwnerUpdateRequest(
            beneficialOwnerUpdateRequest: BeneficialOwnerUpdateRequest
        ) = apply { this.beneficialOwnerUpdateRequest = beneficialOwnerUpdateRequest }
        ...
        fun build(): BeneficialOwnerUpdateParams =
            BeneficialOwnerUpdateParams(
                beneficialOwnerId,
                checkRequired("beneficialOwnerUpdateRequest", beneficialOwnerUpdateRequest),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): BeneficialOwnerUpdateRequest = beneficialOwnerUpdateRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BeneficialOwnerUpdateParams &&
            ...
            beneficialOwnerUpdateRequest == other.beneficialOwnerUpdateRequest &&
    ...
    override fun toString() =
        "BeneficialOwnerUpdateParams{beneficialOwnerId=$beneficialOwnerId, beneficialOwnerUpdateRequest=$beneficialOwnerUpdateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
