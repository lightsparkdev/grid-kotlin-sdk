...
private constructor(
    ...
    ) : this(accountNumber, accountType, bankAccountType, beneficiary, phoneNumber, mutableMapOf())
    ...
    override fun toString() =
        "CopExternalAccountCreateInfo{accountNumber=$accountNumber, accountType=$accountType, bankAccountType=$bankAccountType, beneficiary=$beneficiary, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
