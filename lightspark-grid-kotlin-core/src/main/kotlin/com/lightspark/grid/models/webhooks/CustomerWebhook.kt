...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = customerWebhook.type().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomerWebhook].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerWebhook: CustomerWebhook) = apply {
            id = customerWebhook.id
            timestamp = customerWebhook.timestamp
            type = customerWebhook.type
            data = customerWebhook.data
            additionalProperties = customerWebhook.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomerWebhook].
         *
     ...
     *   expected type.
     */
    fun validate(): CustomerWebhook = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerWebhook &&
            id == other.id &&
    ...
    override fun toString() =
        "CustomerWebhook{id=$id, timestamp=$timestamp, type=$type, data=$data, additionalProperties=$additionalProperties}"
}
