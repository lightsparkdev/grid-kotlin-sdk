...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(documentListResponse: DocumentListResponse) = apply {
            ...
            hasMore = documentListResponse.hasMore
    ...
    override fun toString() =
        "DocumentListResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
