...
class VndExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VndExternalAccountCreateInfo].
         *
    ...
    /** A builder for [VndExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(vndExternalAccountCreateInfo: VndExternalAccountCreateInfo) = apply {
            accountNumber = vndExternalAccountCreateInfo.accountNumber
            accountType = vndExternalAccountCreateInfo.accountType
            bankName = vndExternalAccountCreateInfo.bankName
            beneficiary = vndExternalAccountCreateInfo.beneficiary
            swiftCode = vndExternalAccountCreateInfo.swiftCode
            additionalProperties = vndExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VndExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): VndExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): VndExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VndExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "VndExternalAccountCreateInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
}
