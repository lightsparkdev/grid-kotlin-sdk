...
private constructor(
    ...
    private val status: JsonField<ExternalAccountStatus>,
    ...
    private constructor(
        ...
        @JsonProperty("status")
        @ExcludeMissing
        status: JsonField<ExternalAccountStatus> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun status(): ExternalAccountStatus = status.getRequired("status")
     ...
     */
    @JsonProperty("status") @ExcludeMissing fun _status(): JsonField<ExternalAccountStatus> = status
    ...
    class Builder internal constructor() {
        ...
        private var status: JsonField<ExternalAccountStatus>? = null
         ...
         * `ExternalAccountInfoOneOf.ofSwiftAccount(swiftAccount)`.
         */
        ...
        /** Status of the external account */
        fun status(status: ExternalAccountStatus) = status(JsonField.of(status))

        /**
         * Sets [Builder.status] to an arbitrary JSON value.
         *
         * You should usually call [Builder.status] with a well-typed [ExternalAccountStatus] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun status(status: JsonField<ExternalAccountStatus>) = apply { this.status = status }
