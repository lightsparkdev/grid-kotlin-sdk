...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(vndExternalAccountInfo: VndExternalAccountInfo) = apply {
            ...
            countries = vndExternalAccountInfo.countries.map { it.toMutableList() }
    ...
    override fun toString() =
        "VndExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, countries=$countries, paymentRails=$paymentRails, additionalProperties=$additionalProperties}"
}
