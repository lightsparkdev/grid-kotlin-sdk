...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<VndAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VndExternalAccountInfo].
         *
    ...
    /** A builder for [VndExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(vndExternalAccountInfo: VndExternalAccountInfo) = apply {
            accountNumber = vndExternalAccountInfo.accountNumber
            accountType = vndExternalAccountInfo.accountType
            bankName = vndExternalAccountInfo.bankName
            paymentRails = vndExternalAccountInfo.paymentRails.map { it.toMutableList() }
            swiftCode = vndExternalAccountInfo.swiftCode
            beneficiary = vndExternalAccountInfo.beneficiary
            additionalProperties = vndExternalAccountInfo.additionalProperties.toMutableMap()
        }
         ...
         * [VndAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<VndAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<VndAccountInfo.PaymentRail>>) = apply {
        ...
        fun beneficiary(individual: VndBeneficiary) =
        ...
        /**
         * Returns an immutable instance of [VndExternalAccountInfo].
         *
         ...
         */
        fun build(): VndExternalAccountInfo =
     ...
     *   expected type.
     */
    fun validate(): VndExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    class Beneficiary
    private constructor(
        private val individual: VndBeneficiary? = null,
        private val business: BusinessBeneficiary? = null,
        private val _json: JsonValue? = null,
    ) {

        fun individual(): VndBeneficiary? = individual
        ...
        fun asIndividual(): VndBeneficiary = individual.getOrThrow("individual")
         ...
         *     override fun visitIndividual(individual: VndBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        fun validate(): Beneficiary = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitIndividual(individual: VndBeneficiary) {
                        individual.validate()
                    }
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: VndBeneficiary) = individual.validity()
        ...
        companion object {
            ...
            fun ofIndividual(individual: VndBeneficiary) = Beneficiary(individual = individual)
        ...
        interface Visitor<out T> {
            ...
            fun visitIndividual(individual: VndBeneficiary): T
        ...
        internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                ...
                when (beneficiaryType) {
                    "INDIVIDUAL" -> {
                        return tryDeserialize(node, jacksonTypeRef<VndBeneficiary>())?.let {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VndExternalAccountInfo &&
    ...
    override fun toString() =
        "VndExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, swiftCode=$swiftCode, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
