...
private constructor(
    ...
    ) : this(accountNumber, accountType, bankCode, branchCode, paymentRails, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cadAccountInfo: CadAccountInfo) = apply {
            ...
            paymentRails = cadAccountInfo.paymentRails.map { it.toMutableList() }
    ...
    override fun toString() =
        "CadAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankCode=$bankCode, branchCode=$branchCode, paymentRails=$paymentRails, additionalProperties=$additionalProperties}"
}
