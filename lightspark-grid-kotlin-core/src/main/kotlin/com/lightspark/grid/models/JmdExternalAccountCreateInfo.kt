...
class JmdExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [JmdExternalAccountCreateInfo].
         *
    ...
    /** A builder for [JmdExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(jmdExternalAccountCreateInfo: JmdExternalAccountCreateInfo) = apply {
        ...
        /**
         * Returns an immutable instance of [JmdExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): JmdExternalAccountCreateInfo =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JmdExternalAccountCreateInfo &&
