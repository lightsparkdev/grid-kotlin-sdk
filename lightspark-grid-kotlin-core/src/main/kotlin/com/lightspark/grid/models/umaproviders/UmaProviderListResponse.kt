...
private constructor(
    private val data: JsonField<List<UmaProvider>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<UmaProvider>> = JsonMissing.of(),
     ...
     */
    fun data(): List<UmaProvider>? = data.getNullable("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<UmaProvider>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<UmaProvider>>? = null
        ...
        /** List of available UMA Providers using Grid */
        fun data(data: List<UmaProvider>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<UmaProvider>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<UmaProvider>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [UmaProvider] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: UmaProvider) = apply {
            this.data =
