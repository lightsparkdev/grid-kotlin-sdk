...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VerificationListResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [VerificationListResponse].
         *
    ...
    fun validate(): VerificationListResponse = apply {
        if (validated) {
            return@apply
        }
