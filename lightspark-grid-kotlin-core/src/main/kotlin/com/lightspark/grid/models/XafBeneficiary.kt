...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [XafBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(xafBeneficiary: XafBeneficiary) = apply {
            beneficiaryType = xafBeneficiary.beneficiaryType
            fullName = xafBeneficiary.fullName
            address = xafBeneficiary.address
            birthDate = xafBeneficiary.birthDate
            countryOfResidence = xafBeneficiary.countryOfResidence
            email = xafBeneficiary.email
            nationality = xafBeneficiary.nationality
            phoneNumber = xafBeneficiary.phoneNumber
            additionalProperties = xafBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [XafBeneficiary].
         *
    ...
    fun validate(): XafBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is XafBeneficiary &&
    ...
    override fun toString() =
        "XafBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
