...
class CadExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CadExternalAccountCreateInfo].
         *
    ...
    /** A builder for [CadExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(cadExternalAccountCreateInfo: CadExternalAccountCreateInfo) = apply {
            accountNumber = cadExternalAccountCreateInfo.accountNumber
            accountType = cadExternalAccountCreateInfo.accountType
            bankCode = cadExternalAccountCreateInfo.bankCode
            beneficiary = cadExternalAccountCreateInfo.beneficiary
            branchCode = cadExternalAccountCreateInfo.branchCode
            additionalProperties = cadExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CadExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): CadExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): CadExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CadExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "CadExternalAccountCreateInfo{accountNumber=$accountNumber, accountType=$accountType, bankCode=$bankCode, beneficiary=$beneficiary, branchCode=$branchCode, additionalProperties=$additionalProperties}"
}
