 ...
 * operation type.
 */
class TransactionRejectResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransactionRejectResponse].
         *
    ...
    /** A builder for [TransactionRejectResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(transactionRejectResponse: TransactionRejectResponse) = apply {
            id = transactionRejectResponse.id
            agentId = transactionRejectResponse.agentId
            createdAt = transactionRejectResponse.createdAt
            customerId = transactionRejectResponse.customerId
            platformCustomerId = transactionRejectResponse.platformCustomerId
            status = transactionRejectResponse.status
            type = transactionRejectResponse.type
            updatedAt = transactionRejectResponse.updatedAt
            quote = transactionRejectResponse.quote
            rejectionReason = transactionRejectResponse.rejectionReason
            transaction = transactionRejectResponse.transaction
            transferDetails = transactionRejectResponse.transferDetails
            additionalProperties = transactionRejectResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TransactionRejectResponse].
         *
         ...
         */
        fun build(): TransactionRejectResponse =
     ...
     *   expected type.
     */
    fun validate(): TransactionRejectResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransactionRejectResponse &&
            id == other.id &&
