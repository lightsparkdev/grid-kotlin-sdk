...
private constructor(
    ...
    ) : this(id, invitation, timestamp, type, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, invitation, timestamp, type, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "InvitationClaimedWebhookEvent{id=$id, invitation=$invitation, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
