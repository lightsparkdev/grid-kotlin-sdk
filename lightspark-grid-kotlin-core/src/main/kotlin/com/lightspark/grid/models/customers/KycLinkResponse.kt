...
class KycLinkResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val expiresAt: JsonField<OffsetDateTime>,
    private val kycUrl: JsonField<String>,
    private val provider: JsonField<KycProvider>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        provider: JsonField<KycProvider> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun provider(): KycProvider = provider.getRequired("provider")
     ...
     */
    @JsonProperty("provider") @ExcludeMissing fun _provider(): JsonField<KycProvider> = provider
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [KycLinkResponse].
         *
    ...
    /** A builder for [KycLinkResponse]. */
    class Builder internal constructor() {

        private var expiresAt: JsonField<OffsetDateTime>? = null
        private var kycUrl: JsonField<String>? = null
        private var provider: JsonField<KycProvider>? = null
        private var token: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(kycLinkResponse: KycLinkResponse) = apply {
            expiresAt = kycLinkResponse.expiresAt
            kycUrl = kycLinkResponse.kycUrl
            provider = kycLinkResponse.provider
            token = kycLinkResponse.token
            additionalProperties = kycLinkResponse.additionalProperties.toMutableMap()
        }
         ...
         * informational for platforms that want to integrate directly with the provider's SDK.
         */
        fun provider(provider: KycProvider) = provider(JsonField.of(provider))

        /**
         * Sets [Builder.provider] to an arbitrary JSON value.
         *
         * You should usually call [Builder.provider] with a well-typed [KycProvider] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun provider(provider: JsonField<KycProvider>) = apply { this.provider = provider }
        ...
        /**
         * Returns an immutable instance of [KycLinkResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): KycLinkResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is KycLinkResponse &&
    ...
    override fun toString() =
        "KycLinkResponse{expiresAt=$expiresAt, kycUrl=$kycUrl, provider=$provider, token=$token, additionalProperties=$additionalProperties}"
}
