...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun policy(): AgentPolicy = body.policy()
     ...
     */
    fun _policy(): JsonField<AgentPolicy> = body._policy()
    ...
    class Builder internal constructor() {
         ...
         * boundaries.
         */
        fun policy(policy: AgentPolicy) = apply { body.policy(policy) }
         ...
         * value.
         */
        fun policy(policy: JsonField<AgentPolicy>) = apply { body.policy(policy) }
