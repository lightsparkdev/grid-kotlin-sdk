...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrlBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(brlBeneficiary: BrlBeneficiary) = apply {
            beneficiaryType = brlBeneficiary.beneficiaryType
            fullName = brlBeneficiary.fullName
            address = brlBeneficiary.address
            birthDate = brlBeneficiary.birthDate
            countryOfResidence = brlBeneficiary.countryOfResidence
            email = brlBeneficiary.email
            nationality = brlBeneficiary.nationality
            phoneNumber = brlBeneficiary.phoneNumber
            registrationNumber = brlBeneficiary.registrationNumber
            additionalProperties = brlBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrlBeneficiary].
         *
    ...
    fun validate(): BrlBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrlBeneficiary &&
    ...
    override fun toString() =
        "BrlBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, registrationNumber=$registrationNumber, additionalProperties=$additionalProperties}"
}
