...
class MeListInternalAccountsPageResponse
...
private constructor(
    ...
    companion object {
         ...
         * [MeListInternalAccountsPageResponse].
         *
    ...
    /** A builder for [MeListInternalAccountsPageResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(meListInternalAccountsPageResponse: MeListInternalAccountsPageResponse) =
            apply {
                data = meListInternalAccountsPageResponse.data.map { it.toMutableList() }
                hasMore = meListInternalAccountsPageResponse.hasMore
                nextCursor = meListInternalAccountsPageResponse.nextCursor
                totalCount = meListInternalAccountsPageResponse.totalCount
                additionalProperties =
                    meListInternalAccountsPageResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [MeListInternalAccountsPageResponse].
         *
         ...
         */
        fun build(): MeListInternalAccountsPageResponse =
            MeListInternalAccountsPageResponse(
     ...
     *   expected type.
     */
    fun validate(): MeListInternalAccountsPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MeListInternalAccountsPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "MeListInternalAccountsPageResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
