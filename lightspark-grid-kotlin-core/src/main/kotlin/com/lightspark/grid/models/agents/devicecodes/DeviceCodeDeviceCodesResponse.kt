...
class DeviceCodeDeviceCodesResponse
...
private constructor(
    ...
    /** A builder for [DeviceCodeDeviceCodesResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(deviceCodeDeviceCodesResponse: DeviceCodeDeviceCodesResponse) = apply {
            agentId = deviceCodeDeviceCodesResponse.agentId
            code = deviceCodeDeviceCodesResponse.code
            expiresAt = deviceCodeDeviceCodesResponse.expiresAt
            redeemed = deviceCodeDeviceCodesResponse.redeemed
            additionalProperties = deviceCodeDeviceCodesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DeviceCodeDeviceCodesResponse].
         *
         ...
         */
        fun build(): DeviceCodeDeviceCodesResponse =
            DeviceCodeDeviceCodesResponse(
     ...
     *   expected type.
     */
    fun validate(): DeviceCodeDeviceCodesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeviceCodeDeviceCodesResponse &&
    ...
    override fun toString() =
        "DeviceCodeDeviceCodesResponse{agentId=$agentId, code=$code, expiresAt=$expiresAt, redeemed=$redeemed, additionalProperties=$additionalProperties}"
}
