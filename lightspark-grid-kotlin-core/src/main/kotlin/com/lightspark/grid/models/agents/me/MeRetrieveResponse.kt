...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(meRetrieveResponse: MeRetrieveResponse) = apply {
            ...
            createdAt = meRetrieveResponse.createdAt
            customerId = meRetrieveResponse.customerId
            isConnected = meRetrieveResponse.isConnected
            isPaused = meRetrieveResponse.isPaused
            name = meRetrieveResponse.name
            policy = meRetrieveResponse.policy
            updatedAt = meRetrieveResponse.updatedAt
    ...
    override fun toString() =
        "MeRetrieveResponse{id=$id, createdAt=$createdAt, customerId=$customerId, isConnected=$isConnected, isPaused=$isPaused, name=$name, policy=$policy, updatedAt=$updatedAt, usage=$usage, additionalProperties=$additionalProperties}"
}
