...
class TzsExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TzsExternalAccountCreateInfo].
         *
    ...
    /** A builder for [TzsExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(tzsExternalAccountCreateInfo: TzsExternalAccountCreateInfo) = apply {
            accountType = tzsExternalAccountCreateInfo.accountType
            beneficiary = tzsExternalAccountCreateInfo.beneficiary
            phoneNumber = tzsExternalAccountCreateInfo.phoneNumber
            provider = tzsExternalAccountCreateInfo.provider
            additionalProperties = tzsExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TzsExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): TzsExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): TzsExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: TzsBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: TzsBeneficiary) = individual.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TzsExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "TzsExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
}
