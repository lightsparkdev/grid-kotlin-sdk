...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardUpdateResponse: CardUpdateResponse) = apply {
            id = cardUpdateResponse.id
            cardholderId = cardUpdateResponse.cardholderId
            createdAt = cardUpdateResponse.createdAt
            form = cardUpdateResponse.form
            fundingSources = cardUpdateResponse.fundingSources.map { it.toMutableList() }
            state = cardUpdateResponse.state
            updatedAt = cardUpdateResponse.updatedAt
            brand = cardUpdateResponse.brand
            currency = cardUpdateResponse.currency
            expMonth = cardUpdateResponse.expMonth
            expYear = cardUpdateResponse.expYear
            issuerRef = cardUpdateResponse.issuerRef
            last4 = cardUpdateResponse.last4
            panEmbedUrl = cardUpdateResponse.panEmbedUrl
            platformCardId = cardUpdateResponse.platformCardId
            stateReason = cardUpdateResponse.stateReason
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CardUpdateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "CardUpdateResponse{id=$id, cardholderId=$cardholderId, createdAt=$createdAt, form=$form, fundingSources=$fundingSources, state=$state, updatedAt=$updatedAt, brand=$brand, currency=$currency, expMonth=$expMonth, expYear=$expYear, issuerRef=$issuerRef, last4=$last4, panEmbedUrl=$panEmbedUrl, platformCardId=$platformCardId, stateReason=$stateReason, additionalProperties=$additionalProperties}"
}
