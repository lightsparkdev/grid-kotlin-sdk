...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EurAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [EurAccountInfo].
         *
    ...
    fun validate(): EurAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EurAccountInfo &&
