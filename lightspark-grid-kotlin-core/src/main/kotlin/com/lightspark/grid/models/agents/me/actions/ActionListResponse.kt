...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ActionListResponse].
         *
    ...
    /** A builder for [ActionListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(actionListResponse: ActionListResponse) = apply {
            id = actionListResponse.id
            agentId = actionListResponse.agentId
            createdAt = actionListResponse.createdAt
            customerId = actionListResponse.customerId
            platformCustomerId = actionListResponse.platformCustomerId
            status = actionListResponse.status
            type = actionListResponse.type
            updatedAt = actionListResponse.updatedAt
            quote = actionListResponse.quote
            rejectionReason = actionListResponse.rejectionReason
            transaction = actionListResponse.transaction
            transferDetails = actionListResponse.transferDetails
            additionalProperties = actionListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionListResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): ActionListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionListResponse &&
            id == other.id &&
