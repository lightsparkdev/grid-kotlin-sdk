...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NgnBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ngnBeneficiary: NgnBeneficiary) = apply {
            beneficiaryType = ngnBeneficiary.beneficiaryType
            fullName = ngnBeneficiary.fullName
            address = ngnBeneficiary.address
            birthDate = ngnBeneficiary.birthDate
            countryOfResidence = ngnBeneficiary.countryOfResidence
            email = ngnBeneficiary.email
            nationality = ngnBeneficiary.nationality
            phoneNumber = ngnBeneficiary.phoneNumber
            additionalProperties = ngnBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NgnBeneficiary].
         *
    ...
    fun validate(): NgnBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NgnBeneficiary &&
    ...
    override fun toString() =
        "NgnBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
