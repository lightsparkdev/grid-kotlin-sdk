...
private constructor(
    ...
    ) : this(accountNumber, accountType, paymentRails, sortCode, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(gbpAccountInfo: GbpAccountInfo) = apply {
            ...
            paymentRails = gbpAccountInfo.paymentRails.map { it.toMutableList() }
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountNumber, accountType, paymentRails, sortCode, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "GbpAccountInfo{accountNumber=$accountNumber, accountType=$accountType, paymentRails=$paymentRails, sortCode=$sortCode, additionalProperties=$additionalProperties}"
}
