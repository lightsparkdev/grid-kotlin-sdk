...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<IdrAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IdrExternalAccountInfo].
         *
    ...
    /** A builder for [IdrExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(idrExternalAccountInfo: IdrExternalAccountInfo) = apply {
            accountNumber = idrExternalAccountInfo.accountNumber
            accountType = idrExternalAccountInfo.accountType
            bankName = idrExternalAccountInfo.bankName
            paymentRails = idrExternalAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = idrExternalAccountInfo.phoneNumber
            swiftCode = idrExternalAccountInfo.swiftCode
            beneficiary = idrExternalAccountInfo.beneficiary
            additionalProperties = idrExternalAccountInfo.additionalProperties.toMutableMap()
        }
         ...
         * [IdrAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<IdrAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<IdrAccountInfo.PaymentRail>>) = apply {
        ...
        fun beneficiary(individual: IdrBeneficiary) =
        ...
        /**
         * Returns an immutable instance of [IdrExternalAccountInfo].
         *
         ...
         */
        fun build(): IdrExternalAccountInfo =
     ...
     *   expected type.
     */
    fun validate(): IdrExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    class Beneficiary
    private constructor(
        private val individual: IdrBeneficiary? = null,
        private val business: BusinessBeneficiary? = null,
        private val _json: JsonValue? = null,
    ) {

        fun individual(): IdrBeneficiary? = individual
        ...
        fun asIndividual(): IdrBeneficiary = individual.getOrThrow("individual")
         ...
         *     override fun visitIndividual(individual: IdrBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        fun validate(): Beneficiary = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitIndividual(individual: IdrBeneficiary) {
                        individual.validate()
                    }
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: IdrBeneficiary) = individual.validity()
        ...
        companion object {
            ...
            fun ofIndividual(individual: IdrBeneficiary) = Beneficiary(individual = individual)
        ...
        interface Visitor<out T> {
            ...
            fun visitIndividual(individual: IdrBeneficiary): T
        ...
        internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                ...
                when (beneficiaryType) {
                    "INDIVIDUAL" -> {
                        return tryDeserialize(node, jacksonTypeRef<IdrBeneficiary>())?.let {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IdrExternalAccountInfo &&
    ...
    override fun toString() =
        "IdrExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, phoneNumber=$phoneNumber, swiftCode=$swiftCode, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
