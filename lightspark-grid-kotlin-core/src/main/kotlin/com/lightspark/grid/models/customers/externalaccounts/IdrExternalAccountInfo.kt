...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(idrExternalAccountInfo: IdrExternalAccountInfo) = apply {
            ...
            countries = idrExternalAccountInfo.countries.map { it.toMutableList() }
            paymentRails = idrExternalAccountInfo.paymentRails.map { it.toMutableList() }
            sortCode = idrExternalAccountInfo.sortCode
    ...
    override fun toString() =
        "IdrExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, beneficiary=$beneficiary, countries=$countries, paymentRails=$paymentRails, sortCode=$sortCode, additionalProperties=$additionalProperties}"
}
