...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AuthMethodResponse].
         *
    ...
    /** A builder for [AuthMethodResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(authMethodResponse: AuthMethodResponse) = apply {
            ...
            accountId = authMethodResponse.accountId
            createdAt = authMethodResponse.createdAt
            nickname = authMethodResponse.nickname
        ...
        /**
         * Returns an immutable instance of [AuthMethodResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): AuthMethodResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthMethodResponse &&
            id == other.id &&
