...
class EmailOtpCredentialVerifyRequestFields
...
private constructor(
    ...
    /** A builder for [EmailOtpCredentialVerifyRequestFields]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            clientPublicKey = emailOtpCredentialVerifyRequestFields.clientPublicKey
            otp = emailOtpCredentialVerifyRequestFields.otp
            type = emailOtpCredentialVerifyRequestFields.type
            additionalProperties =
                emailOtpCredentialVerifyRequestFields.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailOtpCredentialVerifyRequestFields].
         *
         ...
         */
        fun build(): EmailOtpCredentialVerifyRequestFields =
            EmailOtpCredentialVerifyRequestFields(
     ...
     *   expected type.
     */
    fun validate(): EmailOtpCredentialVerifyRequestFields = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailOtpCredentialVerifyRequestFields &&
    ...
    override fun toString() =
        "EmailOtpCredentialVerifyRequestFields{clientPublicKey=$clientPublicKey, otp=$otp, type=$type, additionalProperties=$additionalProperties}"
}
