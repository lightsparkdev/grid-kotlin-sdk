...
private constructor(
    ...
    override fun toString() =
        "BeneficialOwnerUpdateResponse{id=$id, createdAt=$createdAt, customerId=$customerId, kycStatus=$kycStatus, personalInfo=$personalInfo, roles=$roles, ownershipPercentage=$ownershipPercentage, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
