...
private constructor(
    ...
    private val documentType: JsonField<IdentityDocumentType>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        documentType: JsonField<IdentityDocumentType> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun documentType(): IdentityDocumentType = documentType.getRequired("documentType")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun issuingAuthority(): String = issuingAuthority.getRequired("issuingAuthority")
    ...
    @JsonProperty("documentType")
    @ExcludeMissing
    fun _documentType(): JsonField<IdentityDocumentType> = documentType
    ...
    class Builder internal constructor() {
        ...
        private var documentType: JsonField<IdentityDocumentType>? = null
        private var file: JsonField<String>? = null
        private var issuingAuthority: JsonField<String>? = null
        private var side: JsonField<Side> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(identityDocumentUploadRequest: IdentityDocumentUploadRequest) = apply {
            ...
            additionalProperties = identityDocumentUploadRequest.additionalProperties.toMutableMap()
        }
        ...
        /** Identity document types issued by a government to verify an individual's identity. */
        fun documentType(documentType: IdentityDocumentType) =
            documentType(JsonField.of(documentType))

        /**
         * Sets [Builder.documentType] to an arbitrary JSON value.
         *
         * You should usually call [Builder.documentType] with a well-typed [IdentityDocumentType]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun documentType(documentType: JsonField<IdentityDocumentType>) = apply {
