...
private constructor(
    ...
    ) : this(accountType, paymentRails, accountNumber, bankName, iban, phoneNumber, mutableMapOf())
    ...
    override fun toString() =
        "PkrAccountInfo{accountType=$accountType, paymentRails=$paymentRails, accountNumber=$accountNumber, bankName=$bankName, iban=$iban, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
