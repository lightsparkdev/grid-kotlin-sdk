...
private constructor(
    ...
    ) : this(accountType, bankName, paymentRails, accountNumber, iban, phoneNumber, mutableMapOf())
    ...
    override fun toString() =
        "PkrAccountInfo{accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, accountNumber=$accountNumber, iban=$iban, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
