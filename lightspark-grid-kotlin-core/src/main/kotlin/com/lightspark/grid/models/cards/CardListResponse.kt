...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardListResponse: CardListResponse) = apply {
            ...
            hasMore = cardListResponse.hasMore
    ...
    override fun toString() =
        "CardListResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
