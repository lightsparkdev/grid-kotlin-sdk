...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardListResponse: CardListResponse) = apply {
            id = cardListResponse.id
            cardholderId = cardListResponse.cardholderId
            createdAt = cardListResponse.createdAt
            form = cardListResponse.form
            fundingSources = cardListResponse.fundingSources.map { it.toMutableList() }
            state = cardListResponse.state
            updatedAt = cardListResponse.updatedAt
            brand = cardListResponse.brand
            currency = cardListResponse.currency
            expMonth = cardListResponse.expMonth
            expYear = cardListResponse.expYear
            issuerRef = cardListResponse.issuerRef
            last4 = cardListResponse.last4
            panEmbedUrl = cardListResponse.panEmbedUrl
            platformCardId = cardListResponse.platformCardId
            stateReason = cardListResponse.stateReason
    ...
    override fun toString() =
        "CardListResponse{id=$id, cardholderId=$cardholderId, createdAt=$createdAt, form=$form, fundingSources=$fundingSources, state=$state, updatedAt=$updatedAt, brand=$brand, currency=$currency, expMonth=$expMonth, expYear=$expYear, issuerRef=$issuerRef, last4=$last4, panEmbedUrl=$panEmbedUrl, platformCardId=$platformCardId, stateReason=$stateReason, additionalProperties=$additionalProperties}"
}
