...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardListPageResponse: CardListPageResponse) = apply {
            ...
            hasMore = cardListPageResponse.hasMore
    ...
    override fun toString() =
        "CardListPageResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
