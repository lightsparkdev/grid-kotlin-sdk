...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BusinessInfoResponse].
         *
    ...
    /** A builder for [BusinessInfoResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(businessInfoResponse: BusinessInfoResponse) = apply {
            legalName = businessInfoResponse.legalName
            businessType = businessInfoResponse.businessType
            countriesOfOperation =
                businessInfoResponse.countriesOfOperation.map { it.toMutableList() }
            country = businessInfoResponse.country
            doingBusinessAs = businessInfoResponse.doingBusinessAs
            entityType = businessInfoResponse.entityType
            expectedMonthlyTransactionCount = businessInfoResponse.expectedMonthlyTransactionCount
            expectedMonthlyTransactionVolume = businessInfoResponse.expectedMonthlyTransactionVolume
            expectedRecipientJurisdictions =
                businessInfoResponse.expectedRecipientJurisdictions.map { it.toMutableList() }
            incorporatedOn = businessInfoResponse.incorporatedOn
            purposeOfAccount = businessInfoResponse.purposeOfAccount
            registrationNumber = businessInfoResponse.registrationNumber
            sourceOfFunds = businessInfoResponse.sourceOfFunds
            taxId = businessInfoResponse.taxId
            additionalProperties = businessInfoResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BusinessInfoResponse].
         *
         ...
         */
        fun build(): BusinessInfoResponse =
     ...
     *   expected type.
     */
    fun validate(): BusinessInfoResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BusinessInfoResponse &&
