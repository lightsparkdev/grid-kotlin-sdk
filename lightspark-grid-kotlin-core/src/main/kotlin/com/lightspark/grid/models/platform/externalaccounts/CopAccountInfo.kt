...
private constructor(
    ...
    ) : this(accountType, paymentRails, accountNumber, phoneNumber, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CopAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(copAccountInfo: CopAccountInfo) = apply {
            accountType = copAccountInfo.accountType
            paymentRails = copAccountInfo.paymentRails.map { it.toMutableList() }
            accountNumber = copAccountInfo.accountNumber
        ...
        /**
         * Returns an immutable instance of [CopAccountInfo].
         *
     ...
     *   expected type.
     */
    fun validate(): CopAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CopAccountInfo &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountType, paymentRails, accountNumber, phoneNumber, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "CopAccountInfo{accountType=$accountType, paymentRails=$paymentRails, accountNumber=$accountNumber, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
