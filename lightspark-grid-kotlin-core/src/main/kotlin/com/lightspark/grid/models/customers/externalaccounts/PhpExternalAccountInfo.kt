...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<PhpAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PhpExternalAccountInfo].
         *
    ...
    /** A builder for [PhpExternalAccountInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(phpExternalAccountInfo: PhpExternalAccountInfo) = apply {
            accountNumber = phpExternalAccountInfo.accountNumber
            accountType = phpExternalAccountInfo.accountType
            bankName = phpExternalAccountInfo.bankName
            paymentRails = phpExternalAccountInfo.paymentRails.map { it.toMutableList() }
            beneficiary = phpExternalAccountInfo.beneficiary
            additionalProperties = phpExternalAccountInfo.additionalProperties.toMutableMap()
        }
         ...
         * [PhpAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<PhpAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<PhpAccountInfo.PaymentRail>>) = apply {
        ...
        /**
         * Returns an immutable instance of [PhpExternalAccountInfo].
         *
         ...
         */
        fun build(): PhpExternalAccountInfo =
     ...
     *   expected type.
     */
    fun validate(): PhpExternalAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhpExternalAccountInfo &&
    ...
    override fun toString() =
        "PhpExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
