...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(phpExternalAccountInfo: PhpExternalAccountInfo) = apply {
            ...
            countries = phpExternalAccountInfo.countries.map { it.toMutableList() }
    ...
    override fun toString() =
        "PhpExternalAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, countries=$countries, paymentRails=$paymentRails, additionalProperties=$additionalProperties}"
}
