 ...
 */
class EgpExternalAccountCreateInfo
...
private constructor(
    ...
    ) : this(accountType, bankName, beneficiary, iban, phoneNumber, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EgpExternalAccountCreateInfo].
         *
    ...
    /** A builder for [EgpExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(egpExternalAccountCreateInfo: EgpExternalAccountCreateInfo) = apply {
            ...
            phoneNumber = egpExternalAccountCreateInfo.phoneNumber
            additionalProperties = egpExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EgpExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): EgpExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): EgpExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     override fun visitIndividual(individual: EgpBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: EgpBeneficiary) = individual.validity()
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountType, bankName, beneficiary, iban, phoneNumber, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "EgpExternalAccountCreateInfo{accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, iban=$iban, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
