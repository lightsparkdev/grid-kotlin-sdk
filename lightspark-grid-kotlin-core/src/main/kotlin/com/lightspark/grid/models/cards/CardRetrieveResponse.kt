...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CardRetrieveResponse].
         *
    ...
    /** A builder for [CardRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(cardRetrieveResponse: CardRetrieveResponse) = apply {
            id = cardRetrieveResponse.id
            cardholderId = cardRetrieveResponse.cardholderId
            createdAt = cardRetrieveResponse.createdAt
            form = cardRetrieveResponse.form
            fundingSources = cardRetrieveResponse.fundingSources.map { it.toMutableList() }
            state = cardRetrieveResponse.state
            updatedAt = cardRetrieveResponse.updatedAt
            brand = cardRetrieveResponse.brand
            currency = cardRetrieveResponse.currency
            expMonth = cardRetrieveResponse.expMonth
            expYear = cardRetrieveResponse.expYear
            issuerRef = cardRetrieveResponse.issuerRef
            last4 = cardRetrieveResponse.last4
            panEmbedUrl = cardRetrieveResponse.panEmbedUrl
            platformCardId = cardRetrieveResponse.platformCardId
            stateReason = cardRetrieveResponse.stateReason
            additionalProperties = cardRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CardRetrieveResponse].
         *
         ...
         */
        fun build(): CardRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): CardRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CardRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "CardRetrieveResponse{id=$id, cardholderId=$cardholderId, createdAt=$createdAt, form=$form, fundingSources=$fundingSources, state=$state, updatedAt=$updatedAt, brand=$brand, currency=$currency, expMonth=$expMonth, expYear=$expYear, issuerRef=$issuerRef, last4=$last4, panEmbedUrl=$panEmbedUrl, platformCardId=$platformCardId, stateReason=$stateReason, additionalProperties=$additionalProperties}"
}
