...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CardPullSummary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardPullSummary: CardPullSummary) = apply {
            count = cardPullSummary.count
            totalAmount = cardPullSummary.totalAmount
            pendingCount = cardPullSummary.pendingCount
            additionalProperties = cardPullSummary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CardPullSummary].
         *
     ...
     *   expected type.
     */
    fun validate(): CardPullSummary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CardPullSummary &&
            count == other.count &&
    ...
    override fun toString() =
        "CardPullSummary{count=$count, totalAmount=$totalAmount, pendingCount=$pendingCount, additionalProperties=$additionalProperties}"
}
