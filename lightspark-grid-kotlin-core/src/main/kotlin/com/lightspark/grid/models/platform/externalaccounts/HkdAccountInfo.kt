...
private constructor(
    ...
    ) : this(accountNumber, accountType, paymentRails, swiftCode, bankName, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HkdAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(hkdAccountInfo: HkdAccountInfo) = apply {
            accountNumber = hkdAccountInfo.accountNumber
            accountType = hkdAccountInfo.accountType
            paymentRails = hkdAccountInfo.paymentRails.map { it.toMutableList() }
            swiftCode = hkdAccountInfo.swiftCode
            bankName = hkdAccountInfo.bankName
            additionalProperties = hkdAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HkdAccountInfo].
         *
     ...
     *   expected type.
     */
    fun validate(): HkdAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HkdAccountInfo &&
    ...
    override fun toString() =
        "HkdAccountInfo{accountNumber=$accountNumber, accountType=$accountType, paymentRails=$paymentRails, swiftCode=$swiftCode, bankName=$bankName, additionalProperties=$additionalProperties}"
}
