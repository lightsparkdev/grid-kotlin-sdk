...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GhsBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ghsBeneficiary: GhsBeneficiary) = apply {
            beneficiaryType = ghsBeneficiary.beneficiaryType
            fullName = ghsBeneficiary.fullName
            address = ghsBeneficiary.address
            birthDate = ghsBeneficiary.birthDate
            countryOfResidence = ghsBeneficiary.countryOfResidence
            email = ghsBeneficiary.email
            nationality = ghsBeneficiary.nationality
            phoneNumber = ghsBeneficiary.phoneNumber
            additionalProperties = ghsBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GhsBeneficiary].
         *
    ...
    fun validate(): GhsBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GhsBeneficiary &&
    ...
    override fun toString() =
        "GhsBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
