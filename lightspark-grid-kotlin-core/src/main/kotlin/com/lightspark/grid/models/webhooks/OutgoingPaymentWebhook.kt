...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = outgoingPaymentWebhook.type().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OutgoingPaymentWebhook].
         *
    ...
    /** A builder for [OutgoingPaymentWebhook]. */
    class Builder internal constructor() {
        ...
        internal fun from(outgoingPaymentWebhook: OutgoingPaymentWebhook) = apply {
            id = outgoingPaymentWebhook.id
            timestamp = outgoingPaymentWebhook.timestamp
            type = outgoingPaymentWebhook.type
            data = outgoingPaymentWebhook.data
            additionalProperties = outgoingPaymentWebhook.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OutgoingPaymentWebhook].
         *
         ...
         */
        fun build(): OutgoingPaymentWebhook =
     ...
     *   expected type.
     */
    fun validate(): OutgoingPaymentWebhook = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OutgoingPaymentWebhook &&
            id == other.id &&
    ...
    override fun toString() =
        "OutgoingPaymentWebhook{id=$id, timestamp=$timestamp, type=$type, data=$data, additionalProperties=$additionalProperties}"
}
