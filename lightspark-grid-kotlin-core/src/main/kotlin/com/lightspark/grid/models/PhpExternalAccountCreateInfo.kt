...
class PhpExternalAccountCreateInfo
...
private constructor(
    ...
    ) : this(accountNumber, accountType, bankName, beneficiary, rail, mutableMapOf())
    ...
    /**
     * Name of the beneficiary's bank. Must be one of the `bankName` values `GET /discoveries`
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PhpExternalAccountCreateInfo].
         *
    ...
    /** A builder for [PhpExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(phpExternalAccountCreateInfo: PhpExternalAccountCreateInfo) = apply {
            accountNumber = phpExternalAccountCreateInfo.accountNumber
            accountType = phpExternalAccountCreateInfo.accountType
            bankName = phpExternalAccountCreateInfo.bankName
            beneficiary = phpExternalAccountCreateInfo.beneficiary
            rail = phpExternalAccountCreateInfo.rail
            additionalProperties = phpExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        fun beneficiary(individual: PhpBeneficiary) =
        ...
        /**
         * Returns an immutable instance of [PhpExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): PhpExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): PhpExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    class Beneficiary
    private constructor(
        private val individual: PhpBeneficiary? = null,
        private val business: Business? = null,
        private val _json: JsonValue? = null,
    ) {

        fun individual(): PhpBeneficiary? = individual
        ...
        fun asIndividual(): PhpBeneficiary = individual.getOrThrow("individual")
         ...
         *     override fun visitIndividual(individual: PhpBeneficiary): String? = individual.toString()
         *
         *     // ...
         *
        ...
        fun validate(): Beneficiary = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitIndividual(individual: PhpBeneficiary) {
                        individual.validate()
                    }
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitIndividual(individual: PhpBeneficiary) = individual.validity()
        ...
        companion object {
            ...
            fun ofIndividual(individual: PhpBeneficiary) = Beneficiary(individual = individual)
        ...
        interface Visitor<out T> {
            ...
            fun visitIndividual(individual: PhpBeneficiary): T
        ...
        internal class Deserializer : BaseDeserializer<Beneficiary>(Beneficiary::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Beneficiary {
                ...
                when (beneficiaryType) {
                    "INDIVIDUAL" -> {
                        return tryDeserialize(node, jacksonTypeRef<PhpBeneficiary>())?.let {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhpExternalAccountCreateInfo &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountNumber, accountType, bankName, beneficiary, rail, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PhpExternalAccountCreateInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, beneficiary=$beneficiary, rail=$rail, additionalProperties=$additionalProperties}"
}
