...
private constructor(
    ...
    @JsonProperty("transaction")
    @ExcludeMissing
    fun _transaction(): JsonField<IncomingTransaction> = transaction
     ...
     *
     * Unlike [requestedReceiverCustomerInfoFields], this method doesn't throw if the JSON field has
     * an unexpected type.
     */
    @JsonProperty("requestedReceiverCustomerInfoFields")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.transaction] with a well-typed [IncomingTransaction]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun transaction(transaction: JsonField<IncomingTransaction>) = apply {
        ...
        ) = requestedReceiverCustomerInfoFields(JsonField.of(requestedReceiverCustomerInfoFields))

        /**
         * Sets [Builder.requestedReceiverCustomerInfoFields] to an arbitrary JSON value.
         *
         * You should usually call [Builder.requestedReceiverCustomerInfoFields] with a well-typed
