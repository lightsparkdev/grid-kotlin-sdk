...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HkdBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(hkdBeneficiary: HkdBeneficiary) = apply {
            beneficiaryType = hkdBeneficiary.beneficiaryType
            fullName = hkdBeneficiary.fullName
            address = hkdBeneficiary.address
            birthDate = hkdBeneficiary.birthDate
            countryOfResidence = hkdBeneficiary.countryOfResidence
            email = hkdBeneficiary.email
            nationality = hkdBeneficiary.nationality
            phoneNumber = hkdBeneficiary.phoneNumber
            registrationNumber = hkdBeneficiary.registrationNumber
            additionalProperties = hkdBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HkdBeneficiary].
         *
    ...
    fun validate(): HkdBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HkdBeneficiary &&
    ...
    override fun toString() =
        "HkdBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, registrationNumber=$registrationNumber, additionalProperties=$additionalProperties}"
}
