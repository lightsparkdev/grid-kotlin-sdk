...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AuthSession].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(authSession: AuthSession) = apply {
            id = authSession.id
            ...
            credentialId = authSession.credentialId
            expiresAt = authSession.expiresAt
            encryptedSessionSigningKey = authSession.encryptedSessionSigningKey
            additionalProperties = authSession.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AuthSession].
         *
     ...
     *   expected type.
     */
    fun validate(): AuthSession = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "AuthSession{id=$id, accountId=$accountId, createdAt=$createdAt, nickname=$nickname, type=$type, updatedAt=$updatedAt, credentialId=$credentialId, expiresAt=$expiresAt, encryptedSessionSigningKey=$encryptedSessionSigningKey, additionalProperties=$additionalProperties}"
}
