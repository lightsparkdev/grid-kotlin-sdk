...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InrBeneficiary].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inrBeneficiary: InrBeneficiary) = apply {
            beneficiaryType = inrBeneficiary.beneficiaryType
            fullName = inrBeneficiary.fullName
            address = inrBeneficiary.address
            birthDate = inrBeneficiary.birthDate
            countryOfResidence = inrBeneficiary.countryOfResidence
            email = inrBeneficiary.email
            nationality = inrBeneficiary.nationality
            phoneNumber = inrBeneficiary.phoneNumber
            registrationNumber = inrBeneficiary.registrationNumber
            additionalProperties = inrBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InrBeneficiary].
         *
    ...
    fun validate(): InrBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InrBeneficiary &&
    ...
    override fun toString() =
        "InrBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, registrationNumber=$registrationNumber, additionalProperties=$additionalProperties}"
}
