...
class AgentActionListResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<AgentAction>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<AgentAction>> = JsonMissing.of(),
     ...
     */
    fun data(): List<AgentAction> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<AgentAction>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentActionListResponse].
         *
    ...
    /** A builder for [AgentActionListResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<AgentAction>>? = null
        private var hasMore: JsonField<Boolean>? = null
        private var nextCursor: JsonField<String> = JsonMissing.of()
        private var totalCount: JsonField<Long> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(agentActionListResponse: AgentActionListResponse) = apply {
            data = agentActionListResponse.data.map { it.toMutableList() }
            hasMore = agentActionListResponse.hasMore
            nextCursor = agentActionListResponse.nextCursor
            totalCount = agentActionListResponse.totalCount
            additionalProperties = agentActionListResponse.additionalProperties.toMutableMap()
        }

        /** List of agent actions matching the filter criteria. */
        fun data(data: List<AgentAction>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<AgentAction>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<AgentAction>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [AgentAction] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: AgentAction) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [AgentActionListResponse].
         *
         ...
         */
        fun build(): AgentActionListResponse =
     ...
     *   expected type.
     */
    fun validate(): AgentActionListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentActionListResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "AgentActionListResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
