 ...
 */
class CardStateReason @JsonCreator private constructor(private val value: JsonField<String>) :
    Enum {
    ...
    companion object {
        ...
        fun of(value: String) = CardStateReason(JsonField.of(value))
    }

    /** An enum containing [CardStateReason]'s known values. */
    enum class Known {
        ISSUER_REJECTED,
        CLOSED_BY_PLATFORM,
        CLOSED_BY_GRID,
    ...
    /**
     * An enum containing [CardStateReason]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [CardStateReason] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        CLOSED_BY_GRID,
        /**
         * An enum member indicating that [CardStateReason] was instantiated with an unknown value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw LightsparkGridInvalidDataException("Unknown CardStateReason: $value")
        }
     ...
     *   expected type.
     */
    fun validate(): CardStateReason = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CardStateReason && value == other.value
    }
