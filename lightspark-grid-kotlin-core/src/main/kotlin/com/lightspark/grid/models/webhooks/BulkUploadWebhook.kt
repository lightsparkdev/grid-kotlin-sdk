...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = bulkUploadWebhook.type().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BulkUploadWebhook].
         *
    ...
    /** A builder for [BulkUploadWebhook]. */
    class Builder internal constructor() {
        ...
        internal fun from(bulkUploadWebhook: BulkUploadWebhook) = apply {
            id = bulkUploadWebhook.id
            timestamp = bulkUploadWebhook.timestamp
            type = bulkUploadWebhook.type
            data = bulkUploadWebhook.data
            additionalProperties = bulkUploadWebhook.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BulkUploadWebhook].
         *
     ...
     *   expected type.
     */
    fun validate(): BulkUploadWebhook = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BulkUploadWebhook &&
            id == other.id &&
    ...
    override fun toString() =
        "BulkUploadWebhook{id=$id, timestamp=$timestamp, type=$type, data=$data, additionalProperties=$additionalProperties}"
}
