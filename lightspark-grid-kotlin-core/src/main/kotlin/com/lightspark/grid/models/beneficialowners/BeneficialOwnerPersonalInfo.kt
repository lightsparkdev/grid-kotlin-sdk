...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BeneficialOwnerPersonalInfo].
         *
    ...
    /** A builder for [BeneficialOwnerPersonalInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(beneficialOwnerPersonalInfo: BeneficialOwnerPersonalInfo) = apply {
            address = beneficialOwnerPersonalInfo.address
            birthDate = beneficialOwnerPersonalInfo.birthDate
            firstName = beneficialOwnerPersonalInfo.firstName
            identifier = beneficialOwnerPersonalInfo.identifier
            idType = beneficialOwnerPersonalInfo.idType
            lastName = beneficialOwnerPersonalInfo.lastName
        ...
        /**
         * Returns an immutable instance of [BeneficialOwnerPersonalInfo].
         *
         ...
         */
        fun build(): BeneficialOwnerPersonalInfo =
    ...
    fun validate(): BeneficialOwnerPersonalInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BeneficialOwnerPersonalInfo &&
