...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IdrAccountInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(idrAccountInfo: IdrAccountInfo) = apply {
            accountNumber = idrAccountInfo.accountNumber
            accountType = idrAccountInfo.accountType
            bankName = idrAccountInfo.bankName
            paymentRails = idrAccountInfo.paymentRails.map { it.toMutableList() }
            phoneNumber = idrAccountInfo.phoneNumber
            swiftCode = idrAccountInfo.swiftCode
            additionalProperties = idrAccountInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IdrAccountInfo].
         *
    ...
    fun validate(): IdrAccountInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IdrAccountInfo &&
    ...
    override fun toString() =
        "IdrAccountInfo{accountNumber=$accountNumber, accountType=$accountType, bankName=$bankName, paymentRails=$paymentRails, phoneNumber=$phoneNumber, swiftCode=$swiftCode, additionalProperties=$additionalProperties}"
}
