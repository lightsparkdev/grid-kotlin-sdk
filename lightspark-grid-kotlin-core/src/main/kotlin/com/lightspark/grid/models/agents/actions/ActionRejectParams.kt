...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(actionRejectParams: ActionRejectParams) = apply {
            ...
            body = actionRejectParams.body.toBuilder()
    ...
    override fun toString() =
        "ActionRejectParams{agentId=$agentId, actionId=$actionId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
