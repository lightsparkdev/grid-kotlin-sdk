...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ActionRejectParams].
         *
    ...
    /** A builder for [ActionRejectParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(actionRejectParams: ActionRejectParams) = apply {
            agentId = actionRejectParams.agentId
            actionId = actionRejectParams.actionId
            agentActionRejectRequest = actionRejectParams.agentActionRejectRequest
            additionalHeaders = actionRejectParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionRejectParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionRejectParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionRejectParams &&
    ...
    override fun toString() =
        "ActionRejectParams{agentId=$agentId, actionId=$actionId, agentActionRejectRequest=$agentActionRejectRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
