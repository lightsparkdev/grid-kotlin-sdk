...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun paymentRails(): List<MwkAccountInfo.PaymentRail> = paymentRails.getRequired("paymentRails")
    ...
    class Builder internal constructor() {
         ...
         * [MwkAccountInfo.AccountType] value instead. This method is primarily for setting the
         ...
         * `List<MwkAccountInfo.PaymentRail>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun paymentRails(paymentRails: JsonField<List<MwkAccountInfo.PaymentRail>>) = apply {
    ...
    override fun toString() =
        "MwkExternalAccountInfo{accountType=$accountType, paymentRails=$paymentRails, phoneNumber=$phoneNumber, provider=$provider, beneficiary=$beneficiary, additionalProperties=$additionalProperties}"
}
