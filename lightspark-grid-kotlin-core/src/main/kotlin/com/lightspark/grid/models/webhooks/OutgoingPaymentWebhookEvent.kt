    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                fees = data.fees
                paymentInstructions = data.paymentInstructions.map { it.toMutableList() }
            ...
            fun destination(
                ...
                destination(
                    Destination.ofExternalAccountDetailsTransaction(
                        externalAccountDetailsTransaction
                    )
                )
             ...
             * [OutgoingTransactionStatus] value instead. This method is primarily for setting the
             * field to an undocumented or not yet supported value.
             */
            fun status(status: JsonField<OutgoingTransactionStatus>) = apply {
                this.status = status
            }
        ...
        private constructor(
             ...
             * creation rather than using a pre-registered external account.
             */
            fun asExternalAccountDetailsTransaction():
                ExternalAccountDetailsTransactionDestination =
            ...
            fun <T> accept(visitor: Visitor<T>): T =
                when {
                    accountTransaction != null ->
                        visitor.visitAccountTransaction(accountTransaction)
            ...
            companion object {
                ...
                fun ofExternalAccountDetailsTransaction(
                    ...
                    Destination(
                        externalAccountDetailsTransaction = externalAccountDetailsTransaction
                    )
            }
            ...
            interface Visitor<out T> {
                 ...
                 *
                 * An instance of [Destination] can contain an unknown variant if it was
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Destination {
                    ...
                    val bestMatches =
                        sequenceOf(
                                tryDeserialize(
                                        node,
                                        jacksonTypeRef<AccountTransactionDestination>(),
                                    )
                                    ?.let { Destination(accountTransaction = it, _json = json) },
                                tryDeserialize(
                                        node,
                                        jacksonTypeRef<UmaAddressTransactionDestination>(),
                                    )
            ...
            private constructor(
                 ...
                 *
                 * Unlike [umaAddress], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("umaAddress")
                @ExcludeMissing
            ...
            private constructor(
                 ...
                 *
                 * Unlike [externalAccountDetails], this method doesn't throw if the JSON field has
                 * an unexpected type.
                 */
                @JsonProperty("externalAccountDetails")
                @ExcludeMissing
                fun _externalAccountDetails(): JsonField<ExternalAccountCreate> =
                ...
                class Builder internal constructor() {
                    ...
                    private var destinationType: JsonValue =
                        JsonValue.from("EXTERNAL_ACCOUNT_DETAILS")
                    ...
                    internal fun from(
                        ...
                        destinationType =
                            externalAccountDetailsTransactionDestination.destinationType
                        externalAccountDetails =
                     ...
                     * [ExternalAccountCreate] value instead. This method is primarily for setting
