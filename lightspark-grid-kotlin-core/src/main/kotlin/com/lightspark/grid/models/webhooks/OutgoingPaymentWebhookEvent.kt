...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        transaction: JsonField<OutgoingTransaction> = JsonMissing.of(),
    ...
    @JsonProperty("transaction")
    @ExcludeMissing
    fun _transaction(): JsonField<OutgoingTransaction> = transaction
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.transaction] with a well-typed [OutgoingTransaction]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun transaction(transaction: JsonField<OutgoingTransaction>) = apply {
