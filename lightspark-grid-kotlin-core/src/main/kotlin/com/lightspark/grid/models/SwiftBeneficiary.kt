...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SwiftBeneficiary].
         *
    ...
    /** A builder for [SwiftBeneficiary]. */
    class Builder internal constructor() {
        ...
        internal fun from(swiftBeneficiary: SwiftBeneficiary) = apply {
            beneficiaryType = swiftBeneficiary.beneficiaryType
            fullName = swiftBeneficiary.fullName
            address = swiftBeneficiary.address
            birthDate = swiftBeneficiary.birthDate
            countryOfResidence = swiftBeneficiary.countryOfResidence
            email = swiftBeneficiary.email
            nationality = swiftBeneficiary.nationality
            phoneNumber = swiftBeneficiary.phoneNumber
            additionalProperties = swiftBeneficiary.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SwiftBeneficiary].
         *
     ...
     *   expected type.
     */
    fun validate(): SwiftBeneficiary = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SwiftBeneficiary &&
    ...
    override fun toString() =
        "SwiftBeneficiary{beneficiaryType=$beneficiaryType, fullName=$fullName, address=$address, birthDate=$birthDate, countryOfResidence=$countryOfResidence, email=$email, nationality=$nationality, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
}
