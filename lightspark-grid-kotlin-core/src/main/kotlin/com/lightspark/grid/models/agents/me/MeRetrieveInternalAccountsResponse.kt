...
class MeRetrieveInternalAccountsResponse
...
private constructor(
    ...
    /** A builder for [MeRetrieveInternalAccountsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(meRetrieveInternalAccountsResponse: MeRetrieveInternalAccountsResponse) =
            apply {
                data = meRetrieveInternalAccountsResponse.data.map { it.toMutableList() }
                hasMore = meRetrieveInternalAccountsResponse.hasMore
                nextCursor = meRetrieveInternalAccountsResponse.nextCursor
                totalCount = meRetrieveInternalAccountsResponse.totalCount
                additionalProperties =
                    meRetrieveInternalAccountsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [MeRetrieveInternalAccountsResponse].
         *
         ...
         */
        fun build(): MeRetrieveInternalAccountsResponse =
            MeRetrieveInternalAccountsResponse(
     ...
     *   expected type.
     */
    fun validate(): MeRetrieveInternalAccountsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MeRetrieveInternalAccountsResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "MeRetrieveInternalAccountsResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
