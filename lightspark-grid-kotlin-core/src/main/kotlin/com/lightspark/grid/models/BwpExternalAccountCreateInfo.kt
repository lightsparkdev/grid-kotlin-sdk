...
class BwpExternalAccountCreateInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BwpExternalAccountCreateInfo].
         *
    ...
    /** A builder for [BwpExternalAccountCreateInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(bwpExternalAccountCreateInfo: BwpExternalAccountCreateInfo) = apply {
            accountType = bwpExternalAccountCreateInfo.accountType
            beneficiary = bwpExternalAccountCreateInfo.beneficiary
            phoneNumber = bwpExternalAccountCreateInfo.phoneNumber
            provider = bwpExternalAccountCreateInfo.provider
            additionalProperties = bwpExternalAccountCreateInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BwpExternalAccountCreateInfo].
         *
         ...
         */
        fun build(): BwpExternalAccountCreateInfo =
     ...
     *   expected type.
     */
    fun validate(): BwpExternalAccountCreateInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BwpExternalAccountCreateInfo &&
    ...
    override fun toString() =
        "BwpExternalAccountCreateInfo{accountType=$accountType, beneficiary=$beneficiary, phoneNumber=$phoneNumber, provider=$provider, additionalProperties=$additionalProperties}"
}
