...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.lightspark.grid.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.lightspark.grid.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.lightspark.grid.** {
    <init>(...);
