...
internal class BeneficialOwnerListResponseTest {
    ...
    fun create() {
                    ...
                    BeneficialOwnerListResponse.PersonalInfo.builder()
                        ...
                        .personalIds(
                            BeneficialOwnerListResponse.PersonalInfo.PersonalIds.builder()
                                ...
                                .idType(
                                    BeneficialOwnerListResponse.PersonalInfo.PersonalIds.IdType.SSN
                                )
            ...
            .isEqualTo(
                BeneficialOwnerListResponse.PersonalInfo.builder()
                    ...
                    .personalIds(
                        BeneficialOwnerListResponse.PersonalInfo.PersonalIds.builder()
                            .identifier("123-45-6789")
                            .idType(BeneficialOwnerListResponse.PersonalInfo.PersonalIds.IdType.SSN)
                            .countryOfIssuance("US")
                            .build()
                    )
                    .email("jane.smith@acmecorp.com")
        ...
        assertThat(beneficialOwnerListResponse.ownershipPercentage()).isEqualTo(51.0f)
