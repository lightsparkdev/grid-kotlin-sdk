...
internal class AgentListResponseTest {
    ...
    fun create() {
        ...
        assertThat(agentListResponse.hasMore()).isEqualTo(true)
        assertThat(agentListResponse.nextCursor()).isEqualTo("nextCursor")
        assertThat(agentListResponse.totalCount()).isEqualTo(0L)
    }
