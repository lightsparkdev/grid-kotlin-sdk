    ...
    fun create() {
        val actionRetrieveResponse =
            ActionRetrieveResponse.builder()
                ...
                .status(ActionRetrieveResponse.Status.PENDING_APPROVAL)
                .type(ActionRetrieveResponse.Type.EXECUTE_QUOTE)
                ...
                .transferDetails(
                    ActionRetrieveResponse.TransferDetails.builder()
                        .amount(50000L)
                        .currency("USD")
        ...
        assertThat(actionRetrieveResponse.id())
            .isEqualTo("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
        assertThat(actionRetrieveResponse.agentId())
            .isEqualTo("Agent:019542f5-b3e7-1d02-0000-000000000042")
        assertThat(actionRetrieveResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:00:00Z"))
        assertThat(actionRetrieveResponse.customerId())
            .isEqualTo("Customer:019542f5-b3e7-1d02-0000-000000000010")
        assertThat(actionRetrieveResponse.platformCustomerId()).isEqualTo("user-a1b2c3")
        assertThat(actionRetrieveResponse.status())
            .isEqualTo(ActionRetrieveResponse.Status.PENDING_APPROVAL)
        assertThat(actionRetrieveResponse.type())
            .isEqualTo(ActionRetrieveResponse.Type.EXECUTE_QUOTE)
        assertThat(actionRetrieveResponse.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:02:00Z"))
        assertThat(actionRetrieveResponse.quote())
            .isEqualTo(
                Quote.builder()
                    .id("Quote:019542f5-b3e7-1d02-0000-000000000006")
                    .createdAt(OffsetDateTime.parse("2025-10-03T12:00:00Z"))
        ...
        assertThat(actionRetrieveResponse.rejectionReason())
            .isEqualTo("Transaction amount exceeds customer's current risk limit.")
        assertThat(actionRetrieveResponse.transaction())
            .isEqualTo(
        ...
        assertThat(actionRetrieveResponse.transferDetails())
            .isEqualTo(
                ActionRetrieveResponse.TransferDetails.builder()
                    .amount(50000L)
                    .currency("USD")
