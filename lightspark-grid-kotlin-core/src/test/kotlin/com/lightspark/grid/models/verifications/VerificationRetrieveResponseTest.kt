    ...
    fun create() {
        val verificationRetrieveResponse =
            VerificationRetrieveResponse.builder()
                ...
                .addError(
                    VerificationRetrieveResponse.Error.builder()
                        .reason("Business address line 1 is required")
                        .resourceId("Customer:019542f5-b3e7-1d02-0000-000000000001")
                        .type(VerificationRetrieveResponse.Error.Type.MISSING_FIELD)
                        .addAcceptedDocumentType(
                            VerificationRetrieveResponse.Error.AcceptedDocumentType.PASSPORT
                        )
