...
internal class AgentActionWebhookTest {
    ...
    fun create() {
        ...
        assertThat(agentActionWebhook.id())
            .isEqualTo("Webhook:019542f5-b3e7-1d02-0000-000000000007")
        assertThat(agentActionWebhook.timestamp())
            .isEqualTo(OffsetDateTime.parse("2025-08-15T14:32:00Z"))
        assertThat(agentActionWebhook._type())
            .isEqualTo(JsonValue.from("AGENT_ACTION.PENDING_APPROVAL"))
        assertThat(agentActionWebhook.data())
            .isEqualTo(
                AgentAction.builder()
                    .id("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
                    .agentId("Agent:019542f5-b3e7-1d02-0000-000000000042")
    ...
    fun roundtrip() {
        ...
        val roundtrippedAgentActionWebhook =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(agentActionWebhook),
                jacksonTypeRef<AgentActionWebhook>(),
            )

        assertThat(roundtrippedAgentActionWebhook).isEqualTo(agentActionWebhook)
    }
}
