...
internal class PasskeyCredentialCreateRequestFieldsTest {

    @Test
    fun create() {
        val passkeyCredentialCreateRequestFields =
        ...
        assertThat(passkeyCredentialCreateRequestFields.attestation())
            .isEqualTo(
                PasskeyAttestation.builder()
                    .attestationObject(
                        "o2NmbXRkbm9uZWdhdHRTdG10oGhhdXRoRGF0YVjFPdxHEOnAiLIp26idVjIguzn3Ipr_RlsKZWsa-5qK-KBFAAAAAAAAAAAAAAAAAAAAAAAAAAAAQQHSlyRHIdWleVqO24-6ix7JFWODqDWo_arvEz3Se5EgIFHkcVjZ4F5XDSBreIHsWRilRnKmaaqlqK3V2_4XtYs2pQECAyYgASFYID5PQTZQQg6haZFQWFzqfAOyQ_ENsMH8xxQ4GRiNPsqrIlggU8IVUOV8qpgk_Jh-OTaLuZL52KdX1fTht07X4DiQPow"
        ...
        assertThat(passkeyCredentialCreateRequestFields.challenge())
            .isEqualTo("ArkQi2yAYHPlgnJNFBlneIwchQdWXBOTrdB-AmMUB21Lx")
        assertThat(passkeyCredentialCreateRequestFields.nickname()).isEqualTo("iPhone Face-ID")
        assertThat(passkeyCredentialCreateRequestFields.type())
    ...
    fun roundtrip() {
        ...
        val roundtrippedPasskeyCredentialCreateRequestFields =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(passkeyCredentialCreateRequestFields),
                jacksonTypeRef<PasskeyCredentialCreateRequestFields>(),
            )

        assertThat(roundtrippedPasskeyCredentialCreateRequestFields)
            .isEqualTo(passkeyCredentialCreateRequestFields)
    }
}
