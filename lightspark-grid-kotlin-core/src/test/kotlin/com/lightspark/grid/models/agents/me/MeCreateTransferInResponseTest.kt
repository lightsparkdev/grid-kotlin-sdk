...
internal class MeCreateTransferInResponseTest {

    @Test
    fun create() {
        val meCreateTransferInResponse =
            MeCreateTransferInResponse.builder()
                ...
                .status(MeCreateTransferInResponse.Status.PENDING_APPROVAL)
                .type(MeCreateTransferInResponse.Type.EXECUTE_QUOTE)
                ...
                .transferDetails(
                    MeCreateTransferInResponse.TransferDetails.builder()
                        .amount(50000L)
                        .currency("USD")
        ...
        assertThat(meCreateTransferInResponse.id())
            .isEqualTo("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
        assertThat(meCreateTransferInResponse.agentId())
            .isEqualTo("Agent:019542f5-b3e7-1d02-0000-000000000042")
        assertThat(meCreateTransferInResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:00:00Z"))
        assertThat(meCreateTransferInResponse.customerId())
            .isEqualTo("Customer:019542f5-b3e7-1d02-0000-000000000010")
        assertThat(meCreateTransferInResponse.platformCustomerId()).isEqualTo("user-a1b2c3")
        assertThat(meCreateTransferInResponse.status())
            .isEqualTo(MeCreateTransferInResponse.Status.PENDING_APPROVAL)
        assertThat(meCreateTransferInResponse.type())
            .isEqualTo(MeCreateTransferInResponse.Type.EXECUTE_QUOTE)
        assertThat(meCreateTransferInResponse.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:02:00Z"))
        assertThat(meCreateTransferInResponse.quote())
            .isEqualTo(
                Quote.builder()
                    .id("Quote:019542f5-b3e7-1d02-0000-000000000006")
                    .createdAt(OffsetDateTime.parse("2025-10-03T12:00:00Z"))
        ...
        assertThat(meCreateTransferInResponse.rejectionReason())
            .isEqualTo("Transaction amount exceeds customer's current risk limit.")
        assertThat(meCreateTransferInResponse.transaction())
            .isEqualTo(
        ...
        assertThat(meCreateTransferInResponse.transferDetails())
            .isEqualTo(
                MeCreateTransferInResponse.TransferDetails.builder()
                    .amount(50000L)
                    .currency("USD")
    ...
    fun roundtrip() {
        ...
        val roundtrippedMeCreateTransferInResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(meCreateTransferInResponse),
                jacksonTypeRef<MeCreateTransferInResponse>(),
            )

        assertThat(roundtrippedMeCreateTransferInResponse).isEqualTo(meCreateTransferInResponse)
    }
}
