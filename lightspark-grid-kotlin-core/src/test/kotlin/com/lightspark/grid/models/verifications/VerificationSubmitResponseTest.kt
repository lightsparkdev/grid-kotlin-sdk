    ...
    fun create() {
        val verificationSubmitResponse =
            VerificationSubmitResponse.builder()
                ...
                .addError(
                    VerificationSubmitResponse.Error.builder()
                        .reason("Business address line 1 is required")
                        .resourceId("Customer:019542f5-b3e7-1d02-0000-000000000001")
                        .type(VerificationSubmitResponse.Error.Type.MISSING_FIELD)
                        .addAcceptedDocumentType(
                            VerificationSubmitResponse.Error.AcceptedDocumentType.PASSPORT
                        )
