...
internal class CustomerCreateResponseTest {
    ...
    fun ofIndividual() {
        ...
        val customerCreateResponse = CustomerCreateResponse.ofIndividual(individual)

        assertThat(customerCreateResponse.individual()).isEqualTo(individual)
        assertThat(customerCreateResponse.business()).isNull()
    }
    ...
    fun ofBusiness() {
        ...
        val customerCreateResponse = CustomerCreateResponse.ofBusiness(business)

        assertThat(customerCreateResponse.individual()).isNull()
        assertThat(customerCreateResponse.business()).isEqualTo(business)
    }
    ...
    fun ofBusinessRoundtrip() {
        val jsonMapper = jsonMapper()
        val customerCreateResponse =
            CustomerCreateResponse.ofBusiness(
                BusinessCustomer.builder()
                    .customerType(BusinessCustomer.CustomerType.BUSINESS)
                    .platformCustomerId("9f84e0c2a72c4fa")
                    .umaAddress("\$john.doe@uma.domain.com")
    ...
    fun incompatibleJsonShapeDeserializesToUnknown(testCase: IncompatibleJsonShapeTestCase) {
        ...
        val e =
            assertThrows<LightsparkGridInvalidDataException> { customerCreateResponse.validate() }
