...
internal class ActionListPageResponseTest {
    ...
    fun create() {
        ...
        assertThat(actionListPageResponse.data())
            .containsExactly(
                ActionListResponse.builder()
                    .id("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
                    .agentId("Agent:019542f5-b3e7-1d02-0000-000000000042")
        ...
        assertThat(actionListPageResponse.hasMore()).isEqualTo(true)
        assertThat(actionListPageResponse.nextCursor()).isEqualTo("nextCursor")
        assertThat(actionListPageResponse.totalCount()).isEqualTo(0L)
    }
