...
internal class MeCreateTransferOutResponseTest {

    @Test
    fun create() {
        val meCreateTransferOutResponse =
            MeCreateTransferOutResponse.builder()
                ...
                .status(MeCreateTransferOutResponse.Status.PENDING_APPROVAL)
                .type(MeCreateTransferOutResponse.Type.EXECUTE_QUOTE)
        ...
        assertThat(meCreateTransferOutResponse.id())
            .isEqualTo("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
        assertThat(meCreateTransferOutResponse.agentId())
            .isEqualTo("Agent:019542f5-b3e7-1d02-0000-000000000042")
        assertThat(meCreateTransferOutResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:00:00Z"))
        assertThat(meCreateTransferOutResponse.customerId())
            .isEqualTo("Customer:019542f5-b3e7-1d02-0000-000000000010")
        assertThat(meCreateTransferOutResponse.platformCustomerId()).isEqualTo("user-a1b2c3")
        assertThat(meCreateTransferOutResponse.status())
            .isEqualTo(MeCreateTransferOutResponse.Status.PENDING_APPROVAL)
        assertThat(meCreateTransferOutResponse.type())
            .isEqualTo(MeCreateTransferOutResponse.Type.EXECUTE_QUOTE)
        assertThat(meCreateTransferOutResponse.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:02:00Z"))
        assertThat(meCreateTransferOutResponse.quote())
            .isEqualTo(
                Quote.builder()
                    .id("Quote:019542f5-b3e7-1d02-0000-000000000006")
                    .createdAt(OffsetDateTime.parse("2025-10-03T12:00:00Z"))
        ...
        assertThat(meCreateTransferOutResponse.rejectionReason())
            .isEqualTo("Transaction amount exceeds customer's current risk limit.")
        assertThat(meCreateTransferOutResponse.transaction())
            .isEqualTo(
    ...
    fun roundtrip() {
        ...
        val roundtrippedMeCreateTransferOutResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(meCreateTransferOutResponse),
                jacksonTypeRef<MeCreateTransferOutResponse>(),
            )

        assertThat(roundtrippedMeCreateTransferOutResponse).isEqualTo(meCreateTransferOutResponse)
    }
}
