...
internal class MeListInternalAccountsPageResponseTest {

    @Test
    fun create() {
        val meListInternalAccountsPageResponse =
            MeListInternalAccountsPageResponse.builder()
                .addData(
        ...
        assertThat(meListInternalAccountsPageResponse.data())
            .containsExactly(
                InternalAccount.builder()
                    .id("InternalAccount:12dcbd6-dced-4ec4-b756-3c3a9ea3d123")
                    .balance(
        ...
        assertThat(meListInternalAccountsPageResponse.hasMore()).isEqualTo(true)
        assertThat(meListInternalAccountsPageResponse.nextCursor()).isEqualTo("nextCursor")
        assertThat(meListInternalAccountsPageResponse.totalCount()).isEqualTo(0L)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedMeListInternalAccountsPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(meListInternalAccountsPageResponse),
                jacksonTypeRef<MeListInternalAccountsPageResponse>(),
            )

        assertThat(roundtrippedMeListInternalAccountsPageResponse)
            .isEqualTo(meListInternalAccountsPageResponse)
    }
}
