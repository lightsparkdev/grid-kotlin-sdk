...
internal class CustomerListResponseTest {
    ...
    fun ofIndividual() {
        ...
        val customerListResponse = CustomerListResponse.ofIndividual(individual)

        assertThat(customerListResponse.individual()).isEqualTo(individual)
        assertThat(customerListResponse.business()).isNull()
    }
    ...
    fun ofBusiness() {
        ...
        val customerListResponse = CustomerListResponse.ofBusiness(business)

        assertThat(customerListResponse.individual()).isNull()
        assertThat(customerListResponse.business()).isEqualTo(business)
    }
    ...
    fun ofBusinessRoundtrip() {
        val jsonMapper = jsonMapper()
        val customerListResponse =
            CustomerListResponse.ofBusiness(
                BusinessCustomer.builder()
                    .customerType(BusinessCustomer.CustomerType.BUSINESS)
                    .platformCustomerId("9f84e0c2a72c4fa")
                    .umaAddress("\$john.doe@uma.domain.com")
    ...
    fun incompatibleJsonShapeDeserializesToUnknown(testCase: IncompatibleJsonShapeTestCase) {
        ...
        val e = assertThrows<LightsparkGridInvalidDataException> { customerListResponse.validate() }
