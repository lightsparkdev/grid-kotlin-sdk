...
internal class TransactionRejectResponseTest {

    @Test
    fun create() {
        val transactionRejectResponse =
            TransactionRejectResponse.builder()
                ...
                .status(TransactionRejectResponse.Status.PENDING_APPROVAL)
                .type(TransactionRejectResponse.Type.EXECUTE_QUOTE)
                ...
                .transferDetails(
                    TransactionRejectResponse.TransferDetails.builder()
                        .amount(50000L)
                        .currency("USD")
        ...
        assertThat(transactionRejectResponse.id())
            .isEqualTo("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
        assertThat(transactionRejectResponse.agentId())
            .isEqualTo("Agent:019542f5-b3e7-1d02-0000-000000000042")
        assertThat(transactionRejectResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:00:00Z"))
        assertThat(transactionRejectResponse.customerId())
            .isEqualTo("Customer:019542f5-b3e7-1d02-0000-000000000010")
        assertThat(transactionRejectResponse.platformCustomerId()).isEqualTo("user-a1b2c3")
        assertThat(transactionRejectResponse.status())
            .isEqualTo(TransactionRejectResponse.Status.PENDING_APPROVAL)
        assertThat(transactionRejectResponse.type())
            .isEqualTo(TransactionRejectResponse.Type.EXECUTE_QUOTE)
        assertThat(transactionRejectResponse.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:02:00Z"))
        assertThat(transactionRejectResponse.quote())
            .isEqualTo(
                Quote.builder()
                    .id("Quote:019542f5-b3e7-1d02-0000-000000000006")
                    .createdAt(OffsetDateTime.parse("2025-10-03T12:00:00Z"))
        ...
        assertThat(transactionRejectResponse.rejectionReason())
            .isEqualTo("Transaction amount exceeds customer's current risk limit.")
        assertThat(transactionRejectResponse.transaction())
            .isEqualTo(
        ...
        assertThat(transactionRejectResponse.transferDetails())
            .isEqualTo(
                TransactionRejectResponse.TransferDetails.builder()
                    .amount(50000L)
                    .currency("USD")
    ...
    fun roundtrip() {
        ...
        val roundtrippedTransactionRejectResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(transactionRejectResponse),
                jacksonTypeRef<TransactionRejectResponse>(),
            )

        assertThat(roundtrippedTransactionRejectResponse).isEqualTo(transactionRejectResponse)
    }
}
