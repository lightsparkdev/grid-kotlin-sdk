    ...
    fun ofCadAccount() {
        val cadAccount =
            ExternalAccountInfoOneOf.CadAccount.builder()
                ...
                .branchCode("00012")
                .addCountry(ExternalAccountInfoOneOf.CadAccount.Country.CA)
    ...
    fun ofKesAccount() {
        val kesAccount =
            ExternalAccountInfoOneOf.KesAccount.builder()
                ...
                .addCountry(ExternalAccountInfoOneOf.KesAccount.Country.KE)
                .addPaymentRail(ExternalAccountInfoOneOf.KesAccount.PaymentRail.MOBILE_MONEY)
                .phoneNumber("+254712345678")
                .provider(ExternalAccountInfoOneOf.KesAccount.Provider.M_PESA)
                .build()
    ...
    fun ofNgnAccount() {
        val ngnAccount =
            ExternalAccountInfoOneOf.NgnAccount.builder()
                ...
                .addCountry(ExternalAccountInfoOneOf.NgnAccount.Country.NG)
    ...
    fun ofRwfAccount() {
        val rwfAccount =
            ExternalAccountInfoOneOf.RwfAccount.builder()
                ...
                .addCountry(ExternalAccountInfoOneOf.RwfAccount.Country.RW)
                .addPaymentRail(ExternalAccountInfoOneOf.RwfAccount.PaymentRail.MOBILE_MONEY)
                .phoneNumber("+250781234567")
                .provider(ExternalAccountInfoOneOf.RwfAccount.Provider.MTN)
                .build()
    ...
    fun ofTzsAccount() {
        val tzsAccount =
            ExternalAccountInfoOneOf.TzsAccount.builder()
                ...
                .addCountry(ExternalAccountInfoOneOf.TzsAccount.Country.TZ)
                .addPaymentRail(ExternalAccountInfoOneOf.TzsAccount.PaymentRail.MOBILE_MONEY)
                .phoneNumber("+255712345678")
                .provider(ExternalAccountInfoOneOf.TzsAccount.Provider.AIRTEL)
                .build()
    ...
    fun ofZarAccount() {
        val zarAccount =
            ExternalAccountInfoOneOf.ZarAccount.builder()
                ...
                .addCountry(ExternalAccountInfoOneOf.ZarAccount.Country.ZA)
    ...
    fun ofZmwAccount() {
        val zmwAccount =
            ExternalAccountInfoOneOf.ZmwAccount.builder()
                ...
                .addCountry(ExternalAccountInfoOneOf.ZmwAccount.Country.ZM)
                .addPaymentRail(ExternalAccountInfoOneOf.ZmwAccount.PaymentRail.MOBILE_MONEY)
                .phoneNumber("+260971234567")
                .provider(ExternalAccountInfoOneOf.ZmwAccount.Provider.TNM)
                .build()
