...
internal class QuoteExecuteResponseTest {

    @Test
    fun create() {
        val quoteExecuteResponse =
            QuoteExecuteResponse.builder()
                ...
                .status(QuoteExecuteResponse.Status.PENDING_APPROVAL)
                .type(QuoteExecuteResponse.Type.EXECUTE_QUOTE)
                ...
                .transferDetails(
                    QuoteExecuteResponse.TransferDetails.builder()
                        .amount(50000L)
                        .currency("USD")
        ...
        assertThat(quoteExecuteResponse.id())
            .isEqualTo("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
        assertThat(quoteExecuteResponse.agentId())
            .isEqualTo("Agent:019542f5-b3e7-1d02-0000-000000000042")
        assertThat(quoteExecuteResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:00:00Z"))
        assertThat(quoteExecuteResponse.customerId())
            .isEqualTo("Customer:019542f5-b3e7-1d02-0000-000000000010")
        assertThat(quoteExecuteResponse.platformCustomerId()).isEqualTo("user-a1b2c3")
        assertThat(quoteExecuteResponse.status())
            .isEqualTo(QuoteExecuteResponse.Status.PENDING_APPROVAL)
        assertThat(quoteExecuteResponse.type()).isEqualTo(QuoteExecuteResponse.Type.EXECUTE_QUOTE)
        assertThat(quoteExecuteResponse.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:02:00Z"))
        assertThat(quoteExecuteResponse.quote())
            .isEqualTo(
                Quote.builder()
                    .id("Quote:019542f5-b3e7-1d02-0000-000000000006")
                    .createdAt(OffsetDateTime.parse("2025-10-03T12:00:00Z"))
        ...
        assertThat(quoteExecuteResponse.rejectionReason())
            .isEqualTo("Transaction amount exceeds customer's current risk limit.")
        assertThat(quoteExecuteResponse.transaction())
            .isEqualTo(
        ...
        assertThat(quoteExecuteResponse.transferDetails())
            .isEqualTo(
                QuoteExecuteResponse.TransferDetails.builder()
                    .amount(50000L)
                    .currency("USD")
    ...
    fun roundtrip() {
        ...
        val roundtrippedQuoteExecuteResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(quoteExecuteResponse),
                jacksonTypeRef<QuoteExecuteResponse>(),
            )

        assertThat(roundtrippedQuoteExecuteResponse).isEqualTo(quoteExecuteResponse)
    }
}
