...
internal class MeTransferInResponseTest {

    @Test
    fun create() {
        val meTransferInResponse =
            MeTransferInResponse.builder()
                ...
                .status(MeTransferInResponse.Status.PENDING_APPROVAL)
                .type(MeTransferInResponse.Type.EXECUTE_QUOTE)
                ...
                .transferDetails(
                    MeTransferInResponse.TransferDetails.builder()
                        .amount(50000L)
                        .currency("USD")
        ...
        assertThat(meTransferInResponse.id())
            .isEqualTo("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
        assertThat(meTransferInResponse.agentId())
            .isEqualTo("Agent:019542f5-b3e7-1d02-0000-000000000042")
        assertThat(meTransferInResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:00:00Z"))
        assertThat(meTransferInResponse.customerId())
            .isEqualTo("Customer:019542f5-b3e7-1d02-0000-000000000010")
        assertThat(meTransferInResponse.platformCustomerId()).isEqualTo("user-a1b2c3")
        assertThat(meTransferInResponse.status())
            .isEqualTo(MeTransferInResponse.Status.PENDING_APPROVAL)
        assertThat(meTransferInResponse.type()).isEqualTo(MeTransferInResponse.Type.EXECUTE_QUOTE)
        assertThat(meTransferInResponse.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:02:00Z"))
        assertThat(meTransferInResponse.quote())
            .isEqualTo(
                Quote.builder()
                    .id("Quote:019542f5-b3e7-1d02-0000-000000000006")
                    .createdAt(OffsetDateTime.parse("2025-10-03T12:00:00Z"))
        ...
        assertThat(meTransferInResponse.rejectionReason())
            .isEqualTo("Transaction amount exceeds customer's current risk limit.")
        assertThat(meTransferInResponse.transaction())
            .isEqualTo(
        ...
        assertThat(meTransferInResponse.transferDetails())
            .isEqualTo(
                MeTransferInResponse.TransferDetails.builder()
                    .amount(50000L)
                    .currency("USD")
    ...
    fun roundtrip() {
        ...
        val roundtrippedMeTransferInResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(meTransferInResponse),
                jacksonTypeRef<MeTransferInResponse>(),
            )

        assertThat(roundtrippedMeTransferInResponse).isEqualTo(meTransferInResponse)
    }
}
