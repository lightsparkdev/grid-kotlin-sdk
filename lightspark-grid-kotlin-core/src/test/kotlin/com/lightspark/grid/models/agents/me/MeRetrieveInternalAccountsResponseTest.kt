...
internal class MeRetrieveInternalAccountsResponseTest {

    @Test
    fun create() {
        val meRetrieveInternalAccountsResponse =
            MeRetrieveInternalAccountsResponse.builder()
                .addData(
        ...
        assertThat(meRetrieveInternalAccountsResponse.data())
            .containsExactly(
                InternalAccount.builder()
                    .id("InternalAccount:12dcbd6-dced-4ec4-b756-3c3a9ea3d123")
                    .balance(
        ...
        assertThat(meRetrieveInternalAccountsResponse.hasMore()).isEqualTo(true)
        assertThat(meRetrieveInternalAccountsResponse.nextCursor()).isEqualTo("nextCursor")
        assertThat(meRetrieveInternalAccountsResponse.totalCount()).isEqualTo(0L)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedMeRetrieveInternalAccountsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(meRetrieveInternalAccountsResponse),
                jacksonTypeRef<MeRetrieveInternalAccountsResponse>(),
            )

        assertThat(roundtrippedMeRetrieveInternalAccountsResponse)
            .isEqualTo(meRetrieveInternalAccountsResponse)
    }
}
