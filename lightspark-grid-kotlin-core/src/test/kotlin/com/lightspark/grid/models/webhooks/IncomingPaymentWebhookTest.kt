...
internal class IncomingPaymentWebhookTest {
    ...
    fun create() {
        ...
        assertThat(incomingPaymentWebhook.id())
            .isEqualTo("Webhook:019542f5-b3e7-1d02-0000-000000000007")
        assertThat(incomingPaymentWebhook.timestamp())
            .isEqualTo(OffsetDateTime.parse("2025-08-15T14:32:00Z"))
        assertThat(incomingPaymentWebhook._type())
            .isEqualTo(JsonValue.from("INCOMING_PAYMENT.PENDING"))
        assertThat(incomingPaymentWebhook.data())
            .isEqualTo(
                IncomingPaymentWebhook.Data.builder()
                    .id("Transaction:019542f5-b3e7-1d02-0000-000000000004")
                    .customerId("Customer:019542f5-b3e7-1d02-0000-000000000001")
    ...
    fun roundtrip() {
        ...
        val roundtrippedIncomingPaymentWebhook =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(incomingPaymentWebhook),
                jacksonTypeRef<IncomingPaymentWebhook>(),
            )

        assertThat(roundtrippedIncomingPaymentWebhook).isEqualTo(incomingPaymentWebhook)
    }
}
