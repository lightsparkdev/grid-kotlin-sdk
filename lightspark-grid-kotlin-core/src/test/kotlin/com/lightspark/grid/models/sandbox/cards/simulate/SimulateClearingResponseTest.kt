    ...
    fun create() {
        val simulateClearingResponse =
            SimulateClearingResponse.builder()
                ...
                .merchant(
                    SimulateClearingResponse.Merchant.builder()
                ...
                .pullSummary(
                    SimulateClearingResponse.PullSummary.builder()
                        .count(2L)
                        .totalAmount(1500L)
                        .pendingCount(0L)
                        .build()
                ...
                .refundSummary(
                    SimulateClearingResponse.RefundSummary.builder()
                        .count(0L)
                        .totalAmount(0L)
                        .build()
                )
                .settlementSummary(
                    SimulateClearingResponse.SettlementSummary.builder()
                        .count(1L)
                        .totalAmount(1500L)
                        .build()
                )
        ...
        assertThat(simulateClearingResponse.refundSummary())
            .isEqualTo(
                SimulateClearingResponse.RefundSummary.builder().count(0L).totalAmount(0L).build()
            )
