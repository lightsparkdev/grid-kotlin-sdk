...
internal class MeTransferOutResponseTest {

    @Test
    fun create() {
        val meTransferOutResponse =
            MeTransferOutResponse.builder()
                ...
                .status(MeTransferOutResponse.Status.PENDING_APPROVAL)
                .type(MeTransferOutResponse.Type.EXECUTE_QUOTE)
                ...
                .transferDetails(
                    MeTransferOutResponse.TransferDetails.builder()
                        .amount(50000L)
                        .currency("USD")
        ...
        assertThat(meTransferOutResponse.id())
            .isEqualTo("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
        assertThat(meTransferOutResponse.agentId())
            .isEqualTo("Agent:019542f5-b3e7-1d02-0000-000000000042")
        assertThat(meTransferOutResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:00:00Z"))
        assertThat(meTransferOutResponse.customerId())
            .isEqualTo("Customer:019542f5-b3e7-1d02-0000-000000000010")
        assertThat(meTransferOutResponse.platformCustomerId()).isEqualTo("user-a1b2c3")
        assertThat(meTransferOutResponse.status())
            .isEqualTo(MeTransferOutResponse.Status.PENDING_APPROVAL)
        assertThat(meTransferOutResponse.type()).isEqualTo(MeTransferOutResponse.Type.EXECUTE_QUOTE)
        assertThat(meTransferOutResponse.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:02:00Z"))
        assertThat(meTransferOutResponse.quote())
            .isEqualTo(
                Quote.builder()
                    .id("Quote:019542f5-b3e7-1d02-0000-000000000006")
                    .createdAt(OffsetDateTime.parse("2025-10-03T12:00:00Z"))
        ...
        assertThat(meTransferOutResponse.rejectionReason())
            .isEqualTo("Transaction amount exceeds customer's current risk limit.")
        assertThat(meTransferOutResponse.transaction())
            .isEqualTo(
        ...
        assertThat(meTransferOutResponse.transferDetails())
            .isEqualTo(
                MeTransferOutResponse.TransferDetails.builder()
                    .amount(50000L)
                    .currency("USD")
    ...
    fun roundtrip() {
        ...
        val roundtrippedMeTransferOutResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(meTransferOutResponse),
                jacksonTypeRef<MeTransferOutResponse>(),
            )

        assertThat(roundtrippedMeTransferOutResponse).isEqualTo(meTransferOutResponse)
    }
}
