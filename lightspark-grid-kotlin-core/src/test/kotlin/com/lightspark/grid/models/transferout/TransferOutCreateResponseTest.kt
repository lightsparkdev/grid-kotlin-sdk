...
internal class TransferOutCreateResponseTest {
    ...
    fun ofIncomingTransaction() {
        ...
        val transferOutCreateResponse =
            TransferOutCreateResponse.ofIncomingTransaction(incomingTransaction)

        assertThat(transferOutCreateResponse.incomingTransaction()).isEqualTo(incomingTransaction)
        assertThat(transferOutCreateResponse.outgoingTransaction()).isNull()
    }
    ...
    fun ofIncomingTransactionRoundtrip() {
        ...
        val transferOutCreateResponse =
            TransferOutCreateResponse.ofIncomingTransaction(
                IncomingTransaction.builder()
                    .id("Transaction:019542f5-b3e7-1d02-0000-000000000004")
                    .customerId("Customer:019542f5-b3e7-1d02-0000-000000000001")
                    .destination(
        ...
        val roundtrippedTransferOutCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(transferOutCreateResponse),
                jacksonTypeRef<TransferOutCreateResponse>(),
            )

        assertThat(roundtrippedTransferOutCreateResponse).isEqualTo(transferOutCreateResponse)
    }
    ...
    fun ofOutgoingTransaction() {
            ...
            TransferOutCreateResponse.OutgoingTransaction.builder()
                ...
                .refund(
                    TransferOutCreateResponse.OutgoingTransaction.Refund.builder()
                        ...
                        .status(
                            TransferOutCreateResponse.OutgoingTransaction.Refund.Status.COMPLETED
                        )
                        .reason(
                            TransferOutCreateResponse.OutgoingTransaction.Refund.Reason
                                .TRANSACTION_FAILED
                        )
        ...
        val transferOutCreateResponse =
            TransferOutCreateResponse.ofOutgoingTransaction(outgoingTransaction)

        assertThat(transferOutCreateResponse.incomingTransaction()).isNull()
        assertThat(transferOutCreateResponse.outgoingTransaction()).isEqualTo(outgoingTransaction)
    }
                ...
                TransferOutCreateResponse.OutgoingTransaction.builder()
                    ...
                    .refund(
                        TransferOutCreateResponse.OutgoingTransaction.Refund.builder()
                            ...
                            .reference("UMA-Q12345-REFUND")
                            .status(
                                TransferOutCreateResponse.OutgoingTransaction.Refund.Status
                                    .COMPLETED
                            )
                            .reason(
                                TransferOutCreateResponse.OutgoingTransaction.Refund.Reason
    ...
    fun incompatibleJsonShapeDeserializesToUnknown(testCase: IncompatibleJsonShapeTestCase) {
        val transferOutCreateResponse =
            jsonMapper().convertValue(testCase.value, jacksonTypeRef<TransferOutCreateResponse>())

        val e =
            assertThrows<LightsparkGridInvalidDataException> {
                transferOutCreateResponse.validate()
            }
