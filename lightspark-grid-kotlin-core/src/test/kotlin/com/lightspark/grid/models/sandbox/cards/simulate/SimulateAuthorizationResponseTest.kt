    ...
    fun create() {
        val simulateAuthorizationResponse =
            SimulateAuthorizationResponse.builder()
                ...
                .merchant(
                    SimulateAuthorizationResponse.Merchant.builder()
                ...
                .pullSummary(
                    SimulateAuthorizationResponse.PullSummary.builder()
                        .count(2L)
                        .totalAmount(1500L)
                        .pendingCount(0L)
                        .build()
                ...
                .refundSummary(
                    SimulateAuthorizationResponse.RefundSummary.builder()
                        .count(0L)
                        .totalAmount(0L)
                        .build()
                )
                .settlementSummary(
                    SimulateAuthorizationResponse.SettlementSummary.builder()
                        .count(1L)
                        .totalAmount(1500L)
                        .build()
                )
