...
internal class ActionApproveResponseTest {

    @Test
    fun create() {
        val actionApproveResponse =
            ActionApproveResponse.builder()
                ...
                .status(ActionApproveResponse.Status.PENDING_APPROVAL)
                .type(ActionApproveResponse.Type.EXECUTE_QUOTE)
        ...
        assertThat(actionApproveResponse.id())
            .isEqualTo("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
        assertThat(actionApproveResponse.agentId())
            .isEqualTo("Agent:019542f5-b3e7-1d02-0000-000000000042")
        assertThat(actionApproveResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:00:00Z"))
        assertThat(actionApproveResponse.customerId())
            .isEqualTo("Customer:019542f5-b3e7-1d02-0000-000000000010")
        assertThat(actionApproveResponse.platformCustomerId()).isEqualTo("user-a1b2c3")
        assertThat(actionApproveResponse.status())
            .isEqualTo(ActionApproveResponse.Status.PENDING_APPROVAL)
        assertThat(actionApproveResponse.type()).isEqualTo(ActionApproveResponse.Type.EXECUTE_QUOTE)
        assertThat(actionApproveResponse.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:02:00Z"))
        assertThat(actionApproveResponse.quote())
            .isEqualTo(
                Quote.builder()
                    .id("Quote:019542f5-b3e7-1d02-0000-000000000006")
                    .createdAt(OffsetDateTime.parse("2025-10-03T12:00:00Z"))
        ...
        assertThat(actionApproveResponse.rejectionReason())
            .isEqualTo("Transaction amount exceeds customer's current risk limit.")
        assertThat(actionApproveResponse.transaction())
            .isEqualTo(
    ...
    fun roundtrip() {
        ...
        val roundtrippedActionApproveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(actionApproveResponse),
                jacksonTypeRef<ActionApproveResponse>(),
            )

        assertThat(roundtrippedActionApproveResponse).isEqualTo(actionApproveResponse)
    }
}
