...
internal class AgentActionWebhookEventTest {

    @Test
    fun create() {
        val agentActionWebhookEvent =
        ...
        assertThat(agentActionWebhookEvent.id())
        ...
        assertThat(agentActionWebhookEvent.timestamp())
            .isEqualTo(OffsetDateTime.parse("2025-08-15T14:32:00Z"))
        assertThat(agentActionWebhookEvent.type())
            .isEqualTo(AgentActionWebhookEvent.Type.AGENT_ACTION_PENDING_APPROVAL)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedAgentActionWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(agentActionWebhookEvent),
                jacksonTypeRef<AgentActionWebhookEvent>(),
            )

        assertThat(roundtrippedAgentActionWebhookEvent).isEqualTo(agentActionWebhookEvent)
    }
}
