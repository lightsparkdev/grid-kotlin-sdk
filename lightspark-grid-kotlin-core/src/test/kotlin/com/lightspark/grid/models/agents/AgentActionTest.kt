...
internal class AgentActionTest {
    ...
    fun create() {
        ...
        assertThat(agentAction.agentId()).isEqualTo("Agent:019542f5-b3e7-1d02-0000-000000000042")
        assertThat(agentAction.createdAt()).isEqualTo(OffsetDateTime.parse("2025-10-03T15:00:00Z"))
        assertThat(agentAction.customerId())
            .isEqualTo("Customer:019542f5-b3e7-1d02-0000-000000000010")
        assertThat(agentAction.platformCustomerId()).isEqualTo("user-a1b2c3")
        assertThat(agentAction.status()).isEqualTo(AgentAction.Status.PENDING_APPROVAL)
        assertThat(agentAction.type()).isEqualTo(AgentAction.Type.EXECUTE_QUOTE)
        assertThat(agentAction.updatedAt()).isEqualTo(OffsetDateTime.parse("2025-10-03T15:02:00Z"))
        assertThat(agentAction.quote())
            .isEqualTo(
                Quote.builder()
                    .id("Quote:019542f5-b3e7-1d02-0000-000000000006")
                    .createdAt(OffsetDateTime.parse("2025-10-03T12:00:00Z"))
        ...
        assertThat(agentAction.rejectionReason())
            .isEqualTo("Transaction amount exceeds customer's current risk limit.")
        assertThat(agentAction.transaction())
            .isEqualTo(
    ...
    fun roundtrip() {
        ...
        val roundtrippedAgentAction =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(agentAction),
                jacksonTypeRef<AgentAction>(),
            )

        assertThat(roundtrippedAgentAction).isEqualTo(agentAction)
    }
}
