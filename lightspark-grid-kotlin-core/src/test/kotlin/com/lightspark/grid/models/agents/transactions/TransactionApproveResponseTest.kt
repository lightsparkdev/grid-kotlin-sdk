...
internal class TransactionApproveResponseTest {

    @Test
    fun create() {
        val transactionApproveResponse =
            TransactionApproveResponse.builder()
                ...
                .status(TransactionApproveResponse.Status.PENDING_APPROVAL)
                .type(TransactionApproveResponse.Type.EXECUTE_QUOTE)
                ...
                .transferDetails(
                    TransactionApproveResponse.TransferDetails.builder()
                        .amount(50000L)
                        .currency("USD")
        ...
        assertThat(transactionApproveResponse.id())
            .isEqualTo("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
        assertThat(transactionApproveResponse.agentId())
            .isEqualTo("Agent:019542f5-b3e7-1d02-0000-000000000042")
        assertThat(transactionApproveResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:00:00Z"))
        assertThat(transactionApproveResponse.customerId())
            .isEqualTo("Customer:019542f5-b3e7-1d02-0000-000000000010")
        assertThat(transactionApproveResponse.platformCustomerId()).isEqualTo("user-a1b2c3")
        assertThat(transactionApproveResponse.status())
            .isEqualTo(TransactionApproveResponse.Status.PENDING_APPROVAL)
        assertThat(transactionApproveResponse.type())
            .isEqualTo(TransactionApproveResponse.Type.EXECUTE_QUOTE)
        assertThat(transactionApproveResponse.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:02:00Z"))
        assertThat(transactionApproveResponse.quote())
            .isEqualTo(
                Quote.builder()
                    .id("Quote:019542f5-b3e7-1d02-0000-000000000006")
                    .createdAt(OffsetDateTime.parse("2025-10-03T12:00:00Z"))
        ...
        assertThat(transactionApproveResponse.rejectionReason())
            .isEqualTo("Transaction amount exceeds customer's current risk limit.")
        assertThat(transactionApproveResponse.transaction())
            .isEqualTo(
        ...
        assertThat(transactionApproveResponse.transferDetails())
            .isEqualTo(
                TransactionApproveResponse.TransferDetails.builder()
                    .amount(50000L)
                    .currency("USD")
    ...
    fun roundtrip() {
        ...
        val roundtrippedTransactionApproveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(transactionApproveResponse),
                jacksonTypeRef<TransactionApproveResponse>(),
            )

        assertThat(roundtrippedTransactionApproveResponse).isEqualTo(transactionApproveResponse)
    }
}
