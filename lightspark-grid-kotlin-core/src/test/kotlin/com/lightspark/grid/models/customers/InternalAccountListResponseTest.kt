...
internal class InternalAccountListResponseTest {

    @Test
    fun create() {
        val internalAccountListResponse =
            InternalAccountListResponse.builder()
                .addData(
        ...
        assertThat(internalAccountListResponse.data())
            .containsExactly(
                InternalAccount.builder()
                    .id("InternalAccount:12dcbd6-dced-4ec4-b756-3c3a9ea3d123")
                    .balance(
        ...
        assertThat(internalAccountListResponse.nextCursor()).isEqualTo("nextCursor")
        assertThat(internalAccountListResponse.totalCount()).isEqualTo(0L)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInternalAccountListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(internalAccountListResponse),
                jacksonTypeRef<InternalAccountListResponse>(),
            )

        assertThat(roundtrippedInternalAccountListResponse).isEqualTo(internalAccountListResponse)
    }
}
