    ...
    fun create() {
        val actionListResponse =
            ActionListResponse.builder()
                ...
                .status(ActionListResponse.Status.PENDING_APPROVAL)
                .type(ActionListResponse.Type.EXECUTE_QUOTE)
                ...
                .transferDetails(
                    ActionListResponse.TransferDetails.builder()
                        .amount(50000L)
                        .currency("USD")
        ...
        assertThat(actionListResponse.id())
            .isEqualTo("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
        assertThat(actionListResponse.agentId())
            .isEqualTo("Agent:019542f5-b3e7-1d02-0000-000000000042")
        assertThat(actionListResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:00:00Z"))
        assertThat(actionListResponse.customerId())
            .isEqualTo("Customer:019542f5-b3e7-1d02-0000-000000000010")
        assertThat(actionListResponse.platformCustomerId()).isEqualTo("user-a1b2c3")
        assertThat(actionListResponse.status())
            .isEqualTo(ActionListResponse.Status.PENDING_APPROVAL)
        assertThat(actionListResponse.type()).isEqualTo(ActionListResponse.Type.EXECUTE_QUOTE)
        assertThat(actionListResponse.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:02:00Z"))
        assertThat(actionListResponse.quote())
            .isEqualTo(
                Quote.builder()
                    .id("Quote:019542f5-b3e7-1d02-0000-000000000006")
                    .createdAt(OffsetDateTime.parse("2025-10-03T12:00:00Z"))
        ...
        assertThat(actionListResponse.rejectionReason())
            .isEqualTo("Transaction amount exceeds customer's current risk limit.")
        assertThat(actionListResponse.transaction())
            .isEqualTo(
        ...
        assertThat(actionListResponse.transferDetails())
            .isEqualTo(
                ActionListResponse.TransferDetails.builder()
                    .amount(50000L)
                    .currency("USD")
