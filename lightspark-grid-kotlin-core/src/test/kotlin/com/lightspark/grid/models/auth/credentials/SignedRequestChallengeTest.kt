...
internal class SignedRequestChallengeTest {

    @Test
    fun create() {
        val signedRequestChallenge =
    ...
    fun roundtrip() {
        ...
        val roundtrippedSignedRequestChallenge =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(signedRequestChallenge),
                jacksonTypeRef<SignedRequestChallenge>(),
            )

        assertThat(roundtrippedSignedRequestChallenge).isEqualTo(signedRequestChallenge)
    }
}
