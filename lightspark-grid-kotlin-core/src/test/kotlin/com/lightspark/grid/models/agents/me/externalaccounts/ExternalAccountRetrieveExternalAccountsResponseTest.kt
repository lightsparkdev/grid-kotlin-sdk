...
internal class ExternalAccountRetrieveExternalAccountsResponseTest {

    @Test
    fun create() {
        val externalAccountRetrieveExternalAccountsResponse =
            ExternalAccountRetrieveExternalAccountsResponse.builder()
                .addData(
        ...
        assertThat(externalAccountRetrieveExternalAccountsResponse.data())
            .containsExactly(
                ExternalAccount.builder()
                    .id("ExternalAccount:e85dcbd6-dced-4ec4-b756-3c3a9ea3d965")
                    .accountInfo(
        ...
        assertThat(externalAccountRetrieveExternalAccountsResponse.hasMore()).isEqualTo(true)
        assertThat(externalAccountRetrieveExternalAccountsResponse.nextCursor())
            .isEqualTo("nextCursor")
        assertThat(externalAccountRetrieveExternalAccountsResponse.totalCount()).isEqualTo(0L)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedExternalAccountRetrieveExternalAccountsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(externalAccountRetrieveExternalAccountsResponse),
                jacksonTypeRef<ExternalAccountRetrieveExternalAccountsResponse>(),
            )

        assertThat(roundtrippedExternalAccountRetrieveExternalAccountsResponse)
            .isEqualTo(externalAccountRetrieveExternalAccountsResponse)
    }
}
