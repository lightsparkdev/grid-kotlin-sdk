    ...
    fun create() {
        val actionRejectResponse =
            ActionRejectResponse.builder()
                ...
                .status(ActionRejectResponse.Status.PENDING_APPROVAL)
                .type(ActionRejectResponse.Type.EXECUTE_QUOTE)
                ...
                .transferDetails(
                    ActionRejectResponse.TransferDetails.builder()
                        .amount(50000L)
                        .currency("USD")
        ...
        assertThat(actionRejectResponse.id())
            .isEqualTo("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
        assertThat(actionRejectResponse.agentId())
            .isEqualTo("Agent:019542f5-b3e7-1d02-0000-000000000042")
        assertThat(actionRejectResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:00:00Z"))
        assertThat(actionRejectResponse.customerId())
            .isEqualTo("Customer:019542f5-b3e7-1d02-0000-000000000010")
        assertThat(actionRejectResponse.platformCustomerId()).isEqualTo("user-a1b2c3")
        assertThat(actionRejectResponse.status())
            .isEqualTo(ActionRejectResponse.Status.PENDING_APPROVAL)
        assertThat(actionRejectResponse.type()).isEqualTo(ActionRejectResponse.Type.EXECUTE_QUOTE)
        assertThat(actionRejectResponse.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:02:00Z"))
        assertThat(actionRejectResponse.quote())
            .isEqualTo(
                Quote.builder()
                    .id("Quote:019542f5-b3e7-1d02-0000-000000000006")
                    .createdAt(OffsetDateTime.parse("2025-10-03T12:00:00Z"))
        ...
        assertThat(actionRejectResponse.rejectionReason())
            .isEqualTo("Transaction amount exceeds customer's current risk limit.")
        assertThat(actionRejectResponse.transaction())
            .isEqualTo(
        ...
        assertThat(actionRejectResponse.transferDetails())
            .isEqualTo(
                ActionRejectResponse.TransferDetails.builder()
                    .amount(50000L)
                    .currency("USD")
