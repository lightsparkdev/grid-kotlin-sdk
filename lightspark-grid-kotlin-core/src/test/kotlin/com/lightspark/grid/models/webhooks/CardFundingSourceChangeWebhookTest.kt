...
internal class CardFundingSourceChangeWebhookTest {
    ...
    fun create() {
        ...
        assertThat(cardFundingSourceChangeWebhook.id())
            .isEqualTo("Webhook:019542f5-b3e7-1d02-0000-000000000007")
        assertThat(cardFundingSourceChangeWebhook.timestamp())
            .isEqualTo(OffsetDateTime.parse("2025-08-15T14:32:00Z"))
        assertThat(cardFundingSourceChangeWebhook._type())
            .isEqualTo(JsonValue.from("CARD.FUNDING_SOURCE_CHANGE"))
        assertThat(cardFundingSourceChangeWebhook.data())
            .isEqualTo(
                Card.builder()
                    .id("Card:019542f5-b3e7-1d02-0000-000000000010")
                    .cardholderId("Customer:019542f5-b3e7-1d02-0000-000000000001")
    ...
    fun roundtrip() {
        ...
        val roundtrippedCardFundingSourceChangeWebhook =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(cardFundingSourceChangeWebhook),
                jacksonTypeRef<CardFundingSourceChangeWebhook>(),
            )

        assertThat(roundtrippedCardFundingSourceChangeWebhook)
