...
internal class AgentListApprovalsResponseTest {

    @Test
    fun create() {
        val agentListApprovalsResponse =
            AgentListApprovalsResponse.builder()
                ...
                .status(AgentListApprovalsResponse.Status.PENDING_APPROVAL)
                .type(AgentListApprovalsResponse.Type.EXECUTE_QUOTE)
        ...
        assertThat(agentListApprovalsResponse.id())
            .isEqualTo("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
        assertThat(agentListApprovalsResponse.agentId())
            .isEqualTo("Agent:019542f5-b3e7-1d02-0000-000000000042")
        assertThat(agentListApprovalsResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:00:00Z"))
        assertThat(agentListApprovalsResponse.customerId())
            .isEqualTo("Customer:019542f5-b3e7-1d02-0000-000000000010")
        assertThat(agentListApprovalsResponse.platformCustomerId()).isEqualTo("user-a1b2c3")
        assertThat(agentListApprovalsResponse.status())
            .isEqualTo(AgentListApprovalsResponse.Status.PENDING_APPROVAL)
        assertThat(agentListApprovalsResponse.type())
            .isEqualTo(AgentListApprovalsResponse.Type.EXECUTE_QUOTE)
        assertThat(agentListApprovalsResponse.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2025-10-03T15:02:00Z"))
        assertThat(agentListApprovalsResponse.quote())
            .isEqualTo(
                Quote.builder()
                    .id("Quote:019542f5-b3e7-1d02-0000-000000000006")
                    .createdAt(OffsetDateTime.parse("2025-10-03T12:00:00Z"))
        ...
        assertThat(agentListApprovalsResponse.rejectionReason())
            .isEqualTo("Transaction amount exceeds customer's current risk limit.")
        assertThat(agentListApprovalsResponse.transaction())
            .isEqualTo(
        ...
        assertThat(agentListApprovalsResponse.transferDetails())
            .isEqualTo(
                AgentListApprovalsResponse.TransferDetails.builder()
                    .amount(50000L)
                    .currency("USD")
    ...
    fun roundtrip() {
        ...
        val roundtrippedAgentListApprovalsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(agentListApprovalsResponse),
                jacksonTypeRef<AgentListApprovalsResponse>(),
            )

        assertThat(roundtrippedAgentListApprovalsResponse).isEqualTo(agentListApprovalsResponse)
    }
}
