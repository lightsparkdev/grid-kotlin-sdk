...
internal class AgentListApprovalsPageResponseTest {

    @Test
    fun create() {
        val agentListApprovalsPageResponse =
            AgentListApprovalsPageResponse.builder()
                .addData(
        ...
        assertThat(agentListApprovalsPageResponse.data())
            .containsExactly(
                AgentListApprovalsResponse.builder()
                    .id("AgentAction:019542f5-b3e7-1d02-0000-000000000099")
                    .agentId("Agent:019542f5-b3e7-1d02-0000-000000000042")
        ...
        assertThat(agentListApprovalsPageResponse.hasMore()).isEqualTo(true)
        assertThat(agentListApprovalsPageResponse.nextCursor()).isEqualTo("nextCursor")
        assertThat(agentListApprovalsPageResponse.totalCount()).isEqualTo(0L)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedAgentListApprovalsPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(agentListApprovalsPageResponse),
                jacksonTypeRef<AgentListApprovalsPageResponse>(),
            )

        assertThat(roundtrippedAgentListApprovalsPageResponse)
            .isEqualTo(agentListApprovalsPageResponse)
    }
}
