...
dependencies {
    testImplementation(project(":lightspark-grid-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../lightspark-grid-kotlin-core/src/main/resources/META-INF/proguard/lightspark-grid-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.lightspark.grid.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../lightspark-grid-kotlin-core/src/main/resources/META-INF/proguard/lightspark-grid-kotlin-core.pro",
