...
/**
 * A class that allows building an instance of [LightsparkGridClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class LightsparkGridOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [LightsparkGridClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): LightsparkGridClient = builder().fromEnv().build()
    }

    /** A builder for [LightsparkGridOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [LightsparkGridClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LightsparkGridClient =
            LightsparkGridClientImpl(
                clientOptions
                    .httpClient(
