...
import com.lightspark.grid.core.http.HttpRequestBody
import com.lightspark.grid.core.http.HttpResponse
import com.lightspark.grid.errors.LightsparkGridIoException
...
class OkHttpClient internal constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw LightsparkGridIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("LIGHTSPARK_GRID_LOG")?.lowercase()) {
