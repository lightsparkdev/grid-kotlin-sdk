...
package com.lightspark.grid.client.okhttp
...
/**
 * A class that allows building an instance of [LightsparkGridClientAsync] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class LightsparkGridOkHttpClientAsync private constructor() {

    companion object {

        /**
         * Returns a mutable builder for constructing an instance of [LightsparkGridClientAsync].
         */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): LightsparkGridClientAsync = builder().fromEnv().build()
    }

    /** A builder for [LightsparkGridOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [LightsparkGridClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LightsparkGridClientAsync =
            LightsparkGridClientAsyncImpl(
                clientOptions
                    .httpClient(
